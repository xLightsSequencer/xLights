...
class DimWhiteDialog: public wxDialog
{
	...
	public:
		...
		DimWhiteDialog(wxWindow* parent, size_t& startChannel, size_t& channels, size_t& dim,wxWindowID id=wxID_ANY,const wxPoint& pos=wxDefaultPosition,const wxSize& size=wxDefaultSize);
