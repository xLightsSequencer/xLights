...
class SetDialog: public wxDialog
{
	...
	public:
		...
		SetDialog(wxWindow* parent, size_t& startChannel, size_t& _channels, size_t& value,wxWindowID id=wxID_ANY,const wxPoint& pos=wxDefaultPosition,const wxSize& size=wxDefaultSize);
		virtual ~SetDialog();
