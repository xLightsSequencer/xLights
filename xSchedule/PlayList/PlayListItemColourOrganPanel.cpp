...
void PlayListItemColourOrganPanel::OnSpinCtrl_StartNoteChange(wxSpinEvent& event) {
    if (SpinCtrl_StartNote->GetValue() > SpinCtrl_EndNote->GetValue())
        SpinCtrl_EndNote->SetValue(SpinCtrl_StartNote->GetValue());
    ValidateWindow();
}

void PlayListItemColourOrganPanel::OnSpinCtrl_EndNoteChange(wxSpinEvent& event) {
    if (SpinCtrl_EndNote->GetValue() < SpinCtrl_StartNote->GetValue())
        SpinCtrl_StartNote->SetValue(SpinCtrl_EndNote->GetValue());
    ValidateWindow();
}
