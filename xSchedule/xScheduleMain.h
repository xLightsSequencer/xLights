...
wxDECLARE_EVENT(EVT_SLOWFRAMEPROCESSING, wxCommandEvent);   
...
private:
    ...
    static const wxWindowID ID_BITMAPBUTTON10;
    static const wxWindowID ID_CUSTOM1;
    static const wxWindowID ID_BITMAPBUTTON11;
    static const wxWindowID ID_BITMAPBUTTON8;
    static const wxWindowID ID_CUSTOM2;
    static const wxWindowID ID_BITMAPBUTTON9;
    ...
    static const wxWindowID ID_LISTVIEW2;
    ...
    static const wxWindowID ID_MNU_SHOWFOLDER;
    static const wxWindowID ID_MNU_USEXLIGHTSFOLDER;
    static const wxWindowID ID_MNU_SAVE;
    static const wxWindowID idMenuQuit;
    static const wxWindowID ID_MNU_MNUADDPLAYLIST;
    static const wxWindowID ID_MENUITEM1;
    static const wxWindowID ID_MNU_BACKGROUND;
    static const wxWindowID ID_MNU_MATRICES;
    static const wxWindowID ID_MNU_VIRTUALMATRICES;
    static const wxWindowID ID_MNU_EDITEVENTS;
    static const wxWindowID ID_MNU_OPTIONS;
    static const wxWindowID ID_MNU_VIEW_LOG;
    static const wxWindowID ID_MNU_CHECK_SCHEDULE;
    static const wxWindowID ID_MNU_WEBINTERFACE;
    static const wxWindowID ID_MNU_IMPORT;
    static const wxWindowID ID_MNU_RESETWINDOWS;
    static const wxWindowID ID_MNU_CRASH;
    static const wxWindowID ID_MNU_TEST;
    static const wxWindowID ID_MNU_FPP_BROADCASTMASTER;
    static const wxWindowID ID_MNU_FPP_MULTICAST;
    static const wxWindowID ID_MNU_FPP_UNICASTMASTER;
    static const wxWindowID ID_MNU_FPP_UNICASTCSVMASTER;
    static const wxWindowID IDM_MNU_ARTNETMASTER;
    static const wxWindowID ID_MNU_OSCMASTER;
    static const wxWindowID MNU_MIDITIMECODE_MASTER;
    static const wxWindowID ID_MNU_MASTER;
    static const wxWindowID ID_MNU_MODENORMAL;
    static const wxWindowID ID_MNU_FPPREMOTE;
    static const wxWindowID ID_MNU_FPPCSVREMOTE;
    static const wxWindowID ID_MNU_ARTNETTIMECODESLAVE;
    static const wxWindowID ID_MNU_OSCREMOTE;
    static const wxWindowID MNU_MIDITIMECODEREMOTE;
    static const wxWindowID ID_MNU_SMPTE;
    static const wxWindowID ID_MNU_REMOTECONFIGURE;
    static const wxWindowID ID_MNU_REMOTE;
    static const wxWindowID ID_MNU_EDITFPPREMOTE;
    static const wxWindowID ID_MNU_OSCOPTION;
    ...
    wxStaticText* StaticText_SequenceTime;
    wxStaticText* StaticText_ShowDir;
    wxStaticText* StaticText_SyncTime;
