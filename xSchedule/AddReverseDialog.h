...
class AddReverseDialog: public wxDialog
{
	...
	public:
		...
		AddReverseDialog(wxWindow* parent, size_t& startChannel, size_t& nodes, size_t& ignore, std::string& description, wxWindowID id=wxID_ANY,const wxPoint& pos=wxDefaultPosition,const wxSize& size=wxDefaultSize);
