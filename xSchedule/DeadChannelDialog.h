...
class DeadChannelDialog: public wxDialog
{
	...
	public:
		...
		DeadChannelDialog(wxWindow* parent, size_t& nodeStartChannel, size_t& channel, std::string& description, wxWindowID id=wxID_ANY,const wxPoint& pos=wxDefaultPosition,const wxSize& size=wxDefaultSize);
