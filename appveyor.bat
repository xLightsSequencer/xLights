...
rem mingw32-make setup_h -f makefile.gcc --debug MONOLITHIC=1 SHARED=1 UNICODE=1 CXXFLAGS="-std=gnu++14" BUILD=release SHELL=%COMSPEC%
mingw32-make setup_h -f makefile.gcc --debug SHELL=%COMSPEC%
