...
{
    spdlog::info("FPPConnectDialog constructor: parent={}, targetIp='{}'", (void*)parent, targetIp);
...
void FPPConnectDialog::LoadSequences()
{
    ...
    xLightsFrame* frame = _frame;
    spdlog::info("FPPConnectDialog::LoadSequences: frame={}, targetIp='{}'", (void*)frame, _targetIp);
    if (frame) {
        spdlog::info("FPPConnectDialog::LoadSequences: frame->GetFseqDirectory()='{}'", ToUTF8(frame->GetFseqDirectory()));
        spdlog::info("FPPConnectDialog::LoadSequences: frame->GetShowDirectory()='{}'", ToUTF8(frame->GetShowDirectory()));
    }
    spdlog::info("FPPConnectDialog::LoadSequences: CurrentDir='{}'", ToUTF8(xLightsFrame::CurrentDir));
    wxString fseqDir = frame ? frame->GetFseqDirectory() : "";
    if (fseqDir.IsEmpty()) {
        fseqDir = xLightsFrame::CurrentDir;
    }
    spdlog::info("FPPConnectDialog::LoadSequences: final fseqDir='{}'", ToUTF8(fseqDir));
