  ...
  mDisplayMode(MODE_SATURATION)
{
	...
	Create(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_STATIC, _T("wxID_ANY"));
	GridBagSizer1 = new wxGridBagSizer(0, 0);
	Panel_Palette = new xlColorCanvas(this, ID_PANEL_Palette, wxDefaultPosition, wxDefaultSize, wxBORDER_SUNKEN|wxTAB_TRAVERSAL, _T("ID_PANEL_Palette"));
	...
	Panel_Slider = new xlColorCanvas(this, ID_PANEL_SLIDER, wxDefaultPosition, wxDefaultSize, wxBORDER_SUNKEN|wxTAB_TRAVERSAL, _T("ID_PANEL_SLIDER"));
	...
	BitmapButton_Swatch1 = new wxBitmapButton(this, ID_BITMAPBUTTON_Swatch1, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_Swatch1"));
	...
	Panel_CurrentColor = new wxPanel(this, ID_PANEL_CurrentColor, wxDefaultPosition, wxDefaultSize, wxBORDER_SUNKEN, _T("ID_PANEL_CurrentColor"));
	...
	TextCtrl_Hue = new wxTextCtrl(this, ID_TEXTCTRL_Hue, _("0"), wxDefaultPosition, wxDefaultSize, wxTE_LEFT|wxBORDER_SIMPLE, wxDefaultValidator, _T("ID_TEXTCTRL_Hue"));
	...
	TextCtrl_Saturation = new wxTextCtrl(this, ID_TEXTCTRL_Saturation, _("100"), wxDefaultPosition, wxDefaultSize, wxTE_LEFT|wxBORDER_SIMPLE, wxDefaultValidator, _T("ID_TEXTCTRL_Saturation"));
	...
	TextCtrl_Brightness = new wxTextCtrl(this, ID_TEXTCTRL_BrightnessCPF, _("100"), wxDefaultPosition, wxDefaultSize, wxTE_LEFT|wxBORDER_SIMPLE, wxDefaultValidator, _T("ID_TEXTCTRL_BrightnessCPF"));
	...
	TextCtrl_Red = new wxTextCtrl(this, ID_TEXTCTRL_Red, _("255"), wxDefaultPosition, wxDefaultSize, wxTE_LEFT|wxBORDER_SIMPLE, wxDefaultValidator, _T("ID_TEXTCTRL_Red"));
	...
	TextCtrl_Green = new wxTextCtrl(this, ID_TEXTCTRL_Green, _("0"), wxDefaultPosition, wxDefaultSize, wxTE_LEFT|wxBORDER_SIMPLE, wxDefaultValidator, _T("ID_TEXTCTRL_Green"));
	...
	TextCtrl_Blue = new wxTextCtrl(this, ID_TEXTCTRL_Blue, _("0"), wxDefaultPosition, wxDefaultSize, wxTE_LEFT|wxBORDER_SIMPLE, wxDefaultValidator, _T("ID_TEXTCTRL_Blue"));
	...
	BitmapButton_Swatch2 = new wxBitmapButton(this, ID_BITMAPBUTTON_Swatch2, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_Swatch2"));
	...
	BitmapButton_Swatch3 = new wxBitmapButton(this, ID_BITMAPBUTTON_Swatch3, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_Swatch3"));
	...
	BitmapButton_Swatch4 = new wxBitmapButton(this, ID_BITMAPBUTTON_Swatch4, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_Swatch4"));
	...
	BitmapButton_Swatch5 = new wxBitmapButton(this, ID_BITMAPBUTTON_Swatch5, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_Swatch5"));
	...
	BitmapButton_Swatch6 = new wxBitmapButton(this, ID_BITMAPBUTTON_Swatch6, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_Swatch6"));
	...
	BitmapButton_Swatch7 = new wxBitmapButton(this, ID_BITMAPBUTTON_Swatch7, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_Swatch7"));
	...
	BitmapButton_Swatch8 = new wxBitmapButton(this, ID_BITMAPBUTTON_Swatch8, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_Swatch8"));
