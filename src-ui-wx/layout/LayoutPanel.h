...
class LayoutPanel: public wxPanel
{
    ...
    public:
		...
		int FindNotebookPage(const wxString& label) const;
    ...
    private:
        ...
        wxTreeListCtrl* CreateTreeListCtrl(long style, wxPanel* panel, long id, const std::string& colOrderKey, const wxString& nameColTitle, TreeChanColumns& cols);
