...
private:
    ...
    wxDataViewModel* _ctrlAttrModel = nullptr; // owned by _tree's dataview; raw ref for macOS AssociateModel dance
    ...
    wxBoxSizer* _headerSizer = nullptr;
    wxStaticBitmap* _ledPing = nullptr;
    ControllerLedBitmaps _ledPingBitmaps;
