...
const wxWindowID EffectTreeDialog::ID_SCROLLEDWINDOW1 = wxNewId();
//*)
...
EffectTreeDialog::EffectTreeDialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size,long style)
{
	...
	FlexGridSizerContent = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizerContent->AddGrowableCol(0);
	FlexGridSizerContent->AddGrowableRow(0);
	FlexGridSizer2 = new wxFlexGridSizer(0, 3, 0, 0);
	FlexGridSizer2->AddGrowableCol(0);
	FlexGridSizer2->AddGrowableRow(0);
	TreeCtrl1 = new wxTreeCtrl(ScrolledWindow1, ID_TREECTRL1, wxDefaultPosition, wxDefaultSize, wxTR_DEFAULT_STYLE, wxDefaultValidator, _T("ID_TREECTRL1"));
	TreeCtrl1->SetMinSize(wxDLG_UNIT(this,wxSize(80,-1)));
	FlexGridSizer2->Add(TreeCtrl1, 1, wxALL|wxEXPAND, 5);
	BoxSizer3 = new wxBoxSizer(wxVERTICAL);
	Button_Top = new wxButton(ScrolledWindow1, ID_BUTTON11, _T("^^"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(15,-1)), 0, wxDefaultValidator, _T("ID_BUTTON11"));
	BoxSizer3->Add(Button_Top, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxFIXED_MINSIZE, 5);
	Button_MoveUp = new wxButton(ScrolledWindow1, ID_BUTTON9, _T("^"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(15,-1)), 0, wxDefaultValidator, _T("ID_BUTTON9"));
	BoxSizer3->Add(Button_MoveUp, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxFIXED_MINSIZE, 5);
	Button_MoveDown = new wxButton(ScrolledWindow1, ID_BUTTON10, _("v"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(15,-1)), 0, wxDefaultValidator, _T("ID_BUTTON10"));
	BoxSizer3->Add(Button_MoveDown, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxFIXED_MINSIZE, 5);
	Button_Bottom = new wxButton(ScrolledWindow1, ID_BUTTON12, _("vv"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(15,-1)), 0, wxDefaultValidator, _T("ID_BUTTON12"));
	...
	StaticBitmapGif = new wxStaticBitmap(ScrolledWindow1, ID_STATICBITMAP_GIF, wxNullBitmap, wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICBITMAP_GIF"));
	FlexGridSizer3->Add(StaticBitmapGif, 1, wxALL|wxALIGN_CENTER_HORIZONTAL, 5);
	StaticTextApplyLabel = new wxStaticText(ScrolledWindow1, ID_STATICTEXT_APPLY, _("Apply preset as:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT_APPLY"));
	FlexGridSizer3->Add(StaticTextApplyLabel, 0, wxALL|wxALIGN_LEFT, 5);
	wxBoxSizer* BoxSizerRadio = new wxBoxSizer(wxHORIZONTAL);
	btPosition = new wxRadioButton(ScrolledWindow1, ID_BTN_POSITION, _("Relative"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP, wxDefaultValidator, _T("ID_BTN_POSITION"));
	...
	btLayers = new wxRadioButton(ScrolledWindow1, ID_BTN_LAYERS, _("Using Layers"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BTN_LAYERS"));
	...
	btApply = new wxButton(ScrolledWindow1, ID_BUTTON6, _("&Apply Preset"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON6"));
	btApply->SetToolTip(_("Apply the selected effect Preset."));
	BoxSizer1->Add(btApply, 0, wxALL|wxEXPAND, 5);
	btAddGroup = new wxButton(ScrolledWindow1, ID_BUTTON7, _("Add &Group"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON7"));
	btAddGroup->SetToolTip(_("Add effect preset group."));
	BoxSizer1->Add(btAddGroup, 0, wxALL|wxEXPAND, 5);
	btUpdate = new wxButton(ScrolledWindow1, ID_BUTTON2, _("&Update Preset"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
	...
	btDelete = new wxButton(ScrolledWindow1, ID_BUTTON4, _("&Delete"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON4"));
	btDelete->SetToolTip(_("Delete curently selected effect preset."));
	BoxSizer1->Add(btDelete, 0, wxALL|wxEXPAND, 5);
	btNewPreset = new wxButton(ScrolledWindow1, ID_BUTTON1, _("&New Preset"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
	btNewPreset->SetToolTip(_("Create New Effect Preset from current settings."));
	BoxSizer1->Add(btNewPreset, 0, wxALL|wxEXPAND, 5);
	btImport = new wxButton(ScrolledWindow1, ID_BUTTON8, _("&Import"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON8"));
	btImport->SetToolTip(_("Import presets from another file."));
	BoxSizer1->Add(btImport, 0, wxALL|wxEXPAND, 5);
	btRename = new wxButton(ScrolledWindow1, ID_BUTTON3, _("&Rename"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON3"));
	btRename->SetToolTip(_("Rename currently selected effect preset."));
	BoxSizer1->Add(btRename, 0, wxALL|wxEXPAND, 5);
	btExport = new wxButton(ScrolledWindow1, ID_BUTTON5, _("Export"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
	BoxSizer1->Add(btExport, 0, wxALL|wxEXPAND, 5);
	FlexGridSizer3->Add(BoxSizer1, 1, wxALL|wxEXPAND, 5);
	BoxSizer2 = new wxBoxSizer(wxHORIZONTAL);
	TextCtrl1 = new wxTextCtrl(ScrolledWindow1, ID_TEXTCTRL_SEARCH, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL_SEARCH"));
	BoxSizer2->Add(TextCtrl1, 1, wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 3);
	ETButton1 = new wxButton(ScrolledWindow1, ID_BUTTON_SEARCH, _("Search"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT, wxDefaultValidator, _T("ID_BUTTON_SEARCH"));
	...
	FlexGridSizerContent->Add(FlexGridSizer2, 1, wxALL|wxEXPAND, 5);
...
{
    xLightParent->GetOutputModelManager()->AddASAPWork(OutputModelManager::WORK_PRESET_CHANGE, "PresetsDirty");
}
