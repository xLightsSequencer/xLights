...
const wxWindowID MetronomeLabelDialog::ID_STATICTEXT_TEXTLABELS = wxNewId();
const wxWindowID MetronomeLabelDialog::ID_TEXTCTRL_TEXTLABELS = wxNewId();
...
MetronomeLabelDialog::MetronomeLabelDialog(int base_timing, wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	SpinCtrlTiming = new wxSpinCtrl(this, ID_SPINCTRL_TIMING, _T("50"), wxDefaultPosition, wxDefaultSize, 0, 50, 60000, 50, _T("ID_SPINCTRL_TIMING"));
	...
	StaticTextLabel = new wxStaticText(this, ID_STATICTEXT_TEXTLABELS, _("Text Labels (eg up,down,left)"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT_TEXTLABELS"));
	StaticTextLabel->SetToolTip(_("If entered, these labels will be used to populate the timing track"));
	GridSizer1->Add(StaticTextLabel, 1, wxALL, 5);
	TextCtrl_TextLabels = new wxTextCtrl(this, ID_TEXTCTRL_TEXTLABELS, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL_TEXTLABELS"));
	TextCtrl_TextLabels->SetToolTip(_("Optionally enter a list of text labels to use. "));
	GridSizer1->Add(TextCtrl_TextLabels, 1, wxALL|wxEXPAND, 5);
	...
	StaticText_MinTiming = new wxStaticText(this, ID_STATICTEXT_MINTIMING, _("Min Timing (ms)"), wxPoint(-1,-1), wxDefaultSize, 0, _T("ID_STATICTEXT_MINTIMING"));
	StaticText_MinTiming->SetToolTip(_("Minimum milliseconds per timing mark"));
	FlexGridSizer3->Add(StaticText_MinTiming, 1, wxTOP|wxLEFT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 1);
	SpinCtrl_MinTiming = new wxSpinCtrl(this, ID_SPINCTRL1, _T("50"), wxDefaultPosition, wxDefaultSize, 0, 50, 60000, 50, _T("ID_SPINCTRL1"));
	SpinCtrl_MinTiming->SetValue(_T("50"));
	SpinCtrl_MinTiming->Disable();
	SpinCtrl_MinTiming->SetToolTip(_("Minimum milliseconds per timing mark"));
