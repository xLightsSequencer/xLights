...
RandomEffectsSettingsPanel::RandomEffectsSettingsPanel(wxWindow* parent, xLightsFrame *f, wxWindowID id,const wxPoint& pos,const wxSize& size) : frame(f)
{
    ...
    _availableList = new wxListBox(this, wxID_ANY, wxDefaultPosition, wxSize(190, 340), 0, nullptr, wxLB_EXTENDED | wxLB_SORT);
    ...
    _usedList = new wxListBox(this, wxID_ANY, wxDefaultPosition, wxSize(190, 340), 0, nullptr, wxLB_EXTENDED | wxLB_SORT);
