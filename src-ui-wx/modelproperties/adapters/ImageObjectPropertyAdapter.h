...
class ImageObjectPropertyAdapter : public ViewObjectPropertyAdapter {
public:
    explicit ImageObjectPropertyAdapter(ImageObject& obj);
    ~ImageObjectPropertyAdapter() override = default;
