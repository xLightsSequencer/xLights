...
CurtainPanel::CurtainPanel(wxWindow* parent) : xlEffectPanel()
{
...
void CurtainPanel::SetDefaultParameters()
{
    BitmapButton_Curtain_SpeedVC->SetActive(false);
    BitmapButton_Curtain_SwagVC->SetActive(false);

    SetSliderValue(Slider_Curtain_Swag, 3);
    SetSliderValue(Slider_Curtain_Speed, 10);

    SetChoiceValue(Choice_Curtain_Edge, "left");
    SetChoiceValue(Choice_Curtain_Effect, "open");

    SetCheckBoxValue(CheckBox_Curtain_Repeat, false);
}
