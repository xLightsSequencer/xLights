...
FillPanel::FillPanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size) : xlEffectPanel()
{
	...
	BitmapButton_Fill_Position = new BulkEditValueCurveButton(this, ID_VALUECURVE_Fill_Position, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Fill_Position"));
	...
	BitmapButton_FillPosition = new xlLockButton(this, ID_BITMAPBUTTON_SLIDER_Fill_Position, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Fill_Position"));
	...
	BitmapButton_Fill_Band_Size = new BulkEditValueCurveButton(this, ID_VALUECURVE_Fill_Band_Size, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Fill_Band_Size"));
	...
	BitmapButton_FillBand_Size = new xlLockButton(this, ID_BITMAPBUTTON_SLIDER_Fill_Band_Size, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Fill_Band_Size"));
	...
	BitmapButton_Fill_Skip_Size = new BulkEditValueCurveButton(this, ID_VALUECURVE_Fill_Skip_Size, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Fill_Skip_Size"));
	...
	BitmapButton_FillSkip_Size = new xlLockButton(this, ID_BITMAPBUTTON_SLIDER_Fill_Skip_Size, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Fill_Skip_Size"));
	...
	BitmapButton_Fill_Offset = new BulkEditValueCurveButton(this, ID_VALUECURVE_Fill_Offset, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Fill_Offset"));
	...
	BitmapButton_FillOffset = new xlLockButton(this, ID_BITMAPBUTTON_SLIDER_Fill_Offset, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Fill_Offset"));
	...
	BitmapButton_Direction = new xlLockButton(this, ID_BITMAPBUTTON_CHOICE_Fill_Direction, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHOICE_Fill_Direction"));
...
void FillPanel::SetDefaultParameters() {
    BitmapButton_Fill_Band_Size->SetActive(false);
    BitmapButton_Fill_Offset->SetActive(false);
    BitmapButton_Fill_Position->SetActive(false);
    BitmapButton_Fill_Skip_Size->SetActive(false);

    SetSliderValue(Slider_Fill_Band_Size, 0);
    SetSliderValue(Slider_Fill_Offset, 0);
    SetSliderValue(Slider_Fill_Position, 100);
    SetSliderValue(Slider_Fill_Skip_Size, 0);

    SetChoiceValue(Choice_Fill_Direction, "Up");

    SetCheckBoxValue(CheckBox_Fill_Color_Time, false);
    SetCheckBoxValue(CheckBox_Fill_Offset_In_Pixels, true);
    SetCheckBoxValue(CheckBox_Fill_Wrap, true);
}
