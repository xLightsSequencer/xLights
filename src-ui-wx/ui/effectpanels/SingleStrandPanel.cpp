...
#include "effects/SingleStrandEffect.h"
...
SingleStrandPanel::SingleStrandPanel(wxWindow* parent) : xlEffectPanel()
{
...
void SingleStrandPanel::SetDefaultParameters()
{
    BitmapButton_Color_Mix1VC->SetActive(false);
    BitmapButton_Number_ChasesVC->SetActive(false);
    BitmapButton_Chase_Rotations->SetActive(false);
    BitmapButton_Chase_OffsetVC->SetActive(false);
    BitmapButton_FX_IntensityVC->SetActive(false);
    BitmapButton_FX_SpeedVC->SetActive(false);

    SetChoiceValue(Choice_SingleStrand_Colors, "Palette");
    SetChoiceValue(Choice_Skips_Direction, "Left");
    SetChoiceValue(Choice_Chase_Type1, "Left-Right");
    SetChoiceValue(Choice_SingleStrand_FX, "Fireworks 1D");
    SetChoiceValue(Choice_FX_Palette, "* Colors Only");

    SetSliderValue(Slider_Number_Chases, 1);
    SetSliderValue(Slider_Color_Mix1, 10);
    SetSliderValue(Slider_Chase_Rotations, 10);
    SetSliderValue(Slider_Chase_Offset, 0);
    SetSliderValue(Slider_Skips_BandSize, 1);
    SetSliderValue(Slider_Skips_SkipSize, 1);
    SetSliderValue(Slider_Skips_StartPos, 1);
    SetSliderValue(Slider_Skips_Advance, 0);
    SetSliderValue(Slider_FX_Intensity, 128);
    SetSliderValue(Slider_FX_Speed, 128);

    SetChoiceValue(Choice_Fade_Type, "None");
    SetCheckBoxValue(CheckBox_Chase_Group_All, false);
}
