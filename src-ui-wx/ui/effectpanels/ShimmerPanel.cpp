...
#include "effects/ShimmerEffect.h"
...
ShimmerPanel::ShimmerPanel(wxWindow* parent) : xlEffectPanel()
{
...
void ShimmerPanel::SetDefaultParameters()
{
    BitmapButton_Shimmer_CyclesVC->SetActive(false);
    BitmapButton_Shimmer_Duty_FactorVC->SetActive(false);

    SetSliderValue(Slider_Shimmer_Duty_Factor, 50);
    SetSliderValue(Slider_Shimmer_Cycles, 10);

    SetCheckBoxValue(CheckBox_Shimmer_Use_All_Colors, false);
    SetCheckBoxValue(CheckBox_PRE_2017_7, false);
}
