...
MarqueePanel::MarqueePanel(wxWindow* parent) : xlEffectPanel()
{
	...
	BitmapButton_Marquee_Band_SizeVC = new BulkEditValueCurveButton(Panel_Marquee_Settings, ID_VALUECURVE_Marquee_Band_Size, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Marquee_Band_Size"));
	...
	BitmapButton_Marquee_Band_Size = new xlLockButton(Panel_Marquee_Settings, ID_BITMAPBUTTON_SLIDER_Marquee_Band_Size, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Marquee_Band_Size"));
	...
	BitmapButton_Marquee_Skip_SizeVC = new BulkEditValueCurveButton(Panel_Marquee_Settings, ID_VALUECURVE_Marquee_Skip_Size, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Marquee_Skip_Size"));
	...
	BitmapButton_Marquee_Skip_Size = new xlLockButton(Panel_Marquee_Settings, ID_BITMAPBUTTON_SLIDER_Marquee_Skip_Size, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Marquee_Skip_Size"));
	...
	BitmapButton_Marquee_ThicknessVC = new BulkEditValueCurveButton(Panel_Marquee_Settings, ID_VALUECURVE_Marquee_Thickness, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Marquee_Thickness"));
	...
	BitmapButton_Marquee_Thickness = new xlLockButton(Panel_Marquee_Settings, ID_BITMAPBUTTON_SLIDER_Marquee_Thickness, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Marquee_Thickness"));
	...
	BitmapButton_Marquee_StaggerVC = new BulkEditValueCurveButton(Panel_Marquee_Settings, ID_VALUECURVE_Marquee_Stagger, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Marquee_Stagger"));
	...
	BitmapButton_Marquee_Stagger = new xlLockButton(Panel_Marquee_Settings, ID_BITMAPBUTTON_SLIDER_Marquee_Stagger, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Marquee_Stagger"));
	...
	BitmapButton_Marquee_SpeedVC = new BulkEditValueCurveButton(Panel_Marquee_Settings, ID_VALUECURVE_Marquee_Speed, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Marquee_Speed"));
	...
	BitmapButton_Marquee_Speed = new xlLockButton(Panel_Marquee_Settings, ID_BITMAPBUTTON_SLIDER_Marquee_Speed, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Marquee_Speed"));
	...
	BitmapButton_Marquee_StartVC = new BulkEditValueCurveButton(Panel_Marquee_Settings, ID_VALUECURVE_Marquee_Start, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Marquee_Start"));
	...
	BitmapButton_Marquee_Start = new xlLockButton(Panel_Marquee_Settings, ID_BITMAPBUTTON_SLIDER_Marquee_Start, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Marquee_Start"));
	...
	BitmapButton_Marquee_ScaleXVC = new BulkEditValueCurveButton(Panel_Marquee_Position, ID_VALUECURVE_Marquee_ScaleX, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Marquee_ScaleX"));
	...
	BitmapButton_Marquee_ScaleX = new xlLockButton(Panel_Marquee_Position, ID_BITMAPBUTTON_SLIDER_Marquee_ScaleX, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Marquee_ScaleX"));
	...
	BitmapButton_Marquee_ScaleYVC = new BulkEditValueCurveButton(Panel_Marquee_Position, ID_VALUECURVE_Marquee_ScaleY, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Marquee_ScaleY"));
	...
	BitmapButton_Marquee_ScaleY = new xlLockButton(Panel_Marquee_Position, ID_BITMAPBUTTON_SLIDER_Marquee_ScaleY, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Marquee_ScaleY"));
	...
	FlexGridSizer137->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BitmapButton_MarqueeXCVC = new BulkEditValueCurveButton(Panel_Marquee_Position, ID_VALUECURVE_MarqueeXC, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_MarqueeXC"));
	...
	BitmapButton_MarqueeYCVC = new BulkEditValueCurveButton(Panel_Marquee_Position, ID_VALUECURVE_MarqueeYC, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_MarqueeYC"));
...
void MarqueePanel::SetDefaultParameters()
{
    SetSliderValue(Slider_MarqueeXC, 0);
    SetSliderValue(Slider_MarqueeYC, 0);
    SetSliderValue(Slider_Marquee_Band_Size, 3);
    SetSliderValue(Slider_Marquee_ScaleX, 100);
    SetSliderValue(Slider_Marquee_ScaleY, 100);
    SetSliderValue(Slider_Marquee_Skip_Size, 0);
    SetSliderValue(Slider_Marquee_Speed, 3);
    SetSliderValue(Slider_Marquee_Stagger, 0);
    SetSliderValue(Slider_Marquee_Start, 0);
    SetSliderValue(Slider_Marquee_Thickness, 1);

    SetCheckBoxValue(CheckBox_Marquee_Reverse, false);
    SetCheckBoxValue(CheckBox_Marquee_PixelOffsets, false);
    SetCheckBoxValue(CheckBox_Marquee_WrapX, false);

    BitmapButton_MarqueeXCVC->SetActive(false);
    BitmapButton_MarqueeYCVC->SetActive(false);
    BitmapButton_Marquee_Band_SizeVC->SetActive(false);
    BitmapButton_Marquee_ScaleXVC->SetActive(false);
    BitmapButton_Marquee_ScaleYVC->SetActive(false);
    BitmapButton_Marquee_Skip_SizeVC->SetActive(false);
    BitmapButton_Marquee_SpeedVC->SetActive(false);
    BitmapButton_Marquee_StaggerVC->SetActive(false);
    BitmapButton_Marquee_StartVC->SetActive(false);
    BitmapButton_Marquee_ThicknessVC->SetActive(false);
}
