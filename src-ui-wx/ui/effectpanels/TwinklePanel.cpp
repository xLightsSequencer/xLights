...
TwinklePanel::TwinklePanel(wxWindow* parent) : xlEffectPanel()
{
...
void TwinklePanel::SetDefaultParameters()
{
    BitmapButton_Twinkle_CountVC->SetActive(false);
    BitmapButton_Twinkle_StepsVC->SetActive(false);

    SetSliderValue(Slider_Twinkle_Count, 3);
    SetSliderValue(Slider_Twinkle_Steps, 30);
    SetCheckBoxValue(CheckBox_Twinkle_Strobe, false);
    SetCheckBoxValue(CheckBox_Twinkle_ReRandom, false);
    SetChoiceValue(Choice_Twinkle_Style, "New Render Method");
}
