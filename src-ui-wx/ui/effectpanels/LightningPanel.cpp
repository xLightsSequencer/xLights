...
LightningPanel::LightningPanel(wxWindow* parent) : xlEffectPanel()
{
...
void LightningPanel::SetDefaultParameters()
{
    BitmapButton_Lightning_TopXVC->SetActive(false);
    BitmapButton_Lightning_TopYVC->SetActive(false);
    BitmapButton_Number_BoltsVC->SetActive(false);
    BitmapButton_Number_SegmentsVC->SetActive(false);

    SetSliderValue(Slider_Number_Bolts, 10);
    SetSliderValue(Slider_Number_Segments, 5);
    SetSliderValue(Slider_Lightning_TopX, 0);
    SetSliderValue(Slider_Lightning_TopY, 0);
    SetSliderValue(Slider_Lightning_BOTX, 0);
    SetSliderValue(Slider_Lightning_WIDTH, 1);

    SetChoiceValue(CHOICE_Lightning_Direction, "Up");

    SetCheckBoxValue(CheckBox_ForkedLightning, false);
}
