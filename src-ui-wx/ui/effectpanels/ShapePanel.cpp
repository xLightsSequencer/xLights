...
ShapePanel::ShapePanel(wxWindow* parent) : xlEffectPanel()
{
...
void ShapePanel::SetDefaultParameters()
{
    BitmapButton_Shape_ThicknessVC->SetActive(false);
    BitmapButton_Shape_CentreXVC->SetActive(false);
    BitmapButton_Shape_CentreYVC->SetActive(false);
    BitmapButton_Shapes_Velocity->SetActive(false);
    BitmapButton_Shapes_Direction->SetActive(false);
    BitmapButton_Shape_LifetimeVC->SetActive(false);
    BitmapButton_Shape_GrowthVC->SetActive(false);
    BitmapButton_Shape_CountVC->SetActive(false);
    BitmapButton_Shape_StartSizeVC->SetActive(false);
    BitmapButton_Shape_RotationVC->SetActive(false);

    SetChoiceValue(Choice_Shape_ObjectToDraw, "Circle");

    SetSliderValue(Slider_Shape_Thickness, 1);
    SetSliderValue(Slider_Shape_StartSize, 1);
    SetSliderValue(Slider_Shape_CentreX, 50);
    SetSliderValue(Slider_Shape_CentreY, 50);
    SetSliderValue(Slider_Shape_Points, 5);
    SetSliderValue(Slider_Shape_Count, 5);
    SetSliderValue(Slider_Shape_Growth, 10);
    SetSliderValue(Slider_Shape_Lifetime, 5);
    SetSliderValue(Slider_Shape_Sensitivity, 50);
    SetSliderValue(Slider_Shape_Rotation, 0);
    SetSliderValue(Slider_Shapes_Velocity, 0);
    SetSliderValue(Slider_Shapes_Direction, 90);

    SetCheckBoxValue(CheckBox_Shape_RandomLocation, true);
    SetCheckBoxValue(CheckBox_Shape_FadeAway, true);
    SetCheckBoxValue(CheckBox_Shape_UseMusic, false);
    SetCheckBoxValue(CheckBox_Shape_FireTiming, false);
    SetCheckBoxValue(CheckBox_Shape_RandomInitial, true);
    SetCheckBoxValue(CheckBox_Shape_HoldColour, true);
    SetCheckBoxValue(CheckBox_FilterLabelReg, false);

    TextCtrl_Shape_FilterLabel->SetValue("");

    FilePickerCtrl_SVG->SetFileName(wxFileName(""));
}

void ShapePanel::SetPanelStatus(Model* cls)
{
