...
#include "effects/TendrilEffect.h"
...
TendrilPanel::TendrilPanel(wxWindow* parent) : xlEffectPanel()
{
...
void TendrilPanel::SetDefaultParameters()
{
    BitmapButton_Tendril_ManualXVC->SetActive(false);
    BitmapButton_Tendril_ManualYVC->SetActive(false);
    BitmapButton_Tendril_ThicknessVC->SetActive(false);
    BitmapButton_Tendril_TuneMovementVC->SetActive(false);
    BitmapButton_Tendril_XOffsetVC->SetActive(false);
    BitmapButton_Tendril_YOffsetVC->SetActive(false);

    SetChoiceValue(Choice_Tendril_Movement, "Random");
    SetSliderValue(Slider_Tendril_TuneMovement, 10);
    SetSliderValue(Slider_Tendril_Speed, 10);
    SetSliderValue(Slider_Tendril_Thickness, 1);
    SetSliderValue(Slider_Tendril_Friction, 10);
    SetSliderValue(Slider_Tendril_Dampening, 10);
    SetSliderValue(Slider_Tendril_Tension, 20);
    SetSliderValue(Slider_Tendril_Trails, 1);
    SetSliderValue(Slider_Tendril_Length, 60);
    SetSliderValue(Slider_Tendril_XOffset, 0);
    SetSliderValue(Slider_Tendril_YOffset, 0);
    SetSliderValue(Slider_Tendril_ManualX, 0);
    SetSliderValue(Slider_Tendril_ManualY, 0);
}
