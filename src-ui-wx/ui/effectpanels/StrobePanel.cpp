...
StrobePanel::StrobePanel(wxWindow* parent) : xlEffectPanel()
{
...
void StrobePanel::SetDefaultParameters()
{
    SetSliderValue(Slider_Number_Strobes, 3);
    SetSliderValue(Slider_Strobe_Duration, 10);
    SetSliderValue(Slider_Strobe_Type, 1);
    SetCheckBoxValue(CheckBox_Strobe_Music, false);
}
