...
OffPanel::OffPanel(wxWindow* parent) : xlEffectPanel()
{
	//(*Initialize(OffPanel)
...
void OffPanel::SetDefaultParameters()
{
    OffStyleChoice->SetSelection(0);
}

wxString OffPanel::GetEffectString()
{
    std::string style = OffStyleChoice->GetStringSelection().ToStdString();
    if (style != "Black") {
