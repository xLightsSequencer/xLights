...
SnowflakesPanel::SnowflakesPanel(wxWindow* parent) : xlEffectPanel()
{
...
void SnowflakesPanel::SetDefaultParameters()
{
    BitmapButton_Snowflakes_Count->SetActive(false);
    BitmapButton_Snowflakes_Speed->SetActive(false);

    SetSliderValue(Slider_Snowflakes_Count, 5);
    SetSliderValue(Slider_Snowflakes_Type, 1);
    SetSliderValue(Slider_Snowflakes_Speed, 10);
    SetChoiceValue(Choice_Falling, "Driving");
}
