...
#include "effects/CirclesEffect.h"
...
CirclesPanel::CirclesPanel(wxWindow* parent) : xlEffectPanel()
{
...
void CirclesPanel::SetDefaultParameters()
{
    BitmapButton_Circles_Count->SetActive(false);
    BitmapButton_Circles_Size->SetActive(false);
    BitmapButton_Circles_Speed->SetActive(false);

    SetSliderValue(Slider_Circles_Count, 3);
    SetSliderValue(Slider_Circles_Size, 5);
    SetSliderValue(Slider_Circles_Speed, 10);
    SetSliderValue(Slider_Circles_XC, 0);
    SetSliderValue(Slider_Circles_YC, 0);

    SetCheckBoxValue(CheckBox_Circles_Bounce, false);
    SetCheckBoxValue(CheckBox_Circles_Radial, false);
    SetCheckBoxValue(CheckBox_Circles_Plasma, false);
    SetCheckBoxValue(CheckBox_Circles_Radial_3D, false);
    SetCheckBoxValue(CheckBox_Circles_Bubbles, false);
    SetCheckBoxValue(CheckBox_Circles_Collide, false);
    SetCheckBoxValue(CheckBox_Circles_Random_m, false);
    SetCheckBoxValue(CheckBox_Circles_Linear_Fade, false);
}
