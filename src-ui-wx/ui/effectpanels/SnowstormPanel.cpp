...
SnowstormPanel::SnowstormPanel(wxWindow* parent) : xlEffectPanel()
{
...
void SnowstormPanel::SetDefaultParameters()
{
    SetSliderValue(Slider_Snowstorm_Count, 50);
    SetSliderValue(Slider_Snowstorm_Length, 50);
    SetSliderValue(Slider_Snowstorm_Speed, 10);
}
