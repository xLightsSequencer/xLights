...
#include "effects/SpirographEffect.h"
...
SpirographPanel::SpirographPanel(wxWindow* parent) : xlEffectPanel()
{
...
void SpirographPanel::SetDefaultParameters()
{
    BitmapButton_Spirograph_AnimateVC->SetActive(false);
    BitmapButton_Spirograph_LengthVC->SetActive(false);
    BitmapButton_Spirograph_WidthVC->SetActive(false);
    BitmapButton_Spirograph_dVC->SetActive(false);
    BitmapButton_Spirograph_RVC->SetActive(false);
    BitmapButton_Spirograph_rVC->SetActive(false);
    BitmapButton_Spirograph_SpeedrVC->SetActive(false);

    SetSliderValue(Slider_Spirograph_Speed, 10);
    SetSliderValue(Slider_Spirograph_R, 20);
    SetSliderValue(Slider_Spirograph_r, 10);
    SetSliderValue(Slider_Spirograph_d, 30);
    SetSliderValue(Slider_Spirograph_Animate, 0);
    SetSliderValue(Slider_Spirograph_Length, 20);
    SetSliderValue(Slider_Spirograph_Width, 1);
}
