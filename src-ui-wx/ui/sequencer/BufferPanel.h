...
public:
		...
		static double GetSettingVCMin(const std::string& name) { return ValueCurveConsts::GetBufferSettingVCMin(name); }
        static double GetSettingVCMax(const std::string& name) { return ValueCurveConsts::GetBufferSettingVCMax(name); }
		static int GetSettingVCDivisor(const std::string& name) { return ValueCurveConsts::GetBufferSettingVCDivisor(name); }
