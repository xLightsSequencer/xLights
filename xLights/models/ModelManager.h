...
class ModelManager : public ObjectManager
{
    public:
        ...
        bool IsModelValid(const BaseObject* o) const;
        ...
        wxString SerialiseModelGroupsForModel(const std::string& name) const;
        void DeserialiseModelGroup(wxXmlNode* n, int w, int h, const std::string& name);
