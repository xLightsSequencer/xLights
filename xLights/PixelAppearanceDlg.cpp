...
const long PixelAppearanceDlg::ID_CHECKBOX1 = wxNewId();
...
PixelAppearanceDlg::PixelAppearanceDlg(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticText2 = new wxStaticText(this, wxID_ANY, _("Smooth Pixels:"), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
	FlexGridSizer5->Add(StaticText2, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	AntialiasCheckBox = new wxCheckBox(this, ID_CHECKBOX1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
	AntialiasCheckBox->SetValue(false);
	FlexGridSizer5->Add(AntialiasCheckBox, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
