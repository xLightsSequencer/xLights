...
static  std::vector<std::pair<std::string, KBSCOPE>> KeyBindingTypes = 
{
    ...
    { _("EXPORT_MODEL_CAD"), KBSCOPE::Layout },
    { _("EXPORT_LAYOUT_DXF"), KBSCOPE::Layout },
...
static  std::vector<std::pair<std::string, std::string>> keyBindingTips =
{
    ...
    { _("EXPORT_MODEL_CAD"), "Export the selected model as a DXF or STL or VRML File." },
    { _("EXPORT_LAYOUT_DXF"), "Export the default layout as a DXF File." },
...
const std::vector<KeyBinding> DefaultBindings =
{
    ...
    KeyBinding(_(""), true, _("EXPORT_MODEL_CAD"), true),
    KeyBinding(_(""), true, _("EXPORT_LAYOUT_DXF"), true),
