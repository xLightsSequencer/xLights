...
private:
    ...
    static const long ID_CHECKBOX_Text1_COUNTDOWN1;
    ...
    wxCheckBox* CheckBox_Text1_COUNTDOWN2;
    ...
    wxCheckBox* CheckBox_Text2_COUNTDOWN1;
    ...
    wxCheckBox* CheckBox_Text2_COUNTDOWN2;
    wxPanel* Panel1_Tree;
