...
void PixelBufferClass::RenderPlasma(int ColorScheme, int Style, int Chunks,  int PlasmaDirection, int PlasmaSpeed) {
    effects[CurrentLayer].RenderPlasma(ColorScheme,Style,Chunks, PlasmaDirection, PlasmaSpeed);
}
