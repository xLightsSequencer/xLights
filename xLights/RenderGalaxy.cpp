                              ...
                              bool start_radius_x10, bool start_width_x10, bool end_radius_x10, bool end_width_x10, bool revolutions_x2 )
{
    ...
    double radius2 = (end_radius_x10 ? end_radius * 10.0 : end_radius);
    double width1 = (start_width_x10 ? start_width * 10.0 : start_width);
    double width2 = (end_width_x10 ? end_width * 10.0 : end_width);
