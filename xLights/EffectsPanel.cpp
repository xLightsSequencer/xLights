...
const long EffectsPanel::ID_CHECKBOX_Meteors_FallUp = wxNewId();
...
EffectsPanel::EffectsPanel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style, const wxString &name)
{
	...
	Slider_Meteors_Swirl_Intensity = new wxSlider(Panel1_Meteors, ID_SLIDER_Meteors_Swirl_Intensity, 0, 10, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Meteors_Swirl_Intensity"));
	...
	CheckBox_Meteors_FallUp = new wxCheckBox(Panel1_Meteors, ID_CHECKBOX_Meteors_FallUp, _("Yes"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_Meteors_FallUp"));
	CheckBox_Meteors_FallUp->SetValue(false);
	FlexGridSizer41->Add(CheckBox_Meteors_FallUp, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
