...
const long EffectsPanel::ID_SLIDER_On_Cycles = wxNewId();
const long EffectsPanel::IDD_TEXTCTRL_On_Cycles = wxNewId();
...
const long EffectsPanel::ID_SLIDER_Bars_Cycles = wxNewId();
const long EffectsPanel::IDD_TEXTCTRL_Bars_Cycles = wxNewId();
...
const long EffectsPanel::ID_SLIDER_ColorWash_Cycles = wxNewId();
const long EffectsPanel::IDD_TEXTCTRL_ColorWash_Cycles = wxNewId();
...
const long EffectsPanel::ID_SLIDER_Curtain_Speed = wxNewId();
const long EffectsPanel::IDD_TEXTCTRL_Curtain_Speed = wxNewId();
...
const long EffectsPanel::ID_SLIDER_Fire_GrowthCycles = wxNewId();
const long EffectsPanel::IDD_TEXTCTRL_Fire_GrowthCycles = wxNewId();
...
const long EffectsPanel::ID_SLIDER_Ripple_Cycles = wxNewId();
const long EffectsPanel::IDD_TEXTCTRL_Ripple_Cycles = wxNewId();
...
const long EffectsPanel::ID_SLIDER_Chase_Rotations = wxNewId();
const long EffectsPanel::IDD_TEXTCTRL_Chase_Rotations = wxNewId();
...
const long EffectsPanel::ID_SLIDER_Spirals_Movement = wxNewId();
const long EffectsPanel::IDD_TEXTCTRL_Spirals_Movement = wxNewId();
...
EffectsPanel::EffectsPanel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style, const wxString &name)
{
    ...
    Slider7 = new wxSlider(Panel1_On, ID_SLIDER_On_Cycles, 0, 0, 200, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_On_Cycles"));
    FlexGridSizer95->Add(Slider7, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
    TextCtrl24 = new wxTextCtrl(Panel1_On, IDD_TEXTCTRL_On_Cycles, _("0.0"), wxDefaultPosition, wxDLG_UNIT(Panel1_On,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_On_Cycles"));
    ...
    Slider13 = new wxSlider(Panel1_Bars, ID_SLIDER_Bars_Cycles, 10, 0, 300, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Bars_Cycles"));
    FlexGridSizer70->Add(Slider13, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
    TextCtrl35 = new wxTextCtrl(Panel1_Bars, IDD_TEXTCTRL_Bars_Cycles, _("1.0"), wxDefaultPosition, wxDLG_UNIT(Panel1_Bars,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Bars_Cycles"));
    ...
    Slider8 = new wxSlider(Panel1_Butterfly, ID_SLIDER_Butterfly_Speed, 0, 0, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Butterfly_Speed"));
    ...
    Slider_ColorWash_Count = new wxSlider(Panel1_ColorWash, ID_SLIDER_ColorWash_Cycles, 10, 1, 200, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_ColorWash_Cycles"));
    FlexGridSizer9->Add(Slider_ColorWash_Count, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
    TextCtrl10 = new wxTextCtrl(Panel1_ColorWash, IDD_TEXTCTRL_ColorWash_Cycles, _("1.0"), wxDefaultPosition, wxDLG_UNIT(Panel1_ColorWash,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_ColorWash_Cycles"));
    ...
    Slider14 = new wxSlider(Panel1_Curtain, ID_SLIDER_Curtain_Speed, 10, 0, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Curtain_Speed"));
    FlexGridSizer20->Add(Slider14, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrl41 = new wxTextCtrl(Panel1_Curtain, IDD_TEXTCTRL_Curtain_Speed, _("1.0"), wxDefaultPosition, wxDLG_UNIT(Panel1_Curtain,wxSize(25,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Curtain_Speed"));
    ...
    Slider9 = new wxSlider(Panel1_Fire, ID_SLIDER_Fire_GrowthCycles, 0, 0, 200, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Fire_GrowthCycles"));
    FlexGridSizer38->Add(Slider9, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
    TextCtrl26 = new wxTextCtrl(Panel1_Fire, IDD_TEXTCTRL_Fire_GrowthCycles, _("0.0"), wxDefaultPosition, wxDLG_UNIT(Panel1_Fire,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Fire_GrowthCycles"));
    ...
    TextCtrl_Pictures_GifSpeed = new wxTextCtrl(Panel1_Pictures, IDD_TEXTCTRL_Pictures_GifSpeed, _("20"), wxDefaultPosition, wxDLG_UNIT(Panel1_Pictures,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Pictures_GifSpeed"));
    ...
    Slider12 = new wxSlider(Panel1_Ripple, ID_SLIDER_Ripple_Cycles, 10, 0, 300, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Ripple_Cycles"));
    FlexGridSizer57->Add(Slider12, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
    TextCtrl34 = new wxTextCtrl(Panel1_Ripple, IDD_TEXTCTRL_Ripple_Cycles, _("1.0"), wxDefaultPosition, wxDLG_UNIT(Panel1_Ripple,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Ripple_Cycles"));
    ...
    StaticText10 = new wxStaticText(Panel1, wxID_ANY, _("Speed"), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
    FlexGridSizer24->Add(StaticText10, 1, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
    Slider16 = new wxSlider(Panel1, ID_SLIDER_Chase_Rotations, 10, 1, 200, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Chase_Rotations"));
    FlexGridSizer24->Add(Slider16, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
    TextCtrl43 = new wxTextCtrl(Panel1, IDD_TEXTCTRL_Chase_Rotations, _("1.0"), wxDefaultPosition, wxDLG_UNIT(Panel1,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Chase_Rotations"));
    ...
    Slider_Spirals_Direction = new wxSlider(Panel1_Spirals, ID_SLIDER_Spirals_Movement, 10, -200, 200, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Spirals_Movement"));
    FlexGridSizer129->Add(Slider_Spirals_Direction, 1, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrl39 = new wxTextCtrl(Panel1_Spirals, IDD_TEXTCTRL_Spirals_Movement, _("1.0"), wxDefaultPosition, wxDLG_UNIT(Panel1_Spirals,wxSize(25,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Spirals_Movement"));
    ...
    FlexGridSizer72->Add(FlexGridSizer125, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    FlexGridSizer72->Add(FlexGridSizer126, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    BitmapButton_Spirographr = new wxBitmapButton(Panel1_Spirograph, ID_BITMAPBUTTON_SLIDER_Spirograph_r, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Spirograph_r"));
    BitmapButton_Spirographr->SetDefault();
    BitmapButton_Spirographr->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    FlexGridSizer72->Add(BitmapButton_Spirographr, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 1);
    ...
    FlexGridSizer72->Add(FlexGridSizer127, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    FlexGridSizer119->Add(Slider_Text_Position1, 1, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
    ...
    FlexGridSizer69->Add(FlexGridSizer119, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    FlexGridSizer120->Add(Slider_Text_Position2, 1, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
    ...
    FlexGridSizer74->Add(FlexGridSizer120, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    FlexGridSizer25->Add(FlexGridSizer121, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    FlexGridSizer29->Add(FlexGridSizer122, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    Connect(ID_SLIDER_On_Cycles,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedTextCtrlFloat);
    Connect(IDD_TEXTCTRL_On_Cycles,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedSliderFloat);
    ...
    Connect(ID_SLIDER_Bars_Cycles,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedTextCtrlFloat);
    Connect(IDD_TEXTCTRL_Bars_Cycles,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedSliderFloat);
    ...
    Connect(ID_SLIDER_ColorWash_Cycles,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedTextCtrlFloat);
    Connect(IDD_TEXTCTRL_ColorWash_Cycles,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedSliderFloat);
    ...
    Connect(ID_SLIDER_Curtain_Speed,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedTextCtrlFloat);
    Connect(IDD_TEXTCTRL_Curtain_Speed,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedSliderFloat);
    ...
    Connect(ID_SLIDER_Fire_GrowthCycles,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedTextCtrlFloat);
    Connect(IDD_TEXTCTRL_Fire_GrowthCycles,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedSliderFloat);
    ...
    Connect(ID_SLIDER_Ripple_Cycles,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedTextCtrlFloat);
    Connect(IDD_TEXTCTRL_Ripple_Cycles,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedSliderFloat);
    ...
    Connect(ID_SLIDER_Chase_Rotations,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedTextCtrlFloat);
    Connect(IDD_TEXTCTRL_Chase_Rotations,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedSliderFloat);
    ...
    Connect(ID_SLIDER_Spirals_Movement,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedTextCtrlFloat);
    Connect(IDD_TEXTCTRL_Spirals_Movement,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedSliderFloat);
