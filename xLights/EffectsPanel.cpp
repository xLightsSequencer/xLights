...
const long EffectsPanel::ID_TEXTCTRL1 = wxNewId();
...
const long EffectsPanel::ID_TEXTCTRL2 = wxNewId();
...
EffectsPanel::EffectsPanel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style, const wxString &name)
{
    ...
    Slider35 = new wxSlider(Panel1_Lightning, ID_SLIDER1, 50, 1, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER1"));
    FlexGridSizer140->Add(Slider35, 1, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrl86 = new wxTextCtrl(Panel1_Lightning, ID_TEXTCTRL1, _("50"), wxDefaultPosition, wxDLG_UNIT(Panel1_Lightning,wxSize(20,-1)), 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
    TextCtrl86->SetMaxLength(3);
    ...
    Slider37 = new wxSlider(Panel1_Lightning, ID_SLIDER2, 10, 0, 300, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER2"));
    FlexGridSizer140->Add(Slider37, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrl88 = new wxTextCtrl(Panel1_Lightning, ID_TEXTCTRL2, _("1.0"), wxDefaultPosition, wxDLG_UNIT(Panel1_Lightning,wxSize(20,-1)), 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
    TextCtrl88->SetMaxLength(4);
    ...
    Connect(ID_SLIDER1,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedTextCtrl);
    Connect(ID_TEXTCTRL1,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedSlider);
    Connect(ID_BITMAPBUTTON38,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&EffectsPanel::OnLockButtonClick);
    Connect(ID_SLIDER2,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedTextCtrlFloat);
    Connect(ID_TEXTCTRL2,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedSliderFloat);
