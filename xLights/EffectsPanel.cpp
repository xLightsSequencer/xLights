...
const long EffectsPanel::IDD_TEXTCTRL_ColorWash_Count = wxNewId();
...
const long EffectsPanel::ID_CHECKBOX_Fan_Blend_Background = wxNewId();
...
const long EffectsPanel::ID_CHECKBOX_Morph_Blend_Tail = wxNewId();
const long EffectsPanel::ID_BITMAPBUTTON_Morph_Blend_Tail = wxNewId();
...
EffectsPanel::EffectsPanel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style, const wxString &name)
{
    ...
    TextCtrl10 = new wxTextCtrl(Panel1_ColorWash, IDD_TEXTCTRL_ColorWash_Count, _("1"), wxDefaultPosition, wxDLG_UNIT(Panel1_ColorWash,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_ColorWash_Count"));
    FlexGridSizer22->Add(TextCtrl10, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    FlexGridSizer114->Add(ColorWashEntireModelCheckbox, 1, wxALL|wxALIGN_LEFT|wxALIGN_TOP, 5);
    ...
    FlexGridSizer116->Add(0,0,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    CheckBox_Fan_Blend_Background = new wxCheckBox(Panel11, ID_CHECKBOX_Fan_Blend_Background, _("Blend To Background:"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT, wxDefaultValidator, _T("ID_CHECKBOX_Fan_Blend_Background"));
    CheckBox_Fan_Blend_Background->SetValue(false);
    FlexGridSizer103->Add(CheckBox_Fan_Blend_Background, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    CheckBox_Morph_Blend_Tail = new wxCheckBox(MorphPanelOptions, ID_CHECKBOX_Morph_Blend_Tail, _("Blend Tail"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_Morph_Blend_Tail"));
    CheckBox_Morph_Blend_Tail->SetValue(true);
    FlexGridSizer105->Add(CheckBox_Morph_Blend_Tail, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    BitmapButton_Morph_Blend_Tail = new wxBitmapButton(MorphPanelOptions, ID_BITMAPBUTTON_Morph_Blend_Tail, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_Morph_Blend_Tail"));
    BitmapButton_Morph_Blend_Tail->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
    FlexGridSizer105->Add(BitmapButton_Morph_Blend_Tail, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    Connect(ID_SLIDER_ColorWash_Count,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedTextCtrl);
    Connect(IDD_TEXTCTRL_ColorWash_Count,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedSlider);
    ...
    Connect(ID_BITMAPBUTTON_Morph_Blend_Tail,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&EffectsPanel::OnLockButtonClick);
