...
const long EffectsPanel::ID_CHOICE_Chase_Type2 = wxNewId();
...
EffectsPanel::EffectsPanel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style, const wxString &name)
{
	...
	StaticText11 = new wxStaticText(Panel1, ID_STATICTEXT10, _("Chase Type"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT10"));
	...
	Choice_Chase_Type1->Append(_("Normal"));
	Choice_Chase_Type1->Append(_("Second"));
	Choice_Chase_Type1->Append(_("Third"));
	FlexGridSizer24->Add(Choice_Chase_Type1, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	StaticText16 = new wxStaticText(Panel2, ID_STATICTEXT15, _("Chase Type"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT15"));
	FlexGridSizer25->Add(StaticText16, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	Choice_Chase_Type2 = new wxChoice(Panel2, ID_CHOICE_Chase_Type2, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE_Chase_Type2"));
	Choice_Chase_Type2->Append(_("Normal"));
	Choice_Chase_Type2->Append(_("Second"));
	Choice_Chase_Type2->Append(_("Third"));
	FlexGridSizer25->Add(Choice_Chase_Type2, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
