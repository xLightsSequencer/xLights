...
const long EffectsPanel::ID_RADIOBUTTON1 = wxNewId();
const long EffectsPanel::ID_RADIOBUTTON2 = wxNewId();
...
const long EffectsPanel::ID_CHOICE_CoroFacePhoneme = wxNewId();
...
const long EffectsPanel::ID_CHOICEBOOK_FaceMode = wxNewId();
...
EffectsPanel::EffectsPanel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style, const wxString &name)
{
    ...
    Choicebook_FaceMode = new wxChoicebook(Panel1_Faces, ID_CHOICEBOOK_FaceMode, wxDefaultPosition, wxDefaultSize, 0, _T("ID_CHOICEBOOK_FaceMode"));
    Panel_Auto = new wxPanel(Choicebook_FaceMode, ID_PANEL19, wxPoint(11,10), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL19"));
    FlexGridSizer57 = new wxFlexGridSizer(0, 3, 0, 0);
    StaticText65 = new wxStaticText(Panel_Auto, ID_STATICTEXT67, _("Face Shape"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT67"));
    FlexGridSizer57->Add(StaticText65, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    RadioButton1 = new wxRadioButton(Panel_Auto, ID_RADIOBUTTON1, _("Round"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON1"));
    FlexGridSizer57->Add(RadioButton1, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    RadioButton2 = new wxRadioButton(Panel_Auto, ID_RADIOBUTTON2, _("Rectangular"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON2"));
    FlexGridSizer57->Add(RadioButton2, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText70 = new wxStaticText(Panel_Auto, ID_STATICTEXT72, _("Outline of Face"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT72"));
    FlexGridSizer57->Add(StaticText70, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    CheckBox1 = new wxCheckBox(Panel_Auto, ID_CHECKBOX2, _("Yes"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX2"));
    CheckBox1->SetValue(false);
    FlexGridSizer57->Add(CheckBox1, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Panel_Auto->SetSizer(FlexGridSizer57);
    FlexGridSizer57->Fit(Panel_Auto);
    FlexGridSizer57->SetSizeHints(Panel_Auto);
    Panel_Coro = new wxPanel(Choicebook_FaceMode, ID_PANEL21, wxPoint(43,12), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL21"));
    FlexGridSizer55 = new wxFlexGridSizer(0, 3, 0, 0);
    StaticText66 = new wxStaticText(Panel_Coro, ID_STATICTEXT68, _("Phoneme:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT68"));
    FlexGridSizer55->Add(StaticText66, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Choice_CoroFacePhoneme = new wxChoice(Panel_Coro, ID_CHOICE_CoroFacePhoneme, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE_CoroFacePhoneme"));
    FlexGridSizer55->Add(Choice_CoroFacePhoneme, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    FlexGridSizer55->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText69 = new wxStaticText(Panel_Coro, ID_STATICTEXT71, _("Elements \nto \nActivate:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT71"));
    FlexGridSizer55->Add(StaticText69, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    CheckListBox_CoroFaceElements = new wxCheckListBox(Panel_Coro, ID_CHECKLISTBOX_CoroFaceElements, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CHECKLISTBOX_CoroFaceElements"));
    FlexGridSizer55->Add(CheckListBox_CoroFaceElements, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    FlexGridSizer55->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Panel_Coro->SetSizer(FlexGridSizer55);
    FlexGridSizer55->Fit(Panel_Coro);
    FlexGridSizer55->SetSizeHints(Panel_Coro);
    Panel_Image_TBD = new wxPanel(Choicebook_FaceMode, ID_PANEL23, wxPoint(50,4), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL23"));
    StaticText67 = new wxStaticText(Panel_Image_TBD, ID_STATICTEXT69, _("TBD"), wxPoint(24,16), wxDefaultSize, 0, _T("ID_STATICTEXT69"));
    Panel_Movie_TBD = new wxPanel(Choicebook_FaceMode, ID_PANEL25, wxPoint(41,13), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL25"));
    StaticText68 = new wxStaticText(Panel_Movie_TBD, ID_STATICTEXT70, _("TBD"), wxPoint(24,24), wxDefaultSize, 0, _T("ID_STATICTEXT70"));
    Panel_PreviousUI = new wxPanel(Choicebook_FaceMode, ID_PANEL27, wxPoint(83,7), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL27"));
    FlexGridSizer56 = new wxFlexGridSizer(0, 3, 0, 0);
    StaticText14 = new wxStaticText(Panel_PreviousUI, ID_STATICTEXT15, _("Phoneme:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT15"));
    FlexGridSizer56->Add(StaticText14, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
    Choice_Faces_Phoneme = new wxChoice(Panel_PreviousUI, ID_CHOICE_Faces_Phoneme, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE_Faces_Phoneme"));
    FlexGridSizer56->Add(Choice_Faces_Phoneme, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    FlexGridSizer56->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText62 = new wxStaticText(Panel_PreviousUI, ID_STATICTEXT64, _("Mouth X:Y"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT64"));
    FlexGridSizer56->Add(StaticText62, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrl_X_Y = new wxTextCtrl(Panel_PreviousUI, ID_TEXTCTRL_X_Y, _("0:0"), wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER, wxDefaultValidator, _T("ID_TEXTCTRL_X_Y"));
    FlexGridSizer56->Add(TextCtrl_X_Y, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    FlexGridSizer56->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText63 = new wxStaticText(Panel_PreviousUI, ID_STATICTEXT65, _("Face Outline X:Y"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT65"));
    FlexGridSizer56->Add(StaticText63, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrl_Outline_X_Y = new wxTextCtrl(Panel_PreviousUI, ID_TEXTCTRL_Outline_X_Y, _("0:0"), wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER, wxDefaultValidator, _T("ID_TEXTCTRL_Outline_X_Y"));
    FlexGridSizer56->Add(TextCtrl_Outline_X_Y, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    FlexGridSizer56->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText64 = new wxStaticText(Panel_PreviousUI, ID_STATICTEXT66, _("Eyes X:Y"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT66"));
    FlexGridSizer56->Add(StaticText64, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrl_Eyes_X_Y = new wxTextCtrl(Panel_PreviousUI, ID_TEXTCTRL_Eyes_X_Y, _("0:0"), wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER, wxDefaultValidator, _T("ID_TEXTCTRL_Eyes_X_Y"));
    FlexGridSizer56->Add(TextCtrl_Eyes_X_Y, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    FlexGridSizer56->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Panel_PreviousUI->SetSizer(FlexGridSizer56);
    FlexGridSizer56->Fit(Panel_PreviousUI);
    FlexGridSizer56->SetSizeHints(Panel_PreviousUI);
    Choicebook_FaceMode->AddPage(Panel_Auto, _("Auto - TBD"), false);
    Choicebook_FaceMode->AddPage(Panel_Coro, _("Coro"), false);
    Choicebook_FaceMode->AddPage(Panel_Image_TBD, _("Image - TBD"), false);
    Choicebook_FaceMode->AddPage(Panel_Movie_TBD, _("Movie - TBD"), false);
    Choicebook_FaceMode->AddPage(Panel_PreviousUI, _("Previous UI - to be dropped\?"), false);
    FlexGridSizer47->Add(Choicebook_FaceMode, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
