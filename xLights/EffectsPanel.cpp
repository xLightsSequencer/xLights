...
const long EffectsPanel::ID_SLIDER_Plasma_Chunks = wxNewId();
const long EffectsPanel::IDD_TEXTCTRL_Plasma_Chunks = wxNewId();
...
EffectsPanel::EffectsPanel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style, const wxString &name)
{
    ...
    Slider34 = new wxSlider(Panel1_Plasma, ID_SLIDER_Plasma_Chunks, 1, 1, 10, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Plasma_Chunks"));
    FlexGridSizer139->Add(Slider34, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
    TextCtrl85 = new wxTextCtrl(Panel1_Plasma, IDD_TEXTCTRL_Plasma_Chunks, _("1"), wxDefaultPosition, wxDLG_UNIT(Panel1_Plasma,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Plasma_Chunks"));
    ...
    Connect(ID_SLIDER_Plasma_Chunks,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedTextCtrl);
    Connect(IDD_TEXTCTRL_Plasma_Chunks,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&EffectsPanel::UpdateLinkedSlider);
