...
EffectsPanel::EffectsPanel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style, const wxString &name)
{
    ...
    TextCtrl_Eff_On_Red = new wxTextCtrl(Panel1_On, ID_TEXTCTRL_EFF_ON_RED, _("255"), wxDefaultPosition, wxSize(30,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL_EFF_ON_RED"));
    ...
    TextCtrl_Eff_On_Grn = new wxTextCtrl(Panel1_On, ID_TEXTCTRL_EFF_ON_GRN, _("255"), wxDefaultPosition, wxSize(30,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL_EFF_ON_GRN"));
    ...
    TextCtrl_Eff_On_Blu = new wxTextCtrl(Panel1_On, ID_TEXTCTRL_EFF_ON_BLU, _("255"), wxDefaultPosition, wxSize(30,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL_EFF_ON_BLU"));
