...
const long EffectsPanel::ID_CHOICE_Curtain_Action = wxNewId();
...
EffectsPanel::EffectsPanel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style, const wxString &name)
{
	...
	Choice_Curtain_Action = new wxChoice(Panel1_Curtain, ID_CHOICE_Curtain_Action, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE_Curtain_Action"));
	FlexGridSizer7->Add(Choice_Curtain_Action, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
