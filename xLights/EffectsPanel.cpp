...
const long EffectsPanel::ID_SLIDER_Single_Chase_Spacing1 = wxNewId();
const long EffectsPanel::ID_STATICTEXT14 = wxNewId();
const long EffectsPanel::ID_SLIDER_Single_Chase_Speed1 = wxNewId();
...
const long EffectsPanel::ID_CHECKBOX_Single_R_TO_L1 = wxNewId();
...
const long EffectsPanel::ID_SLIDER_Single_Chase_Spacing2 = wxNewId();
const long EffectsPanel::ID_STATICTEXT15 = wxNewId();
const long EffectsPanel::ID_SLIDER_Single_Chase_Speed2 = wxNewId();
...
const long EffectsPanel::ID_CHECKBOX_Single_R_TO_L2 = wxNewId();
...
EffectsPanel::EffectsPanel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style, const wxString &name)
{
	...
	FlexGridSizer80->Add(Slider_Circles_Count, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer80->Add(Slider_Circles_Size, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer9->Add(Slider_Single_Color_Mix1, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	Slider_Single_Chase_Spacing1 = new wxSlider(Panel1, ID_SLIDER_Single_Chase_Spacing1, 1, 1, 50, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Single_Chase_Spacing1"));
	FlexGridSizer9->Add(Slider_Single_Chase_Spacing1, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	StaticText15 = new wxStaticText(Panel1, ID_STATICTEXT14, _("Chase Speed"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT14"));
	FlexGridSizer9->Add(StaticText15, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	Slider_Single_Chase_Speed1 = new wxSlider(Panel1, ID_SLIDER_Single_Chase_Speed1, 1, 1, 10, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Single_Chase_Speed1"));
	FlexGridSizer9->Add(Slider_Single_Chase_Speed1, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer9->Add(CheckBox_Single_Group_Arches1, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	StaticText17 = new wxStaticText(Panel1, ID_STATICTEXT16, _("R to L"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT16"));
	FlexGridSizer9->Add(StaticText17, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	CheckBox_Single_R_TO_L1 = new wxCheckBox(Panel1, ID_CHECKBOX_Single_R_TO_L1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_Single_R_TO_L1"));
	CheckBox_Single_R_TO_L1->SetValue(false);
	FlexGridSizer9->Add(CheckBox_Single_R_TO_L1, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	StaticText13 = new wxStaticText(Panel2, ID_STATICTEXT12, _("Chase Spacing"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT12"));
	FlexGridSizer10->Add(StaticText13, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	Slider_Single_Chase_Spacing2 = new wxSlider(Panel2, ID_SLIDER_Single_Chase_Spacing2, 1, 1, 50, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Single_Chase_Spacing2"));
	FlexGridSizer10->Add(Slider_Single_Chase_Spacing2, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText16 = new wxStaticText(Panel2, ID_STATICTEXT15, _("Chase Speed"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT15"));
	FlexGridSizer10->Add(StaticText16, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	Slider_Single_Chase_Speed2 = new wxSlider(Panel2, ID_SLIDER_Single_Chase_Speed2, 0, 0, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Single_Chase_Speed2"));
	FlexGridSizer10->Add(Slider_Single_Chase_Speed2, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer10->Add(CheckBox_Single_Group_Arches2, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	CheckBox_Single_R_TO_L2 = new wxCheckBox(Panel2, ID_CHECKBOX_Single_R_TO_L2, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_Single_R_TO_L2"));
	CheckBox_Single_R_TO_L2->SetValue(false);
	FlexGridSizer10->Add(CheckBox_Single_R_TO_L2, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer6->Add(FlexGridSizer_Palette, 1, wxALIGN_TOP|wxALIGN_CENTER_HORIZONTAL, 5);
	...
	FlexGridSizer8->Add(FlexGridSizer6, 1, wxALIGN_TOP|wxALIGN_CENTER_HORIZONTAL, 5);
	...
	FlexGridSizer8->Add(CheckBox_FitToTime, 1, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 8);
