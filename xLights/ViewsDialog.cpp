...
ViewsDialog::ViewsDialog(wxWindow* parent,wxWindowID id)
{
	...
	FlexGridSizer2->Add(lstAddModelToViews, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer11->Add(FlexGridSizer2, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
