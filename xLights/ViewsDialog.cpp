...
	FlexGridSizer6->Add(lstViews, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer9->Add(FlexGridSizer6, 1, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer10->Add(FlexGridSizer9, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
	Text_ViewName = new wxTextCtrl(this, ID_TEXT_VIEW_NAME, wxEmptyString, wxDefaultPosition, wxSize(151,21), 0, wxDefaultValidator, _T("ID_TEXT_VIEW_NAME"));
	FlexGridSizer13->Add(Text_ViewName, 1, wxALL|wxFIXED_MINSIZE|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer12->Add(FlexGridSizer13, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
...
	FlexGridSizer2->Add(lstAddModelToViews, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
	btAddModelToView = new wxButton(this, ID_BT_ADD_MODEL_VIEW, _("->"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BT_ADD_MODEL_VIEW"));
	FlexGridSizer4->Add(btAddModelToView, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	btRemoveModelFromView = new wxButton(this, ID_BT_REVOVE_MODEL_VIEW, _("<-"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BT_REVOVE_MODEL_VIEW"));
...
	FlexGridSizer5->Add(lstModelsInView, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
	StaticBoxSizer1->Add(FlexGridSizer12, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
