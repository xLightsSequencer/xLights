...
AddShowDialog::AddShowDialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
    ...
    Create(parent, wxID_ANY, _("Schedule Playlist"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxFULL_REPAINT_ON_RESIZE, _T("wxID_ANY"));
    ...
    SpinCtrlStartHour = new wxSpinCtrl(this, ID_SPINCTRL1, _T("18"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(35,-1)), wxSP_ARROW_KEYS, 0, 23, 18, _T("ID_SPINCTRL1"));
    ...
    SpinCtrlStartMinute = new wxSpinCtrl(this, ID_SPINCTRL2, _T("0"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(35,-1)), wxSP_ARROW_KEYS|wxSP_WRAP, 0, 59, 0, _T("ID_SPINCTRL2"));
    ...
    FlexGridSizer4->Add(FlexGridSizer2, 1, wxLEFT|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    SpinCtrlEndHour = new wxSpinCtrl(this, ID_SPINCTRL3, _T("21"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(35,-1)), wxSP_ARROW_KEYS, 0, 23, 21, _T("ID_SPINCTRL3"));
    ...
    SpinCtrlEndMinute = new wxSpinCtrl(this, ID_SPINCTRL4, _T("0"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(35,-1)), wxSP_ARROW_KEYS|wxSP_WRAP, 0, 59, 0, _T("ID_SPINCTRL4"));
    ...
    FlexGridSizer4->Add(FlexGridSizer3, 1, wxLEFT|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    CheckBoxRepeat = new wxCheckBox(this, ID_CHECKBOX_REPEAT, _(" "), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_REPEAT"));
    ...
    CheckBoxRandom = new wxCheckBox(this, ID_CHECKBOX_RANDOM, _(" "), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_RANDOM"));
    ...
    ListBoxDates->SetMinSize(wxSize(-1,150));
    FlexGridSizer5->Add(ListBoxDates, 1, wxBOTTOM|wxLEFT|wxRIGHT|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    StdDialogButtonSizer1 = new wxStdDialogButtonSizer();
    StdDialogButtonSizer1->AddButton(new wxButton(this, wxID_OK, wxEmptyString));
    StdDialogButtonSizer1->AddButton(new wxButton(this, wxID_CANCEL, wxEmptyString));
    StdDialogButtonSizer1->Realize();
    FlexGridSizer5->Add(StdDialogButtonSizer1, 1, wxALL|wxEXPAND|wxFIXED_MINSIZE|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
