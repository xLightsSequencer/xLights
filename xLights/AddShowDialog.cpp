...
AddShowDialog::AddShowDialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
    ...
    FlexGridSizer4->Add(ChoicePlayList, 1, wxALL|wxEXPAND, 5);
    ...
    FlexGridSizer5->Add(FlexGridSizer4, 1, wxALL|wxEXPAND, 5);
    ...
    FlexGridSizer5->Add(ListBoxDates, 1, wxBOTTOM|wxLEFT|wxRIGHT|wxEXPAND, 5);
    StdDialogButtonSizer1 = new wxStdDialogButtonSizer();
    StdDialogButtonSizer1->AddButton(new wxButton(this, wxID_OK, wxEmptyString));
    StdDialogButtonSizer1->AddButton(new wxButton(this, wxID_CANCEL, wxEmptyString));
    StdDialogButtonSizer1->Realize();
    FlexGridSizer5->Add(StdDialogButtonSizer1, 1, wxALL|wxEXPAND|wxFIXED_MINSIZE, 5);
