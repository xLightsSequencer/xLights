...
PerspectivesPanel::PerspectivesPanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	ButtonAddPerspective = new wxButton(this, ID_BUTTON_ADD_PERSPECTIVE, _("+"), wxDefaultPosition, wxSize(20,20), 0, wxDefaultValidator, _T("ID_BUTTON_ADD_PERSPECTIVE"));
	...
	ButtonDeletePerspective = new wxButton(this, D_BUTTON_DELETE_PERSPECTIVE, _("-"), wxDefaultPosition, wxSize(20,20), 0, wxDefaultValidator, _T("D_BUTTON_DELETE_PERSPECTIVE"));
	...
	ButtonRenamePerspective = new wxButton(this, ID_BUTTON_RENAME_PERSPECTIVE, _("Rename"), wxDefaultPosition, wxSize(50,20), 0, wxDefaultValidator, _T("ID_BUTTON_RENAME_PERSPECTIVE"));
	ButtonRenamePerspective->SetToolTip(_("Rename Perspective"));
	FlexGridSizer3->Add(ButtonRenamePerspective, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
