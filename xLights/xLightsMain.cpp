...
const long xLightsFrame::ID_TEXTCTRL_PgoAutoRest = wxNewId();
...
xLightsFrame::xLightsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    CheckBox_PgoAutoRest = new wxCheckBox(PanelPapagayo, ID_CHECKBOX_PgoAutoReset, _("Auto-insert Rest after:"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_PgoAutoReset"));
    ...
    TextCtrl_PgoAutoRest = new wxTextCtrl(PanelPapagayo, ID_TEXTCTRL_PgoAutoRest, _(".2"), wxDefaultPosition, wxSize(55,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL_PgoAutoRest"));
    FlexGridSizer55->Add(TextCtrl_PgoAutoRest, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
    ...
    FlexGridSizer55->Add(TextCtrl_PgoAutoFade, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
