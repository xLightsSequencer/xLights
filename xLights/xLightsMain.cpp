...
xLightsFrame::xLightsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    ListBoxElementList = new wxListView(PanelPreview, ID_LISTBOX_ELEMENT_LIST, wxDefaultPosition, wxDefaultSize, wxLC_REPORT|wxLC_SINGLE_SEL|wxLC_SORT_ASCENDING, wxDefaultValidator, _T("ID_LISTBOX_ELEMENT_LIST"));
    ...
    StaticText23 = new wxStaticText(PanelPreview, ID_STATICTEXT22, _("Model Width"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT22"));
    FlexGridSizer37->Add(StaticText23, 1, wxTOP|wxLEFT|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrlPreviewElementWidth = new wxTextCtrl(PanelPreview, ID_TEXTCTRL_PREVIEW_ELEMENT_SIZE, _("50"), wxDefaultPosition, wxDLG_UNIT(PanelPreview,wxSize(25,-1)), 0, wxDefaultValidator, _T("ID_TEXTCTRL_PREVIEW_ELEMENT_SIZE"));
    ...
    TextCtrlPreviewElementHeight = new wxTextCtrl(PanelPreview, ID_TEXTCTRL3, _("50"), wxDefaultPosition, wxDLG_UNIT(PanelPreview,wxSize(25,-1)), 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
    ...
    SliderPreviewScaleHeight = new wxSlider(PanelPreview, ID_SLIDER_PREVIEW_SCALE, 50, 1, 700, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_PREVIEW_SCALE"));
    ...
    StaticText39 = new wxStaticText(PanelPreview, ID_STATICTEXT31, _("Start Channel"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT31"));
    FlexGridSizer32->Add(StaticText39, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrlModelStartChannel = new wxTextCtrl(PanelPreview, ID_TEXTCTRL4, _("0"), wxDefaultPosition, wxDLG_UNIT(PanelPreview,wxSize(25,-1)), wxTE_PROCESS_ENTER, wxDefaultValidator, _T("ID_TEXTCTRL4"));
	...
	itemCol.SetAlign(wxLIST_FORMAT_LEFT);
	ListBoxElementList->InsertColumn(1, itemCol);
