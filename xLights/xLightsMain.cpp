...
xLightsFrame::xLightsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, wxID_ANY, _("xLights/Nutcracker  (Ver 3.4.17)"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_FRAME_STYLE, _T("wxID_ANY"));
    ...
    CheckBox_AutoFadePgoElement = new wxCheckBox(PanelPapagayo, ID_CHECKBOX_AutoFadePgoElement, _("Auto-fade each element after:"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_AutoFadePgoElement"));
    ...
    TextCtrl_AutoFadePgoElement = new wxTextCtrl(PanelPapagayo, ID_TEXTCTRL_AutoFadePgoElement, _(".2"), wxDefaultPosition, wxSize(55,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL_AutoFadePgoElement"));
    ...
    CheckBox_AutoFadePgoAll = new wxCheckBox(PanelPapagayo, ID_CHECKBOX_AutoFadePgoAll, _("Auto-fade all elements after:"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_AutoFadePgoAll"));
    ...
    TextCtrl_AutoFadePgoAll = new wxTextCtrl(PanelPapagayo, ID_TEXTCTRL_AutoFadePgoAll, _("1.5"), wxDefaultPosition, wxSize(52,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL_AutoFadePgoAll"));
