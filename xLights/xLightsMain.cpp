...
const long xLightsFrame::ID_AUITOOLBARITEM15 = wxNewId();
const long xLightsFrame::ID_AUITOOLBARITEM10 = wxNewId();
const long xLightsFrame::ID_AUITOOLBARITEM11 = wxNewId();
const long xLightsFrame::ID_AUITOOLBARITEM12 = wxNewId();
const long xLightsFrame::ID_AUITOOLBARITEM13 = wxNewId();
...
xLightsFrame::xLightsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, wxID_ANY, _("XL4 ALPHA (Ver 4.0.0) Jan13"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_FRAME_STYLE, _T("wxID_ANY"));
    ...
    PlayToolBar->AddTool(ID_AUITOOLBARITEM2, _("Item label"), play_24_xpm, wxNullBitmap, wxITEM_NORMAL, _("Play"), wxEmptyString, NULL);
    PlayToolBar->AddTool(ID_AUITOOLBARITEM3, _("Item label"), pause_24_xpm, wxNullBitmap, wxITEM_NORMAL, _("Pause"), wxEmptyString, NULL);
    PlayToolBar->AddTool(ID_AUITOOLBARITEM5, _("Item label"), stop_24_off_xpm, wxNullBitmap, wxITEM_NORMAL, _("Stop"), wxEmptyString, NULL);
    ...
    PlayToolBar->AddTool(ID_AUITOOLBARITEM8, _("Item label"), zoom_in_24_xpm, wxNullBitmap, wxITEM_NORMAL, _("Zoom In"), wxEmptyString, NULL);
    PlayToolBar->AddTool(ID_AUITOOLBARITEM9, _("Item label"), zoom_out_24_xpm, wxNullBitmap, wxITEM_NORMAL, _("Zoom Out"), wxEmptyString, NULL);
    PlayToolBar->AddTool(ID_AUITOOLBARITEM14, _("Item label"), settings_24_xpm, wxNullBitmap, wxITEM_NORMAL, _("Settings"), wxEmptyString, NULL);
    PlayToolBar->AddTool(ID_AUITOOLBARITEM15, _("Item label"), gears_24_xpm, wxNullBitmap, wxITEM_NORMAL, _("Gears"), wxEmptyString, NULL);
    PlayToolBar->AddTool(ID_AUITOOLBARITEM10, _("Item label"), eye_open_24_xpm, wxNullBitmap, wxITEM_NORMAL, _("Search"), wxEmptyString, NULL);
    PlayToolBar->AddTool(ID_AUITOOLBARITEM11, _("Item label"), home_24_xpm, wxNullBitmap, wxITEM_NORMAL, _("Home"), wxEmptyString, NULL);
    PlayToolBar->AddTool(ID_AUITOOLBARITEM12, _("Item label"), folder_xpm, wxNullBitmap, wxITEM_NORMAL, _("Open"), wxEmptyString, NULL);
    PlayToolBar->AddTool(ID_AUITOOLBARITEM13, _("Item label"), save_24_xpm, wxNullBitmap, wxITEM_NORMAL, _("Save"), wxEmptyString, NULL);
    PlayToolBar->Realize();
