...
xLightsFrame::xLightsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    FlexGridSizer42 = new wxFlexGridSizer(0, 4, 0, 0);
    ...
    FlexGridSizer55->Add(StaticText68, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    FlexGridSizer42->Add(FlexGridSizer55, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
