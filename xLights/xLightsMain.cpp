...
xLightsFrame::xLightsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    FlexGridSizer2->Add(ShowDirectoryLabel, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    Menu1->Append(ID_MENUITEM4, _("Tool Icon Size"), MenuItem7, wxEmptyString);
