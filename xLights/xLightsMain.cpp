...
xLightsFrame::xLightsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, wxID_ANY, _("xLights/Nutcracker  (Ver 3.0.7)"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_FRAME_STYLE, _T("wxID_ANY"));
    ...
    Panel1_Sean = new wxPanel(Choicebook1, ID_PANEL36, wxPoint(76,10), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL36"));
    FlexGridSizer73 = new wxFlexGridSizer(0, 2, 0, 0);
    StaticText91 = new wxStaticText(Panel1_Sean, ID_STATICTEXT92, _("Count"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT92"));
    FlexGridSizer73->Add(StaticText91, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Slider_Sean1_Count = new wxSlider(Panel1_Sean, ID_SLIDER_Sean1_Count, 50, 1, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Sean1_Count"));
    FlexGridSizer73->Add(Slider_Sean1_Count, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Panel1_Sean->SetSizer(FlexGridSizer73);
    FlexGridSizer73->Fit(Panel1_Sean);
    FlexGridSizer73->SetSizeHints(Panel1_Sean);
    ...
    Choicebook1->AddPage(Panel1_Sean, _("Sean"), false);
