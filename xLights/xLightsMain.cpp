...
xLightsFrame::xLightsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, wxID_ANY, _("xLights/Nutcracker  (Ver 3.0.4)"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_FRAME_STYLE, _T("wxID_ANY"));
    ...
    Spirograph = new wxPanel(Choicebook1, ID_PANEL35, wxPoint(82,12), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL35"));
    FlexGridSizer72 = new wxFlexGridSizer(0, 2, 0, 0);
    StaticText87 = new wxStaticText(Spirograph, ID_STATICTEXT88, _("R - Radius if outer circle"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT88"));
    FlexGridSizer72->Add(StaticText87, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Slider_Spirograph1_R = new wxSlider(Spirograph, ID_SLIDER_Spirograph1_R, 20, 1, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Spirograph1_R"));
    FlexGridSizer72->Add(Slider_Spirograph1_R, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText88 = new wxStaticText(Spirograph, ID_STATICTEXT89, _("r - Radius of inner circle"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT89"));
    FlexGridSizer72->Add(StaticText88, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Slider_Spirograph1_r = new wxSlider(Spirograph, ID_SLIDER_Spirograph1_r, 10, 1, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Spirograph1_r"));
    FlexGridSizer72->Add(Slider_Spirograph1_r, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText89 = new wxStaticText(Spirograph, ID_STATICTEXT90, _("d - Distance"), wxDefaultPosition, wxSize(84,13), 0, _T("ID_STATICTEXT90"));
    FlexGridSizer72->Add(StaticText89, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Slider_Spirograph1_d = new wxSlider(Spirograph, ID_SLIDER_Spirograph1_d, 30, 1, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Spirograph1_d"));
    FlexGridSizer72->Add(Slider_Spirograph1_d, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText90 = new wxStaticText(Spirograph, ID_STATICTEXT91, _("Note: r should be <= R"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT91"));
    FlexGridSizer72->Add(StaticText90, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Spirograph->SetSizer(FlexGridSizer72);
    FlexGridSizer72->Fit(Spirograph);
    FlexGridSizer72->SetSizeHints(Spirograph);
    ...
    Choicebook1->AddPage(Spirograph, _("Spirograph"), false);
