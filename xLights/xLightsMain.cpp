    ...
    _renderMode(renderOnlyMode)
{
    ...
    StatusBarSizer->Add(FileNameText, wxGBPosition(0, 2), wxDefaultSpan, wxALL | wxALIGN_LEFT, 2);
    NodeCountText = new wxStaticText(AUIStatusBar, ID_STATICTEXT8, _("Label"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT, _T("ID_STATICTEXT8"));
    NodeCountText->SetMinSize(wxDLG_UNIT(AUIStatusBar, wxSize(100, -1)));
    NodeCountText->SetLabel("");
    StatusBarSizer->Add(NodeCountText, wxGBPosition(0, 3), wxDefaultSpan, wxALL | wxALIGN_RIGHT | wxEXPAND, 2);
