...
xLightsFrame::xLightsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, wxID_ANY, _("xLights/Nutcracker  (Ver 3.4.8)"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_FRAME_STYLE, _T("wxID_ANY"));
    Move(wxPoint(-1,-1));
    ...
    TextCtrl_pgo_filename = new wxTextCtrl(PanelPapagayo, ID_TEXTCTRL1, wxEmptyString, wxDefaultPosition, wxSize(300,20), 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
    ...
    TextCtrl_papagayo_output_filename = new wxTextCtrl(PanelPapagayo, ID_TEXTCTRL67, wxEmptyString, wxDefaultPosition, wxSize(300,20), 0, wxDefaultValidator, _T("ID_TEXTCTRL67"));
    ...
    FlexGridSizer44 = new wxFlexGridSizer(2, 1, 0, 0);
    FlexGridSizer44->AddGrowableCol(0);
    StaticText43 = new wxStaticText(PGO_COROFACES, ID_STATICTEXT46, _("This is for Standard Coro faces. Assign Channels to Phonemes and eyes.\nEnter your channel numbers, comma delimited, under each Phoneme and voice."), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT46"));
    ...
    FlexGridSizer44->Add(StaticText43, 1, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    ...
    GridCoroFaces->SetRowLabelValue(0, _("Phoneme AI"));
    GridCoroFaces->SetRowLabelValue(1, _("Phoneme E"));
    GridCoroFaces->SetRowLabelValue(2, _("Phoneme etc"));
    GridCoroFaces->SetRowLabelValue(3, _("Phoneme FV"));
    GridCoroFaces->SetRowLabelValue(4, _("Phoneme L"));
    GridCoroFaces->SetRowLabelValue(5, _("Phoneme MBP"));
    GridCoroFaces->SetRowLabelValue(6, _("Phoneme O"));
    GridCoroFaces->SetRowLabelValue(7, _("Phoneme rest"));
    GridCoroFaces->SetRowLabelValue(8, _("Phoneme U"));
    GridCoroFaces->SetRowLabelValue(9, _("Phoneme WQ"));
    GridCoroFaces->SetRowLabelValue(10, _("Eyes - Open"));
    GridCoroFaces->SetRowLabelValue(11, _("Eyes - Closed"));
    ...
    FlexGridSizer44->Add(GridCoroFaces, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    ...
    FlexGridSizer45->Add(Button_AI_image, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
    ...
    FlexGridSizer45->Add(Button_E_image, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
    ...
    FlexGridSizer45->Add(Button_etc_image, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
    ...
    FlexGridSizer45->Add(Button_FV_image, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
    ...
    FlexGridSizer45->Add(Button_L_image, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
    ...
    FlexGridSizer45->Add(Button_MBP_image, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
    ...
    FlexGridSizer45->Add(Button_O_image, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
    ...
    FlexGridSizer45->Add(Button_rest_image, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
    ...
    FlexGridSizer45->Add(Button_U_image, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
    ...
    FlexGridSizer45->Add(Button_WQ_image, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
