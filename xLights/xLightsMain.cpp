...
xLightsFrame::xLightsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Notebook_Text1 = new wxNotebook(Panel1_Text, ID_NOTEBOOK_Text1, wxDefaultPosition, wxSize(267,162), 0, _T("ID_NOTEBOOK_Text1"));
    ...
    Slider_Text1_1_Position = new wxSlider(Panel_Text1_1, ID_SLIDER_Text1_1_Position, 50, 0, 100, wxDefaultPosition, wxSize(172,24), 0, wxDefaultValidator, _T("ID_SLIDER_Text1_1_Position"));
    FlexGridSizer69->Add(Slider_Text1_1_Position, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
    StaticText98 = new wxStaticText(Panel_Text1_1, ID_STATICTEXT99, _("Rotation Degrees\n(0,90,180,270)"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT99"));
    FlexGridSizer69->Add(StaticText98, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Slider_Text1_1_TextRotation = new wxSlider(Panel_Text1_1, ID_SLIDER_Text1_1_TextRotation, 0, 0, 3, wxDefaultPosition, wxSize(172,24), 0, wxDefaultValidator, _T("ID_SLIDER_Text1_1_TextRotation"));
    ...
    Slider_Text1_2_Position = new wxSlider(Panel_Text1_2, ID_SLIDER_Text1_2_Position, 50, 0, 100, wxDefaultPosition, wxSize(172,24), 0, wxDefaultValidator, _T("ID_SLIDER_Text1_2_Position"));
    FlexGridSizer74->Add(Slider_Text1_2_Position, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
    StaticText103 = new wxStaticText(Panel_Text1_2, ID_STATICTEXT104, _("Rotation Degrees\n(0,90,180,270)"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT104"));
    FlexGridSizer74->Add(StaticText103, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Slider_Text1_2_TextRotation = new wxSlider(Panel_Text1_2, ID_SLIDER_Text1_2_TextRotation, 0, 0, 3, wxDefaultPosition, wxSize(172,24), 0, wxDefaultValidator, _T("ID_SLIDER_Text1_2_TextRotation"));
