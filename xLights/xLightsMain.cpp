    ...
    _presetSequenceElements(this), color_mgr(this)
{
    ...
    FlexGridSizerSetupControllerButtons->Add(ButtonVisualise, 1, wxALL|wxEXPAND|wxFIXED_MINSIZE, 5);
    ...
    FlexGridSizerSetupControllerButtons->Add(ButtonUploadInput, 1, wxALL|wxEXPAND|wxFIXED_MINSIZE, 5);
    ...
    FlexGridSizerSetupControllerButtons->Add(ButtonUploadOutput, 1, wxALL|wxEXPAND|wxFIXED_MINSIZE, 5);
    FlexGridSizerSetupControllerButtons->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    FlexGridSizerSetupControllerButtons->Add(ButtonControllerDelete, 1, wxALL|wxEXPAND|wxFIXED_MINSIZE, 5);
    ButtonOpen = new wxButton(Panel5, ID_BUTTON7, _("Open"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON7"));
    FlexGridSizerSetupControllerButtons->Add(ButtonOpen, 1, wxALL|wxEXPAND|wxFIXED_MINSIZE, 5);
    ...
    FlexGridSizerSetupControllerButtons->Add(Button_OpenProxy, 1, wxALL|wxEXPAND|wxFIXED_MINSIZE, 5);
    ...
    FlexGridSizerSetupRight->Add(FlexGridSizerSetupControllerButtons, 1, wxALL, 5);
