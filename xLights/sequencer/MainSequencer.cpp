...
const long MainSequencer::ID_PANEL4 = wxNewId();
...
MainSequencer::MainSequencer(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	PanelTimeLine = new wxPanel(this, ID_PANEL1, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL1"));
	...
	PanelWaveForm = new wxPanel(this, ID_PANEL3, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL3"));
	...
	PanelRowHeadings = new wxPanel(ScrolledEffectsGrid, ID_PANEL6, wxDefaultPosition, wxSize(-1,-1), wxTAB_TRAVERSAL, _T("ID_PANEL6"));
	...
	PanelEffectGrid = new wxPanel(ScrolledEffectsGrid, ID_PANEL4, wxDefaultPosition, wxSize(-1,-1), 0, _T("ID_PANEL4"));
	PanelEffectGrid->SetMinSize(wxSize(-1,-1));
	PanelEffectGrid->SetMaxSize(wxSize(-1,-1));
	FlexGridSizer7->Add(PanelEffectGrid, 1, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_TOP, 0);
	FlexGridSizer14->Add(FlexGridSizer7, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
