...
void SeqSettingsDialog::WizardPage1()
{
    ...
    BitmapButton_Wiz_Music = new FlickerFreeBitmapButton(Panel_Wizard, ID_BITMAPBUTTON_Wiz_Music, musical_seq, wxDefaultPosition, musical_seq.GetDefaultSize(), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_Wiz_Music"));
    ...
    BitmapButton_Wiz_Anim = new FlickerFreeBitmapButton(Panel_Wizard, ID_BITMAPBUTTON_Wiz_Anim, animation_seq, wxDefaultPosition, animation_seq.GetDefaultSize(), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_Wiz_Anim"));
...
void SeqSettingsDialog::WizardPage2()
{
    ...
    GridBagSizerWizard->Add(493,16,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    GridSizerWizButtons = new wxGridSizer(0, 1, 10, 0);
    BitmapButton_25ms = new FlickerFreeBitmapButton(Panel_Wizard, ID_BITMAPBUTTON_25ms, time_25ms, wxDefaultPosition, time_25ms.GetDefaultSize(), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_25ms"));
    ...
    BitmapButton_50ms = new FlickerFreeBitmapButton(Panel_Wizard, ID_BITMAPBUTTON_50ms, time_50ms, wxDefaultPosition, time_50ms.GetDefaultSize(), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_50ms"));
    ...
    BitmapButton_Custom = new FlickerFreeBitmapButton(Panel_Wizard, ID_BITMAPBUTTON_Custom, time_custom, wxDefaultPosition, time_custom.GetDefaultSize(), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_Custom"));
...
void SeqSettingsDialog::WizardPage3()
{
    ...
    BitmapButton_quick_start = new FlickerFreeBitmapButton(Panel_Wizard, ID_BITMAPBUTTON_quick_start, quick_start, wxDefaultPosition, quick_start.GetDefaultSize(), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_quick_start"));
...
void SeqSettingsDialog::WizardPage4()
{
    ...
    BitmapButton_lor = new FlickerFreeBitmapButton(Panel_Wizard, ID_BITMAPBUTTON_lor, lightorama, wxDefaultPosition, lightorama.GetDefaultSize(), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_lor"));
    GridSizerWizButtons->Add(BitmapButton_lor, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    BitmapButton_hls = new FlickerFreeBitmapButton(Panel_Wizard, ID_BITMAPBUTTON_hls, hls, wxDefaultPosition, hls.GetDefaultSize(), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_hls"));
    GridSizerWizButtons->Add(BitmapButton_hls, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    BitmapButton_xlights = new FlickerFreeBitmapButton(Panel_Wizard, ID_BITMAPBUTTON_xlights, xlights_logo, wxDefaultPosition, xlights_logo.GetDefaultSize(), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_xlights"));
    GridSizerWizButtons->Add(BitmapButton_xlights, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    BitmapButton_vixen = new FlickerFreeBitmapButton(Panel_Wizard, ID_BITMAPBUTTON_vixen, vixen, wxDefaultPosition, vixen.GetDefaultSize(), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_vixen"));
    GridSizerWizButtons->Add(BitmapButton_vixen, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    BitmapButton_gled = new FlickerFreeBitmapButton(Panel_Wizard, ID_BITMAPBUTTON_gled, glediator, wxDefaultPosition, glediator.GetDefaultSize(), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_gled"));
    GridSizerWizButtons->Add(BitmapButton_gled, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    BitmapButton_lynx = new FlickerFreeBitmapButton(Panel_Wizard, ID_BITMAPBUTTON_lynx, lynx, wxDefaultPosition, lynx.GetDefaultSize(), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_lynx"));
