...
const long BufferPanel::ID_STATICTEXT8 = wxNewId();
const long BufferPanel::ID_SCROLLEDWINDOW1 = wxNewId();
const long BufferPanel::ID_PANEL2 = wxNewId();
const long BufferPanel::ID_STATICTEXT9 = wxNewId();
...
const long BufferPanel::ID_PANEL3 = wxNewId();
const long BufferPanel::ID_AUINOTEBOOK1 = wxNewId();
//*)
...
BufferPanel::BufferPanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	AuiNotebook1 = new wxAuiNotebook(this, ID_AUINOTEBOOK1, wxDefaultPosition, wxDefaultSize, wxAUI_NB_SCROLL_BUTTONS|wxTAB_TRAVERSAL);
	Panel1 = new wxPanel(AuiNotebook1, ID_PANEL2, wxPoint(60,55), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL2"));
	...
	FullBufferSizer = new wxFlexGridSizer(0, 1, 0, 0);
	...
	BitmapButton_Blur = new ValueCurveButton(ScrolledWindow1, ID_VALUECURVE_Blur, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_VALUECURVE_Blur"));
	...
	FullBufferSizer->Add(BufferSizer, 1, wxALL|wxEXPAND, 5);
	...
	StaticText10 = new wxStaticText(ScrolledWindow1, ID_STATICTEXT8, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT8"));
	FlexGridSizer3->Add(StaticText10, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	FullBufferSizer->Add(FlexGridSizer3, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	Panel1->SetSizer(FlexGridSizer11);
	FlexGridSizer11->Fit(Panel1);
	FlexGridSizer11->SetSizeHints(Panel1);
	Panel2 = new wxPanel(AuiNotebook1, ID_PANEL3, wxPoint(89,10), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL3"));
	...
	StaticText11 = new wxStaticText(ScrolledWindow2, ID_STATICTEXT9, _("Preset"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT9"));
	...
	BitmapButton_VCRotation = new ValueCurveButton(ScrolledWindow2, ID_VALUECURVE_Rotation, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_VALUECURVE_Rotation"));
	...
	RotoZoomSizer->Add(FlexGridSizer2, 1, wxALL|wxEXPAND, 2);
	...
	StaticText3 = new wxStaticText(ScrolledWindow2, ID_STATICTEXT3, _("Rotations"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
	...
	BitmapButton_VCRotations = new ValueCurveButton(ScrolledWindow2, ID_VALUECURVE_Rotations, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_VALUECURVE_Rotations"));
	...
	RotoZoomSizer->Add(FlexGridSizer5, 1, wxALL|wxEXPAND, 2);
	...
	StaticText8 = new wxStaticText(ScrolledWindow2, ID_STATICTEXT6, _("Pivot Point X"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT6"));
	...
	BitmapButton_VCPivotPointX = new ValueCurveButton(ScrolledWindow2, ID_VALUECURVE_PivotPointX, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_VALUECURVE_PivotPointX"));
	...
	RotoZoomSizer->Add(FlexGridSizer9, 1, wxALL|wxEXPAND, 2);
	...
	StaticText9 = new wxStaticText(ScrolledWindow2, ID_STATICTEXT7, _("Pivot Point Y"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
	...
	BitmapButton_VCPivotPointY = new ValueCurveButton(ScrolledWindow2, ID_VALUECURVE_PivotPointY, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_VALUECURVE_PivotPointY"));
	...
	RotoZoomSizer->Add(FlexGridSizer10, 1, wxALL|wxEXPAND, 2);
	...
	StaticText6 = new wxStaticText(ScrolledWindow2, ID_STATICTEXT4, _("Zoom"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT4"));
	...
	BitmapButton_VCZoom = new ValueCurveButton(ScrolledWindow2, ID_VALUECURVE_Zoom, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_VALUECURVE_Zoom"));
	...
	RotoZoomSizer->Add(FlexGridSizer7, 1, wxALL|wxEXPAND, 2);
	...
	StaticText7 = new wxStaticText(ScrolledWindow2, ID_STATICTEXT5, _("Zoom Quality"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT5"));
	...
	RotoZoomSizer->Add(FlexGridSizer8, 1, wxALL|wxEXPAND, 2);
	...
	FlexGridSizer15->Add(ScrolledWindow2, 1, wxALL, 2);
	Panel2->SetSizer(FlexGridSizer15);
	FlexGridSizer15->Fit(Panel2);
	FlexGridSizer15->SetSizeHints(Panel2);
	AuiNotebook1->AddPage(Panel1, _("Buffer"));
	AuiNotebook1->AddPage(Panel2, _("Roto-Zoom"));
	FlexGridSizer1->Add(AuiNotebook1, 1, wxALL|wxEXPAND, 2);
...
void BufferPanel::OnResize(wxSizeEvent& event)
{
    ...
    AuiNotebook1->SetSize(s);
    AuiNotebook1->SetMinSize(s);
    AuiNotebook1->SetMaxSize(s);
    AuiNotebook1->Refresh();
    ...
    ScrolledWindow1->SetVirtualSize(t);
    ScrolledWindow1->SetScrollRate(5, 5);
    ScrolledWindow1->Refresh();

    ScrolledWindow2->SetSize(s);
    ScrolledWindow2->SetMinSize(s);
    ScrolledWindow2->SetMaxSize(s);
    ScrolledWindow2->FitInside();
    ScrolledWindow2->SetVirtualSize(t);
