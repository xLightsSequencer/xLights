...
BufferTransformProperties::BufferTransformProperties(wxWindow* parent,RotoZoomParms* parms, wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	Slider_ZoomMaximum = new wxSlider(this, IDD_SLIDER_ZoomMaximum, 20, 3, 30, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("IDD_SLIDER_ZoomMaximum"));
