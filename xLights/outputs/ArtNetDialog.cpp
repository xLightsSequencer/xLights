...
const long ArtNetDialog::ID_STATICTEXT9 = wxNewId();
...
ArtNetDialog::ArtNetDialog(wxWindow* parent, ArtNetOutput* artnet, OutputManager* outputManager, wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticText9 = new wxStaticText(this, ID_STATICTEXT9, _("# of Universes"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT9"));
