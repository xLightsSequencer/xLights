...
public:
    ...
    virtual int GetMaxChannels() const override { return 1440; }
    virtual bool IsValidChannelCount(long channelCount) const override { return channelCount > 0 && channelCount <= 1440; }
