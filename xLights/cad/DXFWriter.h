...
// rotaion and angle vales are 0-360
...
private:
	...
	void DrawText(float x, float y, float z, std::string const& text, float height, float rotaion, int thickness, int layer);
	void DrawLine(float x1, float y1, float z1, float x2, float y2, float z2, int thickness, int layer );
	void DrawCircle(float x, float y, float z, float radius, int thickness, int layer );
	void DrawArc(float x, float y, float z, float radius, float startAngle, float endAngle, int thickness, int layer);
	void DrawPoint(float x, float y, float z, int thickness, int layer);
