...
public:
    ...
    wxChoice* Choice_CoroFacePhoneme;
    ...
    wxChoicebook* Choicebook_FaceMode;
...
protected:
    ...
    static const long ID_CHOICE_CoroFacePhoneme;
    ...
    static const long ID_CHOICEBOOK_FaceMode;
