...
void MapXLightsStrandEffects(EffectLayer* target, const std::string& name,
                             ...
                             SequencePackage& xsqPkg, bool lock, const std::map<std::string, std::string>& mapping, const std::map<std::string, std::string>& mappingModelType)
{
...
void MapXLightsEffects(Element* target,
                       ...
                       std::map<std::string, EffectLayer*>& layerMap,
                       std::vector<EffectLayer*>& mapped, bool eraseExisting,
                       SequencePackage& xsqPkg, bool lock, const std::map<std::string, std::string>& mapping, bool convertRender, const std::map<std::string, std::string>& mappingModelType)
{
    static log4cpp::Category& logger_base = log4cpp::Category::getInstance(std::string("log_base"));
