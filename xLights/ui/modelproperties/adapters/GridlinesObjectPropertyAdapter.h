...
class GridlinesObjectPropertyAdapter : public ViewObjectPropertyAdapter {
public:
    explicit GridlinesObjectPropertyAdapter(GridlinesObject& obj);
    ~GridlinesObjectPropertyAdapter() override = default;
