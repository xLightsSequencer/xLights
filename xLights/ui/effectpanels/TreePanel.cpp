...
TreePanel::TreePanel(wxWindow* parent) : xlEffectPanel()
{
...
void TreePanel::SetDefaultParameters()
{
    SetSliderValue(Slider_Tree_Branches, 3);
    SetSliderValue(Slider_Tree_Speed, 10);
