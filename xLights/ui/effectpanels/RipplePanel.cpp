...
RipplePanel::RipplePanel(wxWindow* parent) : xlEffectPanel()
{
...
void RipplePanel::SetDefaultParameters()
{
    BitmapButton_Ripple_CyclesVC->SetActive(false);
    BitmapButton_Ripple_ThicknessVC->SetActive(false);
    BitmapButton_Ripple_RotationVC->SetActive(false);
    BitmapButton_Ripple_XCVC->SetActive(false);
    BitmapButton_Ripple_YCVC->SetActive(false);

    BitmapButton_Ripple_SpacingVC->SetActive(false);
    BitmapButton_Ripple_ScaleVC->SetActive(false);
    BitmapButton_Ripple_TwistVC->SetActive(false);
    BitmapButton_Ripple_VelocityVC->SetActive(false);
    BitmapButton_Ripple_DirectionVC->SetActive(false);
    BitmapButton_Ripple_OutlineVC->SetActive(false);

    SetChoiceValue(Choice_Ripple_Object_To_Draw, "Circle");
    SetChoiceValue(Choice_Ripple_Movement, "Explode");

    SetSliderValue(Slider_Ripple_Thickness, 3);
    SetSliderValue(Slider_Ripple_Cycles, 10);
    SetSliderValue(Slider_Ripple_Points, 5);
    SetSliderValue(Slider_Ripple_Rotation, 0);
    SetSliderValue(Slider_Ripple_XC, 0);
    SetSliderValue(Slider_Ripple_YC, 0);

    SetSliderValue(Slider_Ripple_Scale, 100);
    SetSliderValue(Slider_Ripple_Direction, 0);
    SetSliderValue(Slider_Ripple_Velocity, 0);
    SetSliderValue(Slider_Ripple_Twist, 0);
    SetSliderValue(Slider_Ripple_Spacing, 10);
    SetSliderValue(Slider_Ripple_Outline, 10);

    FilePickerCtrl_Ripple_SVG->SetFileName(wxFileName(""));

    SetCheckBoxValue(CheckBox_Ripple3D, false);
    SetChoiceValue(Choice_Ripple_Draw_Style, "Old");
}
