...
ButterflyPanel::ButterflyPanel(wxWindow* parent) : xlEffectPanel()
{
...
void ButterflyPanel::SetDefaultParameters()
{
    SetChoiceValue(Choice_Butterfly_Colors, "Rainbow");
    SetChoiceValue(Choice_Butterfly_Direction, "Normal");

    BitmapButton_Butterfly_Chunks->SetActive(false);
    BitmapButton_Butterfly_Skip->SetActive(false);
    BitmapButton_Butterfly_Speed->SetActive(false);

    SetSliderValue(Slider_Butterfly_Style, 1);
    SetSliderValue(Slider_Butterfly_Chunks, 1);
    SetSliderValue(Slider_Butterfly_Skip, 2);
    SetSliderValue(Slider_Butterfly_Speed, 10);
}
