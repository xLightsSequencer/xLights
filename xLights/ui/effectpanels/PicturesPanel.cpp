...
PicturesPanel::PicturesPanel(wxWindow* parent) : xlEffectPanel()
{
...
void PicturesPanel::SetDefaultParameters()
{
    ...
    SetSliderValue(Slider_Pictures_Speed, 10);
    SetSliderValue(Slider_Pictures_FR, 10);
    SetSliderValue(Slider1, 0);
    SetSliderValue(Slider_PicturesXC, 0);
    SetSliderValue(Slider_PicturesYC, 0);
    SetSliderValue(Slider_PicturesEndXC, 0);
    SetSliderValue(Slider_PicturesEndYC, 0);
    SetSliderValue(Slider_Pictures_EndScale, 100);
    SetSliderValue(Slider_Pictures_StartScale, 100);

    SetChoiceValue(Choice_Pictures_Direction, "none");
    SetChoiceValue(Choice_Scaling, "No Scaling");

    SetCheckBoxValue(CheckBox_Pictures_PixelOffsets, false);
    SetCheckBoxValue(CheckBox_Pictures_WrapX, false);
    SetCheckBoxValue(CheckBox_Pictures_Shimmer, false);
    SetCheckBoxValue(CheckBox_LoopGIF, false);
    SetCheckBoxValue(CheckBox_SuppressGIFBackground, true);
