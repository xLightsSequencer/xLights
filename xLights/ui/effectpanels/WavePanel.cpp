...
WavePanel::WavePanel(wxWindow* parent) : xlEffectPanel()
{
...
void WavePanel::SetDefaultParameters()
{
    SetChoiceValue(Choice_Wave_Type, "Sine");
    SetChoiceValue(Choice_Fill_Colors, "None");
    SetCheckBoxValue(CheckBox_Mirror_Wave, false);
    SetSliderValue(Slider_Number_Waves, 900);
    SetSliderValue(Slider_Thickness_Percentage, 5);
    SetSliderValue(Slider_Wave_Height, 50);
    SetSliderValue(Slider_Wave_Speed, 1000);
    SetSliderValue(Slider_Y_Offset, 0);
    SetChoiceValue(Choice_Wave_Direction, "Right to Left");
    BitmapButton_Number_WavesVC->SetActive(false);
    BitmapButton_Thickness_PercentageVC->SetActive(false);
    BitmapButton_Wave_HeightVC->SetActive(false);
    BitmapButton_Wave_SpeedVC->SetActive(false);
    BitmapButton_Wave_YOffsetVC->SetActive(false);
}
