...
GarlandsPanel::GarlandsPanel(wxWindow* parent) : xlEffectPanel()
{
...
void GarlandsPanel::SetDefaultParameters()
{
    BitmapButton_Garlands_CyclesVC->SetActive(false);
    BitmapButton_Garlands_SpacingVC->SetActive(false);

    SetSliderValue(Slider_Garlands_Type, 0);
    SetSliderValue(Slider_Garlands_Spacing, 10);
    SetSliderValue(Slider_Garlands_Cycles, 10);

    SetChoiceValue(Choice_Garlands_Direction, "Up");
}
