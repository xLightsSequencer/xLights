...
LifePanel::LifePanel(wxWindow* parent) : xlEffectPanel()
{
...
void LifePanel::SetDefaultParameters()
{
    SetSliderValue(Slider_Life_Count, 50);
    SetSliderValue(Slider_Life_Seed, 0);
    SetSliderValue(Slider_Life_Speed, 10);
}
