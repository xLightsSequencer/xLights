...
GlediatorPanel::GlediatorPanel(wxWindow* parent) : xlEffectPanel()
{
...
void GlediatorPanel::SetDefaultParameters()
{
    FilePickerCtrl_Glediator_Filename->SetFileName(wxFileName());
    SetChoiceValue(Choice_Glediator_DurationTreatment, "Normal");
}
