...
PlasmaPanel::PlasmaPanel(wxWindow* parent) : xlEffectPanel()
{
...
void PlasmaPanel::SetDefaultParameters()
{
    BitmapButton_Plasma_SpeedVC->SetActive(false);

    SetSliderValue(Slider_Plasma_Style, 1);
    SetSliderValue(Slider_Plasma_Line_Density, 1);
    SetSliderValue(Slider_Plasma_Speed, 10);

    SetChoiceValue(Choice_Plasma_Color, "Normal");
}
