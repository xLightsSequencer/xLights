...
//(*IdInit(TextPanel)
const wxWindowID TextPanel::ID_STATICTEXT_Text = wxNewId();
const wxWindowID TextPanel::ID_TEXTCTRL_Text = wxNewId();
const wxWindowID TextPanel::ID_STATICTEXT1 = wxNewId();
const wxWindowID TextPanel::ID_FILEPICKERCTRL_Text_File = wxNewId();
const wxWindowID TextPanel::ID_STATICTEXT2 = wxNewId();
const wxWindowID TextPanel::ID_CHOICE_Text_LyricTrack = wxNewId();
const wxWindowID TextPanel::ID_STATICTEXT_FONTLABEL = wxNewId();
const wxWindowID TextPanel::ID_FONTPICKER_Text_Font = wxNewId();
const wxWindowID TextPanel::ID_BITMAPBUTTON_FONTPICKER_Text_Font = wxNewId();
const wxWindowID TextPanel::ID_STATICTEXT_Text_Font = wxNewId();
const wxWindowID TextPanel::ID_CHOICE_Text_Font = wxNewId();
const wxWindowID TextPanel::ID_BITMAPBUTTON1 = wxNewId();
const wxWindowID TextPanel::ID_STATICTEXT_Text_Dir = wxNewId();
const wxWindowID TextPanel::ID_CHOICE_Text_Dir = wxNewId();
const wxWindowID TextPanel::ID_BITMAPBUTTON_CHOICE_Text_Dir = wxNewId();
const wxWindowID TextPanel::ID_CHECKBOX_TextToCenter = wxNewId();
const wxWindowID TextPanel::ID_CHECKBOX_TextNoRepeat = wxNewId();
const wxWindowID TextPanel::ID_BITMAPBUTTON_TextToCenter = wxNewId();
const wxWindowID TextPanel::ID_STATICTEXT_Text_Speed = wxNewId();
const wxWindowID TextPanel::IDD_SLIDER_Text_Speed = wxNewId();
const wxWindowID TextPanel::ID_TEXTCTRL_Text_Speed = wxNewId();
const wxWindowID TextPanel::ID_BITMAPBUTTON_Text_Speed = wxNewId();
const wxWindowID TextPanel::ID_STATICTEXT_Text_Effect = wxNewId();
const wxWindowID TextPanel::ID_CHOICE_Text_Effect = wxNewId();
const wxWindowID TextPanel::ID_BITMAPBUTTON_CHOICE_Text_Effect = wxNewId();
const wxWindowID TextPanel::ID_STATICTEXT_Text_Count = wxNewId();
const wxWindowID TextPanel::ID_CHOICE_Text_Count = wxNewId();
const wxWindowID TextPanel::ID_BITMAPBUTTON_CHOICE_Text_Count = wxNewId();
const wxWindowID TextPanel::ID_CHECKBOX_Text_PixelOffsets = wxNewId();
const wxWindowID TextPanel::ID_CHECKBOX_Text_Color_PerWord = wxNewId();
const wxWindowID TextPanel::ID_STATICTEXT_Text_XStart = wxNewId();
const wxWindowID TextPanel::ID_SLIDER_Text_XStart = wxNewId();
const wxWindowID TextPanel::IDD_TEXTCTRL_Text_XStart = wxNewId();
const wxWindowID TextPanel::ID_STATICTEXT_Text_YStart = wxNewId();
const wxWindowID TextPanel::IDD_TEXTCTRL_Text_YStart = wxNewId();
const wxWindowID TextPanel::ID_SLIDER_Text_YStart = wxNewId();
const wxWindowID TextPanel::IDD_PANEL6 = wxNewId();
const wxWindowID TextPanel::ID_STATICTEXT_Text_XEnd = wxNewId();
const wxWindowID TextPanel::ID_SLIDER_Text_XEnd = wxNewId();
const wxWindowID TextPanel::IDD_TEXTCTRL_Text_XEnd = wxNewId();
const wxWindowID TextPanel::ID_STATICTEXT_Text_YEnd = wxNewId();
const wxWindowID TextPanel::IDD_TEXTCTRL_Text_YEnd = wxNewId();
const wxWindowID TextPanel::ID_SLIDER_Text_YEnd = wxNewId();
const wxWindowID TextPanel::IDD_PANEL17 = wxNewId();
const wxWindowID TextPanel::IDD_NOTEBOOK1 = wxNewId();
const wxWindowID TextPanel::ID_PANEL_Text1 = wxNewId();
//*)
...
TextPanel::TextPanel(wxWindow* parent) : xlEffectPanel()
{
	...
	FlexGridSizer119->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText162 = new wxStaticText(Panel_Text1, ID_STATICTEXT_FONTLABEL, _("Font"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT_FONTLABEL"));
	...
	BitmapButton_TextFont = new xlLockButton(Panel_Text1, ID_BITMAPBUTTON_FONTPICKER_Text_Font, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_FONTPICKER_Text_Font"));
	...
	BitmapButton1 = new xlLockButton(Panel_Text1, ID_BITMAPBUTTON1, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON1"));
	...
	Choice_Text_Dir->Append(_("left-right"));
	Choice_Text_Dir->Append(_("up-down"));
	FlexGridSizer48->Add(Choice_Text_Dir, 1, wxALL|wxEXPAND, 2);
	BitmapButton_TextDir = new xlLockButton(Panel_Text1, ID_BITMAPBUTTON_CHOICE_Text_Dir, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHOICE_Text_Dir"));
	...
	TextCtrl72 = new BulkEditTextCtrl(Panel_Text1, ID_TEXTCTRL_Text_Speed, _T("10"), wxDefaultPosition, wxDLG_UNIT(Panel_Text1,wxSize(20,-1)), 0, wxDefaultValidator, _T("ID_TEXTCTRL_Text_Speed"));
	...
	BitmapButton_Text_Speed = new xlLockButton(Panel_Text1, ID_BITMAPBUTTON_Text_Speed, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_Text_Speed"));
	...
	BitmapButton_TextEffect = new xlLockButton(Panel_Text1, ID_BITMAPBUTTON_CHOICE_Text_Effect, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHOICE_Text_Effect"));
	...
	BitmapButton_TextCount = new xlLockButton(Panel_Text1, ID_BITMAPBUTTON_CHOICE_Text_Count, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHOICE_Text_Count"));
	...
	TextCtrl91 = new BulkEditTextCtrl(Panel16, IDD_TEXTCTRL_Text_XStart, _T("0"), wxDefaultPosition, wxDLG_UNIT(Panel16,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Text_XStart"));
	...
	TextCtrl92 = new BulkEditTextCtrl(Panel16, IDD_TEXTCTRL_Text_YStart, _T("0"), wxDefaultPosition, wxDLG_UNIT(Panel16,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Text_YStart"));
	...
	TextCtrl93 = new BulkEditTextCtrl(Panel17, IDD_TEXTCTRL_Text_XEnd, _T("0"), wxDefaultPosition, wxDLG_UNIT(Panel17,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Text_XEnd"));
	...
	TextCtrl94 = new BulkEditTextCtrl(Panel17, IDD_TEXTCTRL_Text_YEnd, _T("0"), wxDefaultPosition, wxDLG_UNIT(Panel17,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Text_YEnd"));
...
static inline void SetCheckboxValueById(wxWindow* w, int id, bool b)
{
...
void TextPanel::SetDefaultParameters()
{
    SetTextValue(TextCtrl_Text, "");
    FilePickerCtrl1->SetFileName(wxFileName(""));
    SetChoiceValue(Choice_Text_Dir, "none");
    Choice_LyricTrack->SetSelection(-1);
    SetSliderValue(Slider_Text_Speed, 10);
    SetChoiceValue(Choice_Text_Effect, "normal");
    SetChoiceValue(Choice_Text_Count, "none");
    SetCheckboxValueById(this, ID_CHECKBOX_TextToCenter, false);
    SetCheckBoxValue(CheckBox_Text_PixelOffsets, false);
    SetCheckboxValueById(this, ID_CHECKBOX_Text_Color_PerWord, false);
    SetSliderValue(Slider_Text_XStart, 0);
    SetSliderValue(Slider_Text_YStart, 0);
    SetSliderValue(Slider_Text_XEnd, 0);
    SetSliderValue(Slider_Text_YEnd, 0);
}

void TextPanel::SetPanelStatus(Model* cls)
{
    Choice_LyricTrack->Clear();
    ...
    for (int i = 0; i < (int)mSequenceElements->GetElementCount(); i++)
    {
        ...
        if (e->GetType() == ElementType::ELEMENT_TYPE_TIMING)
        {
            ...
            {
                if (te->HasLyrics(0)) {
                    Choice_LyricTrack->Append(n + " - Phrases");
                }
                if (te->HasLyrics(1)) {
                    Choice_LyricTrack->Append(n + " - Words");
                }
            }
            else
            {
    ...
    if (Choice_LyricTrack->GetCount() > 0)
    {
        Choice_LyricTrack->Select(0);
    }
