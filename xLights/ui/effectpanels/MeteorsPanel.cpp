...
MeteorsPanel::MeteorsPanel(wxWindow* parent) : xlEffectPanel()
{
...
void MeteorsPanel::SetDefaultParameters()
{
    BitmapButton_Meteors_Count->SetActive(false);
    BitmapButton_Meteors_Length->SetActive(false);
    BitmapButton_Meteors_Speed->SetActive(false);
    BitmapButton_Meteors_Swirl_Intensity->SetActive(false);
    BitmapButton_Meteors_XOffsetVC->SetActive(false);
    BitmapButton_Meteors_YOffsetVC->SetActive(false);

    SetChoiceValue(Choice_Meteors_Effect, "Down");
    SetChoiceValue(Choice_Meteors_Type, "Rainbow");

    SetSliderValue(Slider_Meteors_Count, 10);
    SetSliderValue(Slider_Meteors_Length, 25);
    SetSliderValue(Slider_Meteors_Swirl_Intensity, 0);
    SetSliderValue(Slider_Meteors_Speed, 10);
    SetSliderValue(Slider_Meteors_XOffset, 0);
    SetSliderValue(Slider_Meteors_YOffset, 0);

    SetCheckBoxValue(CheckBox_Meteors_UseMusic, false);
    SetCheckBoxValue(CheckBox_FadeWithDistance, false);
}
