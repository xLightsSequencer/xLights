...
AdjustPanel::AdjustPanel(wxWindow* parent) : xlEffectPanel()
{
...
void AdjustPanel::SetDefaultParameters()
{
    SetChoiceValue(Choice_Action, "None");
    SetSpinValue(SpinCtrl_Value1, 0);
    SetSpinValue(SpinCtrl_Value2, 0);
    SetSpinValue(SpinCtrl_NthChannel, 1);
    SetSpinValue(SpinCtrl_StartingAt, 1);
