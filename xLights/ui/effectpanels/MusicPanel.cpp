...
MusicPanel::MusicPanel(wxWindow* parent) : xlEffectPanel()
{
...
void MusicPanel::SetDefaultParameters()
{
    BitmapButton_Music_OffsetVC->SetActive(false);

    SetSliderValue(Slider_Music_Bars, 20);
    SetChoiceValue(Choice_Music_Type, "Morph");
    SetSliderValue(Slider_Music_Sensitivity, 50);
    SetCheckBoxValue(CheckBox_Music_Scale, false);
    SetChoiceValue(Choice_Music_Scaling, "None");
    SetSliderValue(Slider_Music_Offset, 0);
    SetSliderValue(Slider_Music_StartNote, 60);
    SetSliderValue(Slider_Music_EndNote, 80);
    SetChoiceValue(Choice_Music_Colour, "Distinct");
    SetCheckBoxValue(CheckBox_Music_Fade, false);
    SetCheckBoxValue(CheckBox_Music_LogarithmicXAxis, false);
}
