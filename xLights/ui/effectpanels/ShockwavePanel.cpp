...
const wxWindowID ShockwavePanel::ID_STATICTEXT_Shockwave_CenterX = wxNewId();
const wxWindowID ShockwavePanel::ID_SLIDER_Shockwave_CenterX = wxNewId();
const wxWindowID ShockwavePanel::ID_VALUECURVE_Shockwave_CenterX = wxNewId();
const wxWindowID ShockwavePanel::IDD_TEXTCTRL_Shockwave_CenterX = wxNewId();
const wxWindowID ShockwavePanel::ID_BITMAPBUTTON_SLIDER_Shockwave_CenterX = wxNewId();
const wxWindowID ShockwavePanel::ID_STATICTEXT_Shockwave_CenterY = wxNewId();
const wxWindowID ShockwavePanel::ID_SLIDER_Shockwave_CenterY = wxNewId();
const wxWindowID ShockwavePanel::ID_VALUECURVE_Shockwave_CenterY = wxNewId();
const wxWindowID ShockwavePanel::IDD_TEXTCTRL_Shockwave_CenterY = wxNewId();
const wxWindowID ShockwavePanel::ID_BITMAPBUTTON_SLIDER_Shockwave_CenterY = wxNewId();
const wxWindowID ShockwavePanel::ID_STATICTEXT_Shockwave_Start_Radius = wxNewId();
const wxWindowID ShockwavePanel::ID_SLIDER_Shockwave_Start_Radius = wxNewId();
const wxWindowID ShockwavePanel::ID_VALUECURVE_Shockwave_Start_Radius = wxNewId();
const wxWindowID ShockwavePanel::IDD_TEXTCTRL_Shockwave_Start_Radius = wxNewId();
const wxWindowID ShockwavePanel::ID_BITMAPBUTTON_SLIDER_Shockwave_Start_Radius = wxNewId();
const wxWindowID ShockwavePanel::ID_STATICTEXT_Shockwave_End_Radius = wxNewId();
const wxWindowID ShockwavePanel::ID_SLIDER_Shockwave_End_Radius = wxNewId();
const wxWindowID ShockwavePanel::ID_VALUECURVE_Shockwave_End_Radius = wxNewId();
const wxWindowID ShockwavePanel::IDD_TEXTCTRL_Shockwave_End_Radius = wxNewId();
const wxWindowID ShockwavePanel::ID_BITMAPBUTTON_SLIDER_Shockwave_End_Radius = wxNewId();
const wxWindowID ShockwavePanel::ID_STATICTEXT_Shockwave_Start_Width = wxNewId();
const wxWindowID ShockwavePanel::ID_SLIDER_Shockwave_Start_Width = wxNewId();
const wxWindowID ShockwavePanel::ID_VALUECURVE_Shockwave_Start_Width = wxNewId();
const wxWindowID ShockwavePanel::IDD_TEXTCTRL_Shockwave_Start_Width = wxNewId();
const wxWindowID ShockwavePanel::ID_BITMAPBUTTON_SLIDER_Shockwave_Start_Width = wxNewId();
const wxWindowID ShockwavePanel::ID_STATICTEXT_Shockwave_End_Width = wxNewId();
const wxWindowID ShockwavePanel::ID_SLIDER_Shockwave_End_Width = wxNewId();
const wxWindowID ShockwavePanel::ID_VALUECURVE_Shockwave_End_Width = wxNewId();
const wxWindowID ShockwavePanel::IDD_TEXTCTRL_Shockwave_End_Width = wxNewId();
const wxWindowID ShockwavePanel::ID_BITMAPBUTTON_SLIDER_Shockwave_End_Width = wxNewId();
const wxWindowID ShockwavePanel::ID_PANEL40 = wxNewId();
const wxWindowID ShockwavePanel::ID_STATICTEXT_Shockwave_Accel = wxNewId();
const wxWindowID ShockwavePanel::ID_SLIDER_Shockwave_Accel = wxNewId();
const wxWindowID ShockwavePanel::IDD_TEXTCTRL_Shockwave_Accel = wxNewId();
const wxWindowID ShockwavePanel::ID_BITMAPBUTTON_SLIDER_Shockwave_Accel = wxNewId();
const wxWindowID ShockwavePanel::ID_STATICTEXT1 = wxNewId();
const wxWindowID ShockwavePanel::ID_SLIDER_Shockwave_Cycles = wxNewId();
const wxWindowID ShockwavePanel::IDD_TEXTCTRL_Shockwave_Cycles = wxNewId();
const wxWindowID ShockwavePanel::ID_BITMAPBUTTON_SLIDER_Shockwave_Cycles = wxNewId();
const wxWindowID ShockwavePanel::ID_CHECKBOX_Shockwave_Blend_Edges = wxNewId();
const wxWindowID ShockwavePanel::ID_CHECKBOX_Shockwave_Scale = wxNewId();
const wxWindowID ShockwavePanel::ID_PANEL44 = wxNewId();
const wxWindowID ShockwavePanel::ID_NOTEBOOK_Shockwave = wxNewId();
//*)
...
ShockwavePanel::ShockwavePanel(wxWindow* parent) : xlEffectPanel()
{
	...
	TextCtrl_Shockwave_CenterX = new BulkEditTextCtrl(Panel10, IDD_TEXTCTRL_Shockwave_CenterX, _T("50"), wxDefaultPosition, wxDLG_UNIT(Panel10,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Shockwave_CenterX"));
	...
	TextCtrl_Shockwave_CenterY = new BulkEditTextCtrl(Panel10, IDD_TEXTCTRL_Shockwave_CenterY, _T("50"), wxDefaultPosition, wxDLG_UNIT(Panel10,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Shockwave_CenterY"));
	...
	TextCtrl_Shockwave_Start_Radius = new BulkEditTextCtrl(Panel10, IDD_TEXTCTRL_Shockwave_Start_Radius, _T("1"), wxDefaultPosition, wxDLG_UNIT(Panel10,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Shockwave_Start_Radius"));
	...
	TextCtrl_Shockwave_End_Radius = new BulkEditTextCtrl(Panel10, IDD_TEXTCTRL_Shockwave_End_Radius, _T("10"), wxDefaultPosition, wxDLG_UNIT(Panel10,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Shockwave_End_Radius"));
	...
	TextCtrl_Shockwave_Start_Width = new BulkEditTextCtrl(Panel10, IDD_TEXTCTRL_Shockwave_Start_Width, _T("5"), wxDefaultPosition, wxDLG_UNIT(Panel10,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Shockwave_Start_Width"));
	...
	TextCtrl_Shockwave_End_Width = new BulkEditTextCtrl(Panel10, IDD_TEXTCTRL_Shockwave_End_Width, _T("10"), wxDefaultPosition, wxDLG_UNIT(Panel10,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Shockwave_End_Width"));
	...
	TextCtrl_Shockwave_Accel = new BulkEditTextCtrl(Panel14, IDD_TEXTCTRL_Shockwave_Accel, _T("0"), wxDefaultPosition, wxDLG_UNIT(Panel14,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Shockwave_Accel"));
	...
	TextCtrl_Shockwave_Cycles = new BulkEditTextCtrl(Panel14, IDD_TEXTCTRL_Shockwave_Cycles, _T("1"), wxDefaultPosition, wxDLG_UNIT(Panel14,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Shockwave_Cycles"));
	...
	CheckBox_Shockwave_Scale->SetValue(true);
...
void ShockwavePanel::SetDefaultParameters()
{
    BitmapButton_Shockwave_CenterX->SetActive(false);
    BitmapButton_Shockwave_CenterY->SetActive(false);
    BitmapButton_Shockwave_End_Radius->SetActive(false);
    BitmapButton_Shockwave_Start_Radius->SetActive(false);
    BitmapButton_Shockwave_Start_Width->SetActive(false);
    BitmapButton_Shockwave_End_Width->SetActive(false);

    SetSliderValue(Slider_Shockwave_Accel, 0);
    SetSliderValue(Slider_Shockwave_CenterX, 50);
    SetSliderValue(Slider_Shockwave_CenterY, 50);
    SetSliderValue(Slider_Shockwave_End_Radius, 10);
    SetSliderValue(Slider_Shockwave_End_Width, 10);
    SetSliderValue(Slider_Shockwave_Start_Radius, 1);
    SetSliderValue(Slider_Shockwave_Start_Width, 5);
    SetSliderValue(Slider_Shockwave_Cycles, 1);

    SetCheckBoxValue(CheckBox_Shockwave_Blend_Edges, true);
    SetCheckBoxValue(CheckBox_Shockwave_Scale, true);
}
