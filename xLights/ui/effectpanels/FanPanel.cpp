...
FanPanel::FanPanel(wxWindow* parent) : xlEffectPanel()
{
	//(*Initialize(FanPanel)
...
void FanPanel::SetDefaultParameters() {
    ValueCurve_Fan_Blade_Angle->SetActive(false);
    ValueCurve_Fan_Accel->SetActive(false);
    ValueCurve_Fan_Blade_Width->SetActive(false);
    ValueCurve_Fan_CenterX->SetActive(false);
    ValueCurve_Fan_CenterY->SetActive(false);
    ValueCurve_Fan_Duration->SetActive(false);
    ValueCurve_Fan_Element_Width->SetActive(false);
    ValueCurve_Fan_End_Radius->SetActive(false);
    ValueCurve_Fan_Num_Blades->SetActive(false);
    ValueCurve_Fan_Num_Elements->SetActive(false);
    ValueCurve_Fan_Revolutions->SetActive(false);
    ValueCurve_Fan_Start_Angle->SetActive(false);
    ValueCurve_Fan_Start_Radius->SetActive(false);

    SetSliderValue(Slider_Fan_Accel, 0);
    SetSliderValue(Slider_Fan_Blade_Angle, 90);
    SetSliderValue(Slider_Fan_Blade_Width, 100);
    SetSliderValue(Slider_Fan_CenterX, 50);
    SetSliderValue(Slider_Fan_CenterY, 50);
    SetSliderValue(Slider_Fan_Duration, 80);
    SetSliderValue(Slider_Fan_Element_Width, 100);
    SetSliderValue(Slider_Fan_End_Radius, 10);
    SetSliderValue(Slider_Fan_Num_Blades, 3);
    SetSliderValue(Slider_Fan_Num_Elements, 1);
    SetSliderValue(Slider_Fan_Revolutions, 720);
    SetSliderValue(Slider_Fan_Start_Angle, 0);
    SetSliderValue(Slider_Fan_Start_Radius, 1);

    SetCheckBoxValue(CheckBox_Fan_Blend_Edges, true);
    SetCheckBoxValue(CheckBox_Fan_Reverse, false);
    SetCheckBoxValue(CheckBox_Fan_Scale, true);
}
