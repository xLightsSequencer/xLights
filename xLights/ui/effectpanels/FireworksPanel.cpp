...
FireworksPanel::FireworksPanel(wxWindow* parent) : xlEffectPanel()
{
...
void FireworksPanel::SetDefaultParameters() {
    BitmapButton_Fireworks_Count->SetActive(false);
    BitmapButton_Fireworks_Velocity->SetActive(false);
    BitmapButton_Fireworks_XVelocity->SetActive(false);
    BitmapButton_Fireworks_YVelocity->SetActive(false);
    BitmapButton_Fireworks_XLocation->SetActive(false);
    BitmapButton_Fireworks_YLocation->SetActive(false);
    BitmapButton_Fireworks_Fade->SetActive(false);

    SetSliderValue(Slider_Fireworks_Num_Explosions, 16);
    SetSliderValue(Slider_Fireworks_Count, 50);
    SetSliderValue(Slider_Fireworks_Velocity, 2);
    SetSliderValue(Slider_Fireworks_Fade, 50);
    SetSliderValue(Slider_Fireworks_Sensitivity, 50);
    SetSliderValue(Slider_Fireworks_XVelocity, 0);
    SetSliderValue(Slider_Fireworks_YVelocity, 0);
    SetSliderValue(Slider_Fireworks_XLocation, -1);
    SetSliderValue(Slider_Fireworks_YLocation, -1);

    SetCheckBoxValue(CheckBox_Fireworks_UseMusic, false);
    SetCheckBoxValue(CheckBox_FireTiming, false);
    SetCheckBoxValue(CheckBox_Fireworks_Gravity, true);
    SetCheckBoxValue(CheckBox_Fireworks_HoldColor, true);
...
void FireworksPanel::SetPanelStatus(Model* cls)
{
    if (mSequenceElements != nullptr) {
        std::string timingtracks;
        for (size_t i = 0; i < mSequenceElements->GetElementCount(); i++) {
