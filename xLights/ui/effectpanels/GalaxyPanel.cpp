...
#include "../../effects/GalaxyEffect.h"
...
//(*IdInit(GalaxyPanel)
const wxWindowID GalaxyPanel::ID_STATICTEXT_Galaxy_CenterX = wxNewId();
const wxWindowID GalaxyPanel::ID_SLIDER_Galaxy_CenterX = wxNewId();
const wxWindowID GalaxyPanel::ID_VALUECURVE_Galaxy_CenterX = wxNewId();
const wxWindowID GalaxyPanel::IDD_TEXTCTRL_Galaxy_CenterX = wxNewId();
const wxWindowID GalaxyPanel::ID_BITMAPBUTTON_SLIDER_Galaxy_CenterX = wxNewId();
const wxWindowID GalaxyPanel::ID_STATICTEXT_Galaxy_CenterY = wxNewId();
const wxWindowID GalaxyPanel::ID_SLIDER_Galaxy_CenterY = wxNewId();
const wxWindowID GalaxyPanel::ID_VALUECURVE_Galaxy_CenterY = wxNewId();
const wxWindowID GalaxyPanel::IDD_TEXTCTRL_Galaxy_CenterY = wxNewId();
const wxWindowID GalaxyPanel::ID_BITMAPBUTTON_SLIDER_Galaxy_CenterY = wxNewId();
const wxWindowID GalaxyPanel::ID_STATICTEXT_Galaxy_Start_Radius = wxNewId();
const wxWindowID GalaxyPanel::ID_SLIDER_Galaxy_Start_Radius = wxNewId();
const wxWindowID GalaxyPanel::ID_VALUECURVE_Galaxy_Start_Radius = wxNewId();
const wxWindowID GalaxyPanel::IDD_TEXTCTRL_Galaxy_Start_Radius = wxNewId();
const wxWindowID GalaxyPanel::ID_BITMAPBUTTON_SLIDER_Galaxy_Start_Radius = wxNewId();
const wxWindowID GalaxyPanel::ID_STATICTEXT_Galaxy_Start_Width = wxNewId();
const wxWindowID GalaxyPanel::ID_SLIDER_Galaxy_Start_Width = wxNewId();
const wxWindowID GalaxyPanel::ID_VALUECURVE_Galaxy_Start_Width = wxNewId();
const wxWindowID GalaxyPanel::IDD_TEXTCTRL_Galaxy_Start_Width = wxNewId();
const wxWindowID GalaxyPanel::ID_BITMAPBUTTON_SLIDER_Galaxy_Start_Width = wxNewId();
const wxWindowID GalaxyPanel::ID_STATICTEXT_Galaxy_Start_Angle = wxNewId();
const wxWindowID GalaxyPanel::ID_SLIDER_Galaxy_Start_Angle = wxNewId();
const wxWindowID GalaxyPanel::ID_VALUECURVE_Galaxy_Start_Angle = wxNewId();
const wxWindowID GalaxyPanel::IDD_TEXTCTRL_Galaxy_Start_Angle = wxNewId();
const wxWindowID GalaxyPanel::ID_BITMAPBUTTON_SLIDER_Galaxy_Start_Angle = wxNewId();
const wxWindowID GalaxyPanel::ID_PANEL29 = wxNewId();
const wxWindowID GalaxyPanel::ID_STATICTEXT_Galaxy_End_Radius = wxNewId();
const wxWindowID GalaxyPanel::ID_SLIDER_Galaxy_End_Radius = wxNewId();
const wxWindowID GalaxyPanel::ID_VALUECURVE_Galaxy_End_Radius = wxNewId();
const wxWindowID GalaxyPanel::IDD_TEXTCTRL_Galaxy_End_Radius = wxNewId();
const wxWindowID GalaxyPanel::ID_BITMAPBUTTON_SLIDER_Galaxy_End_Radius = wxNewId();
const wxWindowID GalaxyPanel::ID_STATICTEXT_Galaxy_End_Width = wxNewId();
const wxWindowID GalaxyPanel::ID_SLIDER_Galaxy_End_Width = wxNewId();
const wxWindowID GalaxyPanel::ID_VALUECURVE_Galaxy_End_Width = wxNewId();
const wxWindowID GalaxyPanel::IDD_TEXTCTRL_Galaxy_End_Width = wxNewId();
const wxWindowID GalaxyPanel::ID_BITMAPBUTTON_SLIDER_Galaxy_End_Width = wxNewId();
const wxWindowID GalaxyPanel::ID_STATICTEXT_Galaxy_Revolutions = wxNewId();
const wxWindowID GalaxyPanel::ID_SLIDER_Galaxy_Revolutions = wxNewId();
const wxWindowID GalaxyPanel::ID_VALUECURVE_Galaxy_Revolutions = wxNewId();
const wxWindowID GalaxyPanel::IDD_TEXTCTRL_Galaxy_Revolutions = wxNewId();
const wxWindowID GalaxyPanel::ID_BITMAPBUTTON_SLIDER_Galaxy_Revolutions = wxNewId();
const wxWindowID GalaxyPanel::ID_PANEL31 = wxNewId();
const wxWindowID GalaxyPanel::ID_STATICTEXT_Galaxy_Duration = wxNewId();
const wxWindowID GalaxyPanel::ID_SLIDER_Galaxy_Duration = wxNewId();
const wxWindowID GalaxyPanel::ID_VALUECURVE_Galaxy_Duration = wxNewId();
const wxWindowID GalaxyPanel::IDD_TEXTCTRL_Galaxy_Duration = wxNewId();
const wxWindowID GalaxyPanel::ID_BITMAPBUTTON_SLIDER_Galaxy_Duration = wxNewId();
const wxWindowID GalaxyPanel::ID_STATICTEXT_Galaxy_Accel = wxNewId();
const wxWindowID GalaxyPanel::ID_SLIDER_Galaxy_Accel = wxNewId();
const wxWindowID GalaxyPanel::ID_VALUECURVE_Galaxy_Accel = wxNewId();
const wxWindowID GalaxyPanel::IDD_TEXTCTRL_Galaxy_Accel = wxNewId();
const wxWindowID GalaxyPanel::ID_BITMAPBUTTON_SLIDER_Galaxy_Accel = wxNewId();
const wxWindowID GalaxyPanel::ID_CHECKBOX_Galaxy_Reverse = wxNewId();
const wxWindowID GalaxyPanel::ID_CHECKBOX_Galaxy_Blend_Edges = wxNewId();
const wxWindowID GalaxyPanel::ID_CHECKBOX_Galaxy_Inward = wxNewId();
const wxWindowID GalaxyPanel::ID_CHECKBOX_Galaxy_Scale = wxNewId();
const wxWindowID GalaxyPanel::ID_PANEL32 = wxNewId();
const wxWindowID GalaxyPanel::ID_NOTEBOOK_Galaxy = wxNewId();
//*)
...
GalaxyPanel::GalaxyPanel(wxWindow* parent) : xlEffectPanel()
{
	...
	TextCtrl_Galaxy_CenterX = new BulkEditTextCtrl(Panel6, IDD_TEXTCTRL_Galaxy_CenterX, _T("50"), wxDefaultPosition, wxDLG_UNIT(Panel6,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Galaxy_CenterX"));
	...
	TextCtrl_Galaxy_CenterY = new BulkEditTextCtrl(Panel6, IDD_TEXTCTRL_Galaxy_CenterY, _T("50"), wxDefaultPosition, wxDLG_UNIT(Panel6,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Galaxy_CenterY"));
	...
	TextCtrl_Galaxy_Start_Radius = new BulkEditTextCtrl(Panel6, IDD_TEXTCTRL_Galaxy_Start_Radius, _T("1"), wxDefaultPosition, wxDLG_UNIT(Panel6,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Galaxy_Start_Radius"));
	...
	TextCtrl_Galaxy_Start_Width = new BulkEditTextCtrl(Panel6, IDD_TEXTCTRL_Galaxy_Start_Width, _T("5"), wxDefaultPosition, wxDLG_UNIT(Panel6,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Galaxy_Start_Width"));
	...
	TextCtrl_Galaxy_Start_Angle = new BulkEditTextCtrl(Panel6, IDD_TEXTCTRL_Galaxy_Start_Angle, _T("0"), wxDefaultPosition, wxDLG_UNIT(Panel6,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Galaxy_Start_Angle"));
	...
	TextCtrl_Galaxy_End_Radius = new BulkEditTextCtrl(Panel7, IDD_TEXTCTRL_Galaxy_End_Radius, _T("10"), wxDefaultPosition, wxDLG_UNIT(Panel7,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Galaxy_End_Radius"));
	...
	TextCtrl_Galaxy_End_Width = new BulkEditTextCtrl(Panel7, IDD_TEXTCTRL_Galaxy_End_Width, _T("5"), wxDefaultPosition, wxDLG_UNIT(Panel7,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Galaxy_End_Width"));
	...
	TextCtrl_Galaxy_Revolutions = new BulkEditTextCtrlF360(Panel7, IDD_TEXTCTRL_Galaxy_Revolutions, _T("4.0"), wxDefaultPosition, wxDLG_UNIT(Panel7,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Galaxy_Revolutions"));
	...
	TextCtrl_Galaxy_Duration = new BulkEditTextCtrl(Panel8, IDD_TEXTCTRL_Galaxy_Duration, _T("20"), wxDefaultPosition, wxDLG_UNIT(Panel8,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Galaxy_Duration"));
	...
	TextCtrl_Galaxy_Accel = new BulkEditTextCtrl(Panel8, IDD_TEXTCTRL_Galaxy_Accel, _T("0"), wxDefaultPosition, wxDLG_UNIT(Panel8,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Galaxy_Accel"));
...
void GalaxyPanel::SetDefaultParameters() {
    ValueCurve_Galaxy_Accel->SetActive(false);
    ValueCurve_Galaxy_CenterX->SetActive(false);
    ValueCurve_Galaxy_CenterY->SetActive(false);
    ValueCurve_Galaxy_Duration->SetActive(false);
    ValueCurve_Galaxy_End_Radius->SetActive(false);
    ValueCurve_Galaxy_End_Width->SetActive(false);
    ValueCurve_Galaxy_Revolutions->SetActive(false);
    ValueCurve_Galaxy_Start_Angle->SetActive(false);
    ValueCurve_Galaxy_Start_Radius->SetActive(false);
    ValueCurve_Galaxy_Start_Width->SetActive(false);

    SetSliderValue(Slider_Galaxy_Accel, 0);
    SetSliderValue(Slider_Galaxy_CenterX, 50);
    SetSliderValue(Slider_Galaxy_CenterY, 50);
    SetSliderValue(Slider_Galaxy_Duration, 20);
    SetSliderValue(Slider_Galaxy_End_Radius, 10);
    SetSliderValue(Slider_Galaxy_End_Width, 5);
    SetSliderValue(Slider_Galaxy_Revolutions, 1440);
    SetSliderValue(Slider_Galaxy_Start_Angle, 0);
    SetSliderValue(Slider_Galaxy_Start_Radius, 1);
    SetSliderValue(Slider_Galaxy_Start_Width, 5);

    SetCheckBoxValue(CheckBox_Galaxy_Blend_Edges, true);
    SetCheckBoxValue(CheckBox_Galaxy_Inward, false);
    SetCheckBoxValue(CheckBox_Galaxy_Reverse, false);

    SetCheckBoxValue(CheckBox_Galaxy_Scale, true);
}
