...
KaleidoscopePanel::KaleidoscopePanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size) : xlEffectPanel()
{
...
void KaleidoscopePanel::SetDefaultParameters()
{
    BitmapButton_Kaleidoscope_X->SetActive(false);
    BitmapButton_Kaleidoscope_Y->SetActive(false);
    BitmapButton_Kaleidoscope_Size->SetActive(false);
    BitmapButton_Kaleidoscope_Rotation->SetActive(false);

    Choice_Kaleidoscope_Type->SetSelection(0);

    SetSliderValue(Slider_Kaleidoscope_X, 50);
    SetSliderValue(Slider_Kaleidoscope_Y, 50);
    SetSliderValue(Slider_Kaleidoscope_Size, 5);
    SetSliderValue(Slider_Kaleidoscope_Rotation, 0);
