...
PinwheelPanel::PinwheelPanel(wxWindow* parent) : xlEffectPanel()
{
...
void PinwheelPanel::SetDefaultParameters()
{
    BitmapButton_PinwheelXCVC->SetActive(false);
    BitmapButton_PinwheelYCVC->SetActive(false);
    BitmapButton_Pinwheel_ArmSizeVC->SetActive(false);
    BitmapButton_Pinwheel_SpeedVC->SetActive(false);
    BitmapButton_Pinwheel_ThicknessVC->SetActive(false);
    BitmapButton_Pinwheel_TwistVC->SetActive(false);
    BitmapButton_Pinwheel_OffsetVC->SetActive(false);

    SetChoiceValue(Choice_Pinwheel_3D, "none");
    SetChoiceValue(Choice_Pinwheel_Style, "New Render Method");

    SetSliderValue(Slider_PinwheelXC, 0);
    SetSliderValue(Slider_PinwheelYC, 0);
    SetSliderValue(Slider_Pinwheel_Arms, 3);
    SetSliderValue(Slider_Pinwheel_ArmSize, 100);
    SetSliderValue(Slider_Pinwheel_Thickness, 0);
    SetSliderValue(Slider_Pinwheel_Twist, 0);
    SetSliderValue(Slider_Pinwheel_Speed, 10);
    SetSliderValue(Slider_Pinwheel_Offset, 0);

    SetCheckBoxValue(CheckBox_Pinwheel_Rotation, true);
}
