...
SpiralsPanel::SpiralsPanel(wxWindow* parent) : xlEffectPanel()
{
...
void SpiralsPanel::SetDefaultParameters()
{
    BitmapButton_VCSpiralsCount->SetActive(false);
    BitmapButton_VCSpirals_Movement->SetActive(false);
    BitmapButton_VCSpirals_Rotation->SetActive(false);
    BitmapButton_VCSpirals_Thickness->SetActive(false);

    SetSliderValue(Slider_Spirals_Count, 1);
    SetSliderValue(Slider_Spirals_Rotation, 20);
    SetSliderValue(Slider_Spirals_Thickness, 50);
    SetSliderValue(Slider_Spirals_Movement, 10);

    SetCheckBoxValue(CheckBox_Spirals_3D, false);
    SetCheckBoxValue(CheckBox_Spirals_Blend, false);
    SetCheckBoxValue(CheckBox_Spirals_Grow, false);
    SetCheckBoxValue(CheckBox_Spirlas_Shrink, false);
}
