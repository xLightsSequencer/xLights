...
namespace ExportSettings {
    ...
    enum SETTINGS {
        ...
        SETTINGS_PORT_CURRENT = 0x010,
        SETTINGS_MODEL_DESCRIPTIONS = 0x0020,
        SETTINGS_MODEL_ABSADDRESS = 0x0040,
        SETTINGS_MODEL_UNIADDRESS = 0x0080,
        SETTINGS_MODEL_CHANNELS = 0x0100,
        SETTINGS_MODEL_PIXELS = 0x0200,
        SETTINGS_MODEL_CURRENT = 0x0400
    };
