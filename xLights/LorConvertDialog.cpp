...
LorConvertDialog::LorConvertDialog(wxWindow* parent)
{
	...
	CheckBoxOffAtEnd = new wxCheckBox(this, ID_CHECKBOX_OFF_AT_END, _(" "), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_OFF_AT_END"));
	...
	CheckBoxMapEmptyChannels = new wxCheckBox(this, ID_CHECKBOX_MAP_EMPTY_CHANNELS, _(" "), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_MAP_EMPTY_CHANNELS"));
	...
	MapLORChannelsWithNoNetwork = new wxCheckBox(this, ID_CHECKBOX_LOR_WITH_NO_CHANNELS, _(" "), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_LOR_WITH_NO_CHANNELS"));
