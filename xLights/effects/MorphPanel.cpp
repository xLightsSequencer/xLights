...
MorphPanel::MorphPanel(wxWindow* parent) : xlEffectPanel(parent)
{
	...
	BitmapButton_Morph_AutoRepeat = new xlLockButton(MorphPanelOptions, ID_BITMAPBUTTON_CHECKBOX_Morph_AutoRepeat, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_PADLOCK_OPEN")),wxART_BUTTON), wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHECKBOX_Morph_AutoRepeat"));
