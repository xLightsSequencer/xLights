...
class RipplePanel: public xlEffectPanel
{
	public:
		...
		BulkEditSlider* Slider2;
		BulkEditSlider* Slider3;
		BulkEditSlider* Slider4;
		...
		BulkEditValueCurveButton* BitmapButton10;
		BulkEditValueCurveButton* BitmapButton2;
		BulkEditValueCurveButton* BitmapButton7;
		BulkEditValueCurveButton* BitmapButton8;
		BulkEditValueCurveButton* BitmapButton9;
