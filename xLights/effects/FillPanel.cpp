...
FillPanel::FillPanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	BitmapButton_Fill_Position = new BulkEditValueCurveButton(this, ID_VALUECURVE_Fill_Position, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Fill_Position"));
	...
	BitmapButton_Fill_Band_Size = new BulkEditValueCurveButton(this, ID_VALUECURVE_Fill_Band_Size, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Fill_Band_Size"));
	...
	BitmapButton_Fill_Skip_Size = new BulkEditValueCurveButton(this, ID_VALUECURVE_Fill_Skip_Size, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Fill_Skip_Size"));
	...
	BitmapButton_Fill_Offset = new BulkEditValueCurveButton(this, ID_VALUECURVE_Fill_Offset, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Fill_Offset"));
