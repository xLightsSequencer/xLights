...
CirclesPanel::CirclesPanel(wxWindow* parent)
{
	...
	BitmapButton_Circles_Count = new BulkEditValueCurveButton(this, ID_VALUECURVE_Circles_Count, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Circles_Count"));
	...
	BitmapButton_Circles_Size = new BulkEditValueCurveButton(this, ID_VALUECURVE_Circles_Size, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Circles_Size"));
	...
	BitmapButton_Circles_Speed = new BulkEditValueCurveButton(this, ID_VALUECURVE_Circles_Speed, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Circles_Speed"));
	...
	BitmapButton_CirclesBubbles = new wxBitmapButton(this, ID_BITMAPBUTTON_CHECKBOX_Circles_Bubbles, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHECKBOX_Circles_Bubbles"));
