...
FanPanel::FanPanel(wxWindow* parent) : xlEffectPanel(parent)
{
	...
	TextCtrl_Fan_Start_Radius = new BulkEditTextCtrl(Panel9, IDD_TEXTCTRL_Fan_Start_Radius, _("1"), wxDefaultPosition, wxDLG_UNIT(Panel9,wxSize(30,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_Fan_Start_Radius"));
