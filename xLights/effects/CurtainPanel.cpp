...
CurtainPanel::CurtainPanel(wxWindow* parent)
{
	...
	FlexGridSizer1->Add(Slider_Curtain_Swag, 1, wxALL|wxEXPAND, 5);
	...
	FlexGridSizer1->Add(BitmapButton_Curtain_SwagVC, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
	FlexGridSizer20->Add(FlexGridSizer1, 1, wxALL|wxEXPAND, 2);
	...
	FlexGridSizer2->Add(Slider14, 1, wxALL|wxEXPAND, 5);
	...
	FlexGridSizer2->Add(BitmapButton_Curtain_SpeedVC, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
	FlexGridSizer20->Add(FlexGridSizer2, 1, wxALL|wxEXPAND, 2);
