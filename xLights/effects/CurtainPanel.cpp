...
CurtainPanel::CurtainPanel(wxWindow* parent)
{
	...
	Connect(ID_SLIDER_Curtain_Swag,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&CurtainPanel::UpdateLinkedTextCtrl);
	...
	Connect(IDD_SLIDER_Curtain_Speed,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&CurtainPanel::UpdateLinkedTextCtrlFloat);
