...
class LiquidEffect : public RenderableEffect
{
    ...
    protected:
        ...
        void CreateParticles(b2ParticleSystem* ps, int x, int y, int direction, int velocity, int flow, int lifetime, int width, int height, const xlColor& c, const std::string& particleType, bool mixcolors);
