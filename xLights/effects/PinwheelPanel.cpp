...
const long PinwheelPanel::IDD_SLIDER_Pinwheel_Speed = wxNewId();
const long PinwheelPanel::ID_TEXTCTRL_Pinwheel_Speed = wxNewId();
...
PinwheelPanel::PinwheelPanel(wxWindow* parent)
{
	...
	FlexGridSizer128->Add(Slider_Pinwheel_ArmSize, 1, wxALL|wxEXPAND, 2);
	...
	FlexGridSizer128->Add(Slider_Pinwheel_Twist, 1, wxALL|wxEXPAND, 2);
	...
	FlexGridSizer128->Add(Slider_Pinwheel_Thickness, 1, wxALL|wxEXPAND, 2);
	...
	Slider24 = new wxSlider(this, IDD_SLIDER_Pinwheel_Speed, 10, 0, 50, wxDefaultPosition, wxSize(80,20), 0, wxDefaultValidator, _T("IDD_SLIDER_Pinwheel_Speed"));
	FlexGridSizer128->Add(Slider24, 1, wxALL|wxEXPAND, 2);
	TextCtrl70 = new wxTextCtrl(this, ID_TEXTCTRL_Pinwheel_Speed, _("10"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("ID_TEXTCTRL_Pinwheel_Speed"));
	...
	Connect(ID_SLIDER_Pinwheel_ArmSize,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&PinwheelPanel::UpdateLinkedTextCtrl);
	...
	Connect(ID_SLIDER_Pinwheel_Twist,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&PinwheelPanel::UpdateLinkedTextCtrl);
	...
	Connect(ID_SLIDER_Pinwheel_Thickness,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&PinwheelPanel::UpdateLinkedTextCtrl);
	...
	Connect(IDD_SLIDER_Pinwheel_Speed,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&PinwheelPanel::UpdateLinkedTextCtrl);
	Connect(ID_TEXTCTRL_Pinwheel_Speed,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&PinwheelPanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_PinwheelXC,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&PinwheelPanel::UpdateLinkedTextCtrl);
	...
	Connect(ID_SLIDER_PinwheelYC,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&PinwheelPanel::UpdateLinkedTextCtrl);
	//*)
