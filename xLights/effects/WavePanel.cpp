...
WavePanel::WavePanel(wxWindow* parent)
{
	...
	BitmapButton_WaveType = new wxBitmapButton(this, ID_BITMAPBUTTON_CHOICE_Wave_Type, padlock16x16_green_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHOICE_Wave_Type"));
	...
	FlexGridSizer51->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BitmapButton_Wave_FillColors = new wxBitmapButton(this, ID_BITMAPBUTTON_CHOICE_Fill_Colors, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHOICE_Fill_Colors"));
	...
	FlexGridSizer51->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BitmapButton_Wave_MirrorWave = new wxBitmapButton(this, ID_BITMAPBUTTON_CHECKBOX_Mirror_Wave, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHECKBOX_Mirror_Wave"));
	...
	BitmapButton_NumberWaves = new wxBitmapButton(this, ID_BITMAPBUTTON_SLIDER_Number_Waves, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Number_Waves"));
	...
	BitmapButton_Wave_Thickness = new wxBitmapButton(this, ID_BITMAPBUTTON_SLIDER_Thickness_Percentage, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Thickness_Percentage"));
	...
	BitmapButton_Wave_Height = new wxBitmapButton(this, ID_BITMAPBUTTON_SLIDER_Wave_Height, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Wave_Height"));
	...
	BitmapButton_WaveSpeed = new wxBitmapButton(this, ID_BITMAPBUTTON_SLIDER_Wave_Speed, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Wave_Speed"));
	BitmapButton_WaveSpeed->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
	...
	FlexGridSizer51->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BitmapButton_Wave_Direction = new wxBitmapButton(this, ID_BITMAPBUTTON_CHOICE_Wave_Direction, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHOICE_Wave_Direction"));
