...
ButterflyPanel::ButterflyPanel(wxWindow* parent)
{
	...
	wxBitmapButton* BitmapButton_ButterflyDirection;
	...
	BitmapButton_ButterflyColors = new wxBitmapButton(this, ID_BITMAPBUTTON_CHOICE_Butterfly_Colors, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHOICE_Butterfly_Colors"));
	...
	BitmapButton_Butterfly_Chunks = new BulkEditValueCurveButton(this, ID_VALUECURVE_Butterfly_Chunks, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Butterfly_Chunks"));
	...
	BitmapButton_Butterfly_Skip = new BulkEditValueCurveButton(this, ID_VALUECURVE_Butterfly_Skip, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Butterfly_Skip"));
	...
	BitmapButton1 = new wxBitmapButton(this, ID_BITMAPBUTTON_SLIDER_Butterfly_Skip, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Butterfly_Skip"));
	...
	BitmapButton_Butterfly_Speed = new BulkEditValueCurveButton(this, ID_VALUECURVE_Butterfly_Speed, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Butterfly_Speed"));
	...
	BitmapButton_ButterflySkip = new wxBitmapButton(this, ID_BITMAPBUTTON_SLIDER_Butterfly_Speed, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Butterfly_Speed"));
	...
	FlexGridSizer36->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BitmapButton_ButterflyDirection = new wxBitmapButton(this, ID_BITMAPBUTTON_CHOICE_Butterfly_Direction, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHOICE_Butterfly_Direction"));
	BitmapButton_ButterflyDirection->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
