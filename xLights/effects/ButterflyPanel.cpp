...
ButterflyPanel::ButterflyPanel(wxWindow* parent) : xlEffectPanel(parent)
{
	...
	BitmapButton_ButterflyColors = new xlLockButton(this, ID_BITMAPBUTTON_CHOICE_Butterfly_Colors, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHOICE_Butterfly_Colors"));
	...
	BitmapButton_ButterflyStyle = new xlLockButton(this, ID_BITMAPBUTTON_SLIDER_Butterfly_Style, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Butterfly_Style"));
	...
	BitmapButton_Butterfly_Chunks = new BulkEditValueCurveButton(this, ID_VALUECURVE_Butterfly_Chunks, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Butterfly_Chunks"));
	...
	BitmapButton_ButterflyChunks = new xlLockButton(this, ID_BITMAPBUTTON_SLIDER_Butterfly_Chunks, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Butterfly_Chunks"));
	...
	BitmapButton_Butterfly_Skip = new BulkEditValueCurveButton(this, ID_VALUECURVE_Butterfly_Skip, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Butterfly_Skip"));
	...
	BitmapButton1 = new xlLockButton(this, ID_BITMAPBUTTON_SLIDER_Butterfly_Skip, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Butterfly_Skip"));
	...
	BitmapButton_Butterfly_Speed = new BulkEditValueCurveButton(this, ID_VALUECURVE_Butterfly_Speed, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_VALUECURVE_Butterfly_Speed"));
	...
	BitmapButton_ButterflySkip = new xlLockButton(this, ID_BITMAPBUTTON_SLIDER_Butterfly_Speed, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Butterfly_Speed"));
	...
	FlexGridSizer36->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BitmapButton_ButterflyDirection = new xlLockButton(this, ID_BITMAPBUTTON_CHOICE_Butterfly_Direction, wxNullBitmap, wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHOICE_Butterfly_Direction"));
