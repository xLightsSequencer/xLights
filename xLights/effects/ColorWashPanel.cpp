...
ColorWashPanel::ColorWashPanel(wxWindow* parent)
{
	...
	FlexGridSizer9->Add(SliderCycles, 1, wxALL|wxEXPAND, 2);
	...
	EntireModelCheckbox = new wxCheckBox(this, ID_CHECKBOX_ColorWash_EntireModel, _("Entire Model"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_ColorWash_EntireModel"));
	EntireModelCheckbox->SetValue(true);
	FlexGridSizer124->Add(EntireModelCheckbox, 1, wxALL|wxALIGN_LEFT|wxALIGN_TOP, 5);
	...
	CornersNotebook = new wxNotebook(this, IDD_NOTEBOOK_ColorWashRect, wxDefaultPosition, wxDefaultSize, 0, _T("IDD_NOTEBOOK_ColorWashRect"));
	CornersNotebook->Disable();
	Panel13 = new wxPanel(CornersNotebook, ID_PANEL46, wxPoint(15,49), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL46"));
	...
	C1SliderX = new wxSlider(Panel13, ID_SLIDER_ColorWash_X1, 0, 0, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_ColorWash_X1"));
	FlexGridSizer116->Add(C1SliderX, 1, wxALL|wxEXPAND, 5);
	...
	C1SliderY = new wxSlider(Panel13, ID_SLIDER_ColorWash_Y1, 0, 0, 100, wxDefaultPosition, wxDefaultSize, wxSL_VERTICAL|wxSL_INVERSE, wxDefaultValidator, _T("ID_SLIDER_ColorWash_Y1"));
	GridBagSizer1->Add(C1SliderY, wxGBPosition(0, 1), wxGBSpan(4, 1), wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	Panel15 = new wxPanel(CornersNotebook, ID_PANEL47, wxPoint(104,13), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL47"));
	...
	C2SliderX = new wxSlider(Panel15, ID_SLIDER_ColorWash_X2, 100, 0, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_ColorWash_X2"));
	FlexGridSizer118->Add(C2SliderX, 1, wxALL|wxEXPAND, 5);
	...
	C2SliderY = new wxSlider(Panel15, ID_SLIDER_ColorWash_Y2, 100, 0, 100, wxDefaultPosition, wxDefaultSize, wxSL_VERTICAL|wxSL_INVERSE, wxDefaultValidator, _T("ID_SLIDER_ColorWash_Y2"));
	GridBagSizer4->Add(C2SliderY, wxGBPosition(0, 1), wxGBSpan(4, 1), wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	CornersNotebook->AddPage(Panel13, _("Corner 1"), false);
	CornersNotebook->AddPage(Panel15, _("Corner 2"), false);
	FlexGridSizer114->Add(CornersNotebook, 1, wxALL|wxEXPAND, 5);
