...
FireworksPanel::FireworksPanel(wxWindow* parent)
{
	...
	TextCtrl_Fireworks_Explosions = new wxTextCtrl(this, IDD_TEXTCTRL_Fireworks_Explosions, _("16"), wxDefaultPosition, wxSize(40,-1), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Fireworks_Explosions"));
	...
	TextCtrl_Fireworks_Count = new wxTextCtrl(this, IDD_TEXTCTRL_Fireworks_Count, _("50"), wxDefaultPosition, wxSize(40,-1), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Fireworks_Count"));
	...
	TextCtrl_Fireworks_Velocity = new wxTextCtrl(this, IDD_TEXTCTRL_Fireworks_Velocity, _("2"), wxDefaultPosition, wxSize(40,-1), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Fireworks_Velocity"));
	...
	TextCtrl_Fireworks_Fade = new wxTextCtrl(this, IDD_TEXTCTRL_Fireworks_Fade, _("50"), wxDefaultPosition, wxSize(40,-1), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Fireworks_Fade"));
	...
	TextCtrl_Fireworks_Sensitivity = new wxTextCtrl(this, IDD_TEXTCTRL_Fireworks_Sensitivity, _("50"), wxDefaultPosition, wxSize(40,-1), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Fireworks_Sensitivity"));
	...
	Connect(ID_SLIDER_Fireworks_Explosions,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&FireworksPanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Fireworks_Explosions,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&FireworksPanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_Fireworks_Count,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&FireworksPanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Fireworks_Count,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&FireworksPanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_Fireworks_Velocity,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&FireworksPanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Fireworks_Velocity,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&FireworksPanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_Fireworks_Fade,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&FireworksPanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Fireworks_Fade,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&FireworksPanel::UpdateLinkedSlider);
