...
//(*IdInit(ShapePanel)
const long ShapePanel::ID_STATICTEXT71 = wxNewId();
const long ShapePanel::ID_CHOICE_Shape_ObjectToDraw = wxNewId();
const long ShapePanel::ID_STATICTEXT74 = wxNewId();
...
const long ShapePanel::ID_STATICTEXT6 = wxNewId();
...
const long ShapePanel::ID_STATICTEXT7 = wxNewId();
...
const long ShapePanel::ID_STATICTEXT8 = wxNewId();
...
ShapePanel::ShapePanel(wxWindow* parent)
{
	...
	wxTextCtrl* TextCtrl_Shape_Growth;
	wxFlexGridSizer* FlexGridSizer2;
	wxTextCtrl* TextCtrl_Shape_StartSize;
	...
	Choice_Shape_ObjectToDraw = new wxChoice(this, ID_CHOICE_Shape_ObjectToDraw, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE_Shape_ObjectToDraw"));
	...
	Slider_Shape_Thickness = new wxSlider(this, ID_SLIDER_Shape_Thickness, 3, 1, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Shape_Thickness"));
	...
	Slider_Shape_Count = new wxSlider(this, IDD_SLIDER_Shape_Count, 5, 1, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("IDD_SLIDER_Shape_Count"));
	FlexGridSizer2->Add(Slider_Shape_Count, 1, wxALL|wxEXPAND, 2);
	BitmapButton_Shape_CountVC = new ValueCurveButton(this, ID_VALUECURVE_Shape_Count, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Shape_Count"));
	...
	TextCtrl34 = new wxTextCtrl(this, ID_TEXTCTRL_Shape_Count, _("5"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(20,-1)), 0, wxDefaultValidator, _T("ID_TEXTCTRL_Shape_Count"));
	TextCtrl34->SetMaxLength(3);
	FlexGridSizer57->Add(TextCtrl34, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
	StaticText6 = new wxStaticText(this, ID_STATICTEXT6, _("Start Size"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT6"));
	FlexGridSizer57->Add(StaticText6, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer7 = new wxFlexGridSizer(0, 2, 0, 0);
	FlexGridSizer7->AddGrowableCol(0);
	Slider_Shape_StartSize = new wxSlider(this, ID_SLIDER_Shape_StartSize, 5, 0, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Shape_StartSize"));
	FlexGridSizer7->Add(Slider_Shape_StartSize, 1, wxALL|wxEXPAND, 2);
	BitmapButton_Shape_StartSizeVC = new ValueCurveButton(this, ID_VALUECURVE_Shape_StartSize, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Shape_StartSize"));
	...
	TextCtrl_Shape_StartSize = new wxTextCtrl(this, IDD_TEXTCTRL_Shape_StartSize, _("5"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Shape_StartSize"));
	...
	StaticText2 = new wxStaticText(this, ID_STATICTEXT2, _("Lifetime"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
	FlexGridSizer57->Add(StaticText2, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer3 = new wxFlexGridSizer(0, 2, 0, 0);
	FlexGridSizer3->AddGrowableCol(0);
	Slider_Shape_Lifetime = new wxSlider(this, ID_SLIDER_Shape_Lifetime, 5, 1, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Shape_Lifetime"));
	FlexGridSizer3->Add(Slider_Shape_Lifetime, 1, wxALL|wxEXPAND, 2);
	BitmapButton_Shape_LifetimeVC = new ValueCurveButton(this, ID_VALUECURVE_Shape_Lifetime, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Shape_Lifetime"));
	...
	TextCtrl1 = new wxTextCtrl(this, IDD_TEXTCTRL_Shape_Lifetime, _("5"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Shape_Lifetime"));
	TextCtrl1->SetMaxLength(3);
	FlexGridSizer57->Add(TextCtrl1, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText3 = new wxStaticText(this, ID_STATICTEXT3, _("Growth"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
	FlexGridSizer57->Add(StaticText3, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer4 = new wxFlexGridSizer(0, 2, 0, 0);
	FlexGridSizer4->AddGrowableCol(0);
	Slider_Shape_Growth = new wxSlider(this, ID_SLIDER_Shape_Growth, 10, -100, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Shape_Growth"));
	FlexGridSizer4->Add(Slider_Shape_Growth, 1, wxALL|wxEXPAND, 2);
	BitmapButton_Shape_GrowthVC = new ValueCurveButton(this, ID_VALUECURVE_Shape_Growth, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Shape_Growth"));
	...
	TextCtrl_Shape_Growth = new wxTextCtrl(this, IDD_TEXTCTRL_Shape_Growth, _("10"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Shape_Growth"));
	...
	StaticText4 = new wxStaticText(this, ID_STATICTEXT4, _("X Center"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT4"));
	FlexGridSizer57->Add(StaticText4, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer5 = new wxFlexGridSizer(0, 2, 0, 0);
	FlexGridSizer5->AddGrowableCol(0);
	Slider_Shape_CentreX = new wxSlider(this, ID_SLIDER_Shape_CentreX, 50, 0, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Shape_CentreX"));
	FlexGridSizer5->Add(Slider_Shape_CentreX, 1, wxALL|wxEXPAND, 2);
	BitmapButton_Shape_CentreXVC = new ValueCurveButton(this, ID_VALUECURVE_Shape_CentreX, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Shape_CentreX"));
	...
	TextCtrl_Shape_CentreX = new wxTextCtrl(this, IDD_TEXTCTRL_Shape_CentreX, _("50"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Shape_CentreX"));
	...
	StaticText5 = new wxStaticText(this, ID_STATICTEXT5, _("Y Center"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT5"));
	FlexGridSizer57->Add(StaticText5, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer6 = new wxFlexGridSizer(0, 2, 0, 0);
	FlexGridSizer6->AddGrowableCol(0);
	Slider_Shape_CentreY = new wxSlider(this, ID_SLIDER_Shape_CentreY, 50, 0, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Shape_CentreY"));
	FlexGridSizer6->Add(Slider_Shape_CentreY, 1, wxALL|wxEXPAND, 2);
	BitmapButton_Shape_CentreYVC = new ValueCurveButton(this, ID_VALUECURVE_Shape_CentreY, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Shape_CentreY"));
	...
	TextCtrl_Shape_CentreY = new wxTextCtrl(this, IDD_TEXTCTRL_Shape_CentreY, _("50"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Shape_CentreY"));
	...
	Slider_Shape_Points = new wxSlider(this, ID_SLIDER_Shape_Points, 5, 4, 7, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Shape_Points"));
	FlexGridSizer57->Add(Slider_Shape_Points, 1, wxALL|wxEXPAND, 5);
	TextCtrl_Shape_Points = new wxTextCtrl(this, IDD_TEXTCTRL_Shape_Points, _("5"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Shape_Points"));
	...
	FlexGridSizer57->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	CheckBox_Shape_RandomLocation = new wxCheckBox(this, ID_CHECKBOX_Shape_RandomLocation, _("Random Location"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_Shape_RandomLocation"));
	...
	FlexGridSizer57->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer57->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	CheckBox_Shape_FadeAway = new wxCheckBox(this, ID_CHECKBOX_Shape_FadeAway, _("Fade Away"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_Shape_FadeAway"));
	...
	FlexGridSizer57->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer57->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	CheckBox_Shape_UseMusic = new wxCheckBox(this, ID_CHECKBOX_Shape_UseMusic, _("Fire with music"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_Shape_UseMusic"));
	...
	FlexGridSizer57->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText7 = new wxStaticText(this, ID_STATICTEXT7, _("Trigger level"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
	FlexGridSizer57->Add(StaticText7, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	Slider_Shape_Sensitivity = new wxSlider(this, ID_SLIDER_Shape_Sensitivity, 50, 0, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Shape_Sensitivity"));
	FlexGridSizer57->Add(Slider_Shape_Sensitivity, 1, wxALL|wxEXPAND, 2);
	TextCtrl_Shape_Sensitivity = new wxTextCtrl(this, IDD_TEXTCTRL_Shape_Sensitivity, _("50"), wxDefaultPosition, wxSize(35,-1), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Shape_Sensitivity"));
	...
	FlexGridSizer57->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	CheckBox_Shape_FireTiming = new wxCheckBox(this, ID_CHECKBOX_Shape_FireTiming, _("Fire with timing track"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_Shape_FireTiming"));
	...
	FlexGridSizer57->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText8 = new wxStaticText(this, ID_STATICTEXT8, _("Timing Track"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT8"));
	FlexGridSizer57->Add(StaticText8, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	Choice_Shape_TimingTrack = new wxChoice(this, ID_CHOICE_Shape_FireTimingTrack, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE_Shape_FireTimingTrack"));
	...
	Connect(ID_SLIDER_Shape_Thickness,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedTextCtrlVC);
	Connect(ID_VALUECURVE_Shape_Thickness,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&ShapePanel::OnVCButtonClick);
	Connect(IDD_TEXTCTRL_Shape_Thickness,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedSlider);
	Connect(IDD_SLIDER_Shape_Count,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedTextCtrlVC);
	Connect(ID_VALUECURVE_Shape_Count,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&ShapePanel::OnVCButtonClick);
	Connect(ID_TEXTCTRL_Shape_Count,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedSlider);
	Connect(ID_SLIDER_Shape_StartSize,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedTextCtrlVC);
	Connect(ID_VALUECURVE_Shape_StartSize,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&ShapePanel::OnVCButtonClick);
	Connect(IDD_TEXTCTRL_Shape_StartSize,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedSlider);
	Connect(ID_SLIDER_Shape_Lifetime,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedTextCtrlVC);
	Connect(ID_VALUECURVE_Shape_Lifetime,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&ShapePanel::OnVCButtonClick);
	Connect(IDD_TEXTCTRL_Shape_Lifetime,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedSlider);
	Connect(ID_SLIDER_Shape_Growth,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedTextCtrlVC);
	Connect(ID_VALUECURVE_Shape_Growth,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&ShapePanel::OnVCButtonClick);
	Connect(IDD_TEXTCTRL_Shape_Growth,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedSlider);
	Connect(ID_SLIDER_Shape_CentreX,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedTextCtrlVC);
	Connect(ID_VALUECURVE_Shape_CentreX,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&ShapePanel::OnVCButtonClick);
	Connect(IDD_TEXTCTRL_Shape_CentreX,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedSlider);
	Connect(ID_SLIDER_Shape_CentreY,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedTextCtrlVC);
	Connect(ID_VALUECURVE_Shape_CentreY,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&ShapePanel::OnVCButtonClick);
	Connect(IDD_TEXTCTRL_Shape_CentreY,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedSlider);
	Connect(ID_SLIDER_Shape_Points,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Shape_Points,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_Shape_Sensitivity,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Shape_Sensitivity,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&ShapePanel::UpdateLinkedSlider);
