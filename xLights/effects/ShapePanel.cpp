...
ShapePanel::ShapePanel(wxWindow* parent)
{
    ...
    SpinCtrl_CharCode = new BulkEditSpinCtrl(this, ID_SPINCTRL_Shape_Char, _T("127876"), wxDefaultPosition, wxDefaultSize, 0, 32, 917631, 127876, _T("ID_SPINCTRL_Shape_Char"));
    SpinCtrl_CharCode->SetValue(_T("127876"));
    FlexGridSizer8->Add(SpinCtrl_CharCode, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
    FlexGridSizer57->Add(FlexGridSizer8, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
    ...
    if (fontEnumerator.Exists("Segoe UI Emoji"))
    {
        _emojis.push_back(new Emoji("Snowman 1", "Segoe UI Emoji", 9924));
        _emojis.push_back(new Emoji("Snowman 2", "Segoe UI Emoji", 9927));
        _emojis.push_back(new Emoji("Snowflake 2", "Segoe UI Emoji", 10052));
        _emojis.push_back(new Emoji("Snowflake 3", "Segoe UI Emoji", 10053));
        _emojis.push_back(new Emoji("Snowflake 4", "Segoe UI Emoji", 10054));
    }
