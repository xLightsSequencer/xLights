...
class OnEffect : public RenderableEffect
{
    public:
        ...
        virtual int DrawEffectBackground(const Effect *e, int x1, int y1, int x2, int y2, DrawGLUtils::xlVertexColorAccumulator &backgrounds, xlColor* colorMask, bool ramps) override;
