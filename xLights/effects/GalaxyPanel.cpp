...
GalaxyPanel::GalaxyPanel(wxWindow* parent)
{
	...
	ValueCurve_Galaxy_CenterX = new BulkEditValueCurveButton(Panel6, ID_VALUECURVE_Galaxy_CenterX, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_valuecurve_notselected")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_CenterX"));
	...
	BitmapButton_Galaxy_CenterX = new xlLockButton(Panel6, ID_BITMAPBUTTON_SLIDER_Galaxy_CenterX, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_PADLOCK_OPEN")),wxART_BUTTON), wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Galaxy_CenterX"));
	...
	ValueCurve_Galaxy_CenterY = new BulkEditValueCurveButton(Panel6, ID_VALUECURVE_Galaxy_CenterY, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_valuecurve_notselected")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_CenterY"));
	...
	BitmapButton_Galaxy_CenterY = new xlLockButton(Panel6, ID_BITMAPBUTTON_SLIDER_Galaxy_CenterY, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_PADLOCK_OPEN")),wxART_BUTTON), wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Galaxy_CenterY"));
	...
	ValueCurve_Galaxy_Start_Radius = new BulkEditValueCurveButton(Panel6, ID_VALUECURVE_Galaxy_Start_Radius, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_valuecurve_notselected")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_Start_Radius"));
	...
	BitmapButton_Galaxy_Start_Radius = new xlLockButton(Panel6, ID_BITMAPBUTTON_SLIDER_Galaxy_Start_Radius, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_PADLOCK_OPEN")),wxART_BUTTON), wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Galaxy_Start_Radius"));
	...
	ValueCurve_Galaxy_Start_Width = new BulkEditValueCurveButton(Panel6, ID_VALUECURVE_Galaxy_Start_Width, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_valuecurve_notselected")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_Start_Width"));
	...
	BitmapButton_Galaxy_Start_Width = new xlLockButton(Panel6, ID_BITMAPBUTTON_SLIDER_Galaxy_Start_Width, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_PADLOCK_OPEN")),wxART_BUTTON), wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Galaxy_Start_Width"));
	...
	ValueCurve_Galaxy_Start_Angle = new BulkEditValueCurveButton(Panel6, ID_VALUECURVE_Galaxy_Start_Angle, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_valuecurve_notselected")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_Start_Angle"));
	...
	BitmapButton_Galaxy_Start_Angle = new xlLockButton(Panel6, ID_BITMAPBUTTON_SLIDER_Galaxy_Start_Angle, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_PADLOCK_OPEN")),wxART_BUTTON), wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Galaxy_Start_Angle"));
	...
	ValueCurve_Galaxy_End_Radius = new BulkEditValueCurveButton(Panel7, ID_VALUECURVE_Galaxy_End_Radius, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_valuecurve_notselected")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_End_Radius"));
	...
	BitmapButton_Galaxy_End_Radius = new xlLockButton(Panel7, ID_BITMAPBUTTON_SLIDER_Galaxy_End_Radius, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_PADLOCK_OPEN")),wxART_BUTTON), wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Galaxy_End_Radius"));
	...
	ValueCurve_Galaxy_End_Width = new BulkEditValueCurveButton(Panel7, ID_VALUECURVE_Galaxy_End_Width, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_valuecurve_notselected")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_End_Width"));
	...
	BitmapButton_Galaxy_End_Width = new xlLockButton(Panel7, ID_BITMAPBUTTON_SLIDER_Galaxy_End_Width, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_PADLOCK_OPEN")),wxART_BUTTON), wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Galaxy_End_Width"));
	...
	ValueCurve_Galaxy_Revolutions = new BulkEditValueCurveButton(Panel7, ID_VALUECURVE_Galaxy_Revolutions, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_valuecurve_notselected")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_Revolutions"));
	...
	BitmapButton_Galaxy_Revolutions = new xlLockButton(Panel7, ID_BITMAPBUTTON_SLIDER_Galaxy_Revolutions, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_PADLOCK_OPEN")),wxART_BUTTON), wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Galaxy_Revolutions"));
	...
	ValueCurve_Galaxy_Duration = new BulkEditValueCurveButton(Panel8, ID_VALUECURVE_Galaxy_Duration, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_valuecurve_notselected")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_Duration"));
	...
	BitmapButton_Galaxy_Duration = new xlLockButton(Panel8, ID_BITMAPBUTTON_SLIDER_Galaxy_Duration, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_PADLOCK_OPEN")),wxART_BUTTON), wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Galaxy_Duration"));
	...
	ValueCurve_Galaxy_Accel = new BulkEditValueCurveButton(Panel8, ID_VALUECURVE_Galaxy_Accel, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_valuecurve_notselected")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_Accel"));
	...
	BitmapButton_Galaxy_Accel = new xlLockButton(Panel8, ID_BITMAPBUTTON_SLIDER_Galaxy_Accel, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("xlART_PADLOCK_OPEN")),wxART_BUTTON), wxDefaultPosition, wxSize(14,14), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Galaxy_Accel"));
