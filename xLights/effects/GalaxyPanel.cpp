...
GalaxyPanel::GalaxyPanel(wxWindow* parent)
{
	...
	ValueCurve_Galaxy_CenterX = new BulkEditValueCurveButton(Panel6, ID_VALUECURVE_Galaxy_CenterX, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_CenterX"));
	...
	ValueCurve_Galaxy_CenterY = new BulkEditValueCurveButton(Panel6, ID_VALUECURVE_Galaxy_CenterY, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_CenterY"));
	...
	ValueCurve_Galaxy_Start_Radius = new BulkEditValueCurveButton(Panel6, ID_VALUECURVE_Galaxy_Start_Radius, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_Start_Radius"));
	...
	ValueCurve_Galaxy_Start_Width = new BulkEditValueCurveButton(Panel6, ID_VALUECURVE_Galaxy_Start_Width, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_Start_Width"));
	...
	ValueCurve_Galaxy_Start_Angle = new BulkEditValueCurveButton(Panel6, ID_VALUECURVE_Galaxy_Start_Angle, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_Start_Angle"));
	...
	ValueCurve_Galaxy_End_Radius = new BulkEditValueCurveButton(Panel7, ID_VALUECURVE_Galaxy_End_Radius, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_End_Radius"));
	...
	ValueCurve_Galaxy_End_Width = new BulkEditValueCurveButton(Panel7, ID_VALUECURVE_Galaxy_End_Width, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_End_Width"));
	...
	ValueCurve_Galaxy_Revolutions = new BulkEditValueCurveButton(Panel7, ID_VALUECURVE_Galaxy_Revolutions, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_Revolutions"));
	...
	ValueCurve_Galaxy_Duration = new BulkEditValueCurveButton(Panel8, ID_VALUECURVE_Galaxy_Duration, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_Duration"));
	...
	ValueCurve_Galaxy_Accel = new BulkEditValueCurveButton(Panel8, ID_VALUECURVE_Galaxy_Accel, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Galaxy_Accel"));
