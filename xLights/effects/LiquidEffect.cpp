...
void LiquidEffect::Render(Effect *effect, const SettingsMap &SettingsMap, RenderBuffer &buffer) {
    ...
    Render(buffer,
        ...
        GetValueCurveInt("LifeTime", 1000, SettingsMap, oset, LIQUID_LIFETIME_MIN, LIQUID_LIFETIME_MAX),
        ...
        GetValueCurveInt("Direction1", 270, SettingsMap, oset, LIQUID_DIRECTION_MIN, LIQUID_DIRECTION_MAX),
        GetValueCurveInt("X1", 50, SettingsMap, oset, LIQUID_X_MIN, LIQUID_X_MAX),
        GetValueCurveInt("Y1", 50, SettingsMap, oset, LIQUID_Y_MIN, LIQUID_Y_MAX),
        GetValueCurveInt("Velocity1", 100, SettingsMap, oset, LIQUID_VELOCITY_MIN, LIQUID_VELOCITY_MAX),
        GetValueCurveInt("Flow1", 100, SettingsMap, oset, LIQUID_FLOW_MIN, LIQUID_FLOW_MAX),
        GetValueCurveInt("Liquid_SourceSize1", 0, SettingsMap, oset, LIQUID_SOURCESIZE_MIN, LIQUID_SOURCESIZE_MAX),
        SettingsMap.GetBool("CHECKBOX_FlowMusic1", false),

        SettingsMap.GetBool("CHECKBOX_Enabled2", false),
        GetValueCurveInt("Direction2", 270, SettingsMap, oset, LIQUID_DIRECTION_MIN, LIQUID_DIRECTION_MAX),
        GetValueCurveInt("X2", 50, SettingsMap, oset, LIQUID_X_MIN, LIQUID_X_MAX),
        GetValueCurveInt("Y2", 50, SettingsMap, oset, LIQUID_Y_MIN, LIQUID_Y_MAX),
        GetValueCurveInt("Velocity2", 100, SettingsMap, oset, LIQUID_VELOCITY_MIN, LIQUID_VELOCITY_MAX),
        GetValueCurveInt("Flow2", 100, SettingsMap, oset, LIQUID_FLOW_MIN, LIQUID_FLOW_MAX),
        GetValueCurveInt("Liquid_SourceSize2", 0, SettingsMap, oset, LIQUID_SOURCESIZE_MIN, LIQUID_SOURCESIZE_MAX),
        SettingsMap.GetBool("CHECKBOX_FlowMusic2", false),

        SettingsMap.GetBool("CHECKBOX_Enabled3", false),
        GetValueCurveInt("Direction3", 270, SettingsMap, oset, LIQUID_DIRECTION_MIN, LIQUID_DIRECTION_MAX),
        GetValueCurveInt("X3", 50, SettingsMap, oset, LIQUID_X_MIN, LIQUID_X_MAX),
        GetValueCurveInt("Y3", 50, SettingsMap, oset, LIQUID_Y_MIN, LIQUID_Y_MAX),
        GetValueCurveInt("Velocity3", 100, SettingsMap, oset, LIQUID_VELOCITY_MIN, LIQUID_VELOCITY_MAX),
        GetValueCurveInt("Flow3", 100, SettingsMap, oset, LIQUID_FLOW_MIN, LIQUID_FLOW_MAX),
        GetValueCurveInt("Liquid_SourceSize3", 0, SettingsMap, oset, LIQUID_SOURCESIZE_MIN, LIQUID_SOURCESIZE_MAX),
        SettingsMap.GetBool("CHECKBOX_FlowMusic3", false),

        SettingsMap.GetBool("CHECKBOX_Enabled4", false),
        GetValueCurveInt("Direction4", 270, SettingsMap, oset, LIQUID_DIRECTION_MIN, LIQUID_DIRECTION_MAX),
        GetValueCurveInt("X4", 50, SettingsMap, oset, LIQUID_X_MIN, LIQUID_X_MAX),
        GetValueCurveInt("Y4", 50, SettingsMap, oset, LIQUID_Y_MIN, LIQUID_Y_MAX),
        GetValueCurveInt("Velocity4", 100, SettingsMap, oset, LIQUID_VELOCITY_MIN, LIQUID_VELOCITY_MAX),
        GetValueCurveInt("Flow4", 100, SettingsMap, oset, LIQUID_FLOW_MIN, LIQUID_FLOW_MAX),
        GetValueCurveInt("Liquid_SourceSize4", 0, SettingsMap, oset, LIQUID_SOURCESIZE_MIN, LIQUID_SOURCESIZE_MAX),
