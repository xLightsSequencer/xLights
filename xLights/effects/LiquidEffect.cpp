...
void LiquidEffect::Render(Effect *effect, const SettingsMap &SettingsMap, RenderBuffer &buffer) {
    ...
    Render(buffer,
        ...
        GetValueCurveInt("LifeTime", 1000, SettingsMap, oset, 0, 1000),
        ...
        GetValueCurveInt("Direction1", 270, SettingsMap, oset, 0, 360),
        GetValueCurveInt("X1", 50, SettingsMap, oset, 0, 100),
        GetValueCurveInt("Y1", 50, SettingsMap, oset, 0, 100),
        GetValueCurveInt("Velocity1", 100, SettingsMap, oset, 0, 1000),
        GetValueCurveInt("Flow1", 100, SettingsMap, oset, 0, 1000),
        GetValueCurveInt("Liquid_SourceSize1", 0, SettingsMap, oset, 0, 100),
        SettingsMap.GetBool("CHECKBOX_FlowMusic1", false),

        SettingsMap.GetBool("CHECKBOX_Enabled2", false),
        GetValueCurveInt("Direction2", 270, SettingsMap, oset, 0, 360),
        GetValueCurveInt("X2", 50, SettingsMap, oset, 0, 100),
        GetValueCurveInt("Y2", 50, SettingsMap, oset, 0, 100),
        GetValueCurveInt("Velocity2", 100, SettingsMap, oset, 0, 1000),
        GetValueCurveInt("Flow2", 100, SettingsMap, oset, 0, 1000),
        GetValueCurveInt("Liquid_SourceSize2", 0, SettingsMap, oset, 0, 100),
        SettingsMap.GetBool("CHECKBOX_FlowMusic2", false),

        SettingsMap.GetBool("CHECKBOX_Enabled3", false),
        GetValueCurveInt("Direction3", 270, SettingsMap, oset, 0, 360),
        GetValueCurveInt("X3", 50, SettingsMap, oset, 0, 100),
        GetValueCurveInt("Y3", 50, SettingsMap, oset, 0, 100),
        GetValueCurveInt("Velocity3", 100, SettingsMap, oset, 0, 1000),
        GetValueCurveInt("Flow3", 100, SettingsMap, oset, 0, 1000),
        GetValueCurveInt("Liquid_SourceSize3", 0, SettingsMap, oset, 0, 100),
        SettingsMap.GetBool("CHECKBOX_FlowMusic3", false),

        SettingsMap.GetBool("CHECKBOX_Enabled4", false),
        GetValueCurveInt("Direction4", 270, SettingsMap, oset, 0, 360),
        GetValueCurveInt("X4", 50, SettingsMap, oset, 0, 100),
        GetValueCurveInt("Y4", 50, SettingsMap, oset, 0, 100),
        GetValueCurveInt("Velocity4", 100, SettingsMap, oset, 0, 1000),
        GetValueCurveInt("Flow4", 100, SettingsMap, oset, 0, 1000),
        GetValueCurveInt("Liquid_SourceSize4", 0, SettingsMap, oset, 0, 100),
