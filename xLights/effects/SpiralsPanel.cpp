...
SpiralsPanel::SpiralsPanel(wxWindow* parent)
{
	...
	Connect(ID_SLIDER_Spirals_Count,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&SpiralsPanel::UpdateLinkedTextCtrl);
	...
	Connect(ID_SLIDER_Spirals_Rotation,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&SpiralsPanel::UpdateLinkedTextCtrlFloat);
	...
	Connect(ID_SLIDER_Spirals_Thickness,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&SpiralsPanel::UpdateLinkedTextCtrl);
	...
	Connect(IDD_SLIDER_Spirals_Movement,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&SpiralsPanel::UpdateLinkedTextCtrlFloat);
