...
SpiralsPanel::SpiralsPanel(wxWindow* parent)
{
	...
	BitmapButton_VCSpiralsCount = new BulkEditValueCurveButton(this, ID_VALUECURVE_Spirals_Count, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Spirals_Count"));
	...
	BitmapButton_VCSpirals_Rotation = new BulkEditValueCurveButton(this, ID_VALUECURVE_Spirals_Rotation, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Spirals_Rotation"));
	...
	BitmapButton_VCSpirals_Thickness = new BulkEditValueCurveButton(this, ID_VALUECURVE_Spirals_Thickness, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Spirals_Thickness"));
	...
	BitmapButton_VCSpirals_Movement = new BulkEditValueCurveButton(this, ID_VALUECURVE_Spirals_Movement, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Spirals_Movement"));
