...
MarqueePanel::MarqueePanel(wxWindow* parent)
{
	...
	CheckBox_Marquee_Reverse = new wxCheckBox(Panel_Marquee_Settings, ID_CHECKBOX_Marquee_Reverse, _("Reverse:"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT, wxDefaultValidator, _T("ID_CHECKBOX_Marquee_Reverse"));
	...
	TextCtrl_MarqueeYC = new wxTextCtrl(Panel_Marquee_Position, IDD_TEXTCTRL_MarqueeYC, _("0"), wxDefaultPosition, wxDLG_UNIT(Panel_Marquee_Position,wxSize(20,-1)), wxTE_CENTRE, wxDefaultValidator, _T("IDD_TEXTCTRL_MarqueeYC"));
	...
	Slider_MarqueeYC = new wxSlider(Panel_Marquee_Position, ID_SLIDER_MarqueeYC, 0, -100, 100, wxDefaultPosition, wxDefaultSize, wxSL_VERTICAL|wxSL_INVERSE, wxDefaultValidator, _T("ID_SLIDER_MarqueeYC"));
	...
	Connect(ID_SLIDER_Marquee_Band_Size,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Marquee_Band_Size,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_Marquee_Skip_Size,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Marquee_Skip_Size,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_Marquee_Thickness,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Marquee_Thickness,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_Marquee_Stagger,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Marquee_Stagger,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_Marquee_Speed,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Marquee_Speed,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_Marquee_Start,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Marquee_Start,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_Marquee_ScaleX,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Marquee_ScaleX,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_Marquee_ScaleY,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Marquee_ScaleY,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_MarqueeXC,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_MarqueeXC,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedSlider);
	Connect(IDD_TEXTCTRL_MarqueeYC,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedSlider);
	Connect(ID_SLIDER_MarqueeYC,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&MarqueePanel::UpdateLinkedTextCtrl);
	//*)
