...
StrobePanel::StrobePanel(wxWindow* parent)
{
	...
	FlexGridSizer88->Add(Slider_Strobe_Duration, 1, wxALL|wxEXPAND, 5);
	...
	FlexGridSizer85->Add(FlexGridSizer88, 1, wxALL|wxEXPAND, 5);
	...
	FlexGridSizer90->Add(Slider_Strobe_Type, 1, wxALL|wxEXPAND, 5);
