...
protected:
    ...
    static const long ID_TEXTCTRL_MHPanOffset;
    static const long ID_STATICTEXT_TiltOffset;
    static const long IDD_SLIDER_MHTiltOffset;
    static const long ID_VALUECURVE_MHTiltOffset;
    static const long ID_TEXTCTRL_MHTiltOffset;
