...
//(*IdInit(TwinklePanel)
const long TwinklePanel::ID_STATICTEXT86 = wxNewId();
...
const long TwinklePanel::ID_STATICTEXT105 = wxNewId();
...
TwinklePanel::TwinklePanel(wxWindow* parent)
{
	...
	CheckBox_Twinkle_Strobe = new wxCheckBox(this, ID_CHECKBOX_Twinkle_Strobe, _("Strobe"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_Twinkle_Strobe"));
	...
	Connect(ID_SLIDER_Twinkle_Count,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&TwinklePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Twinkle_Count,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&TwinklePanel::UpdateLinkedSlider);
	...
	Connect(ID_SLIDER_Twinkle_Steps,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&TwinklePanel::UpdateLinkedTextCtrl);
	Connect(IDD_TEXTCTRL_Twinkle_Steps,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&TwinklePanel::UpdateLinkedSlider);
