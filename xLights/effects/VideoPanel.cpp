...
//(*IdInit(VideoPanel)
const wxWindowID VideoPanel::ID_FILEPICKERCTRL_Video_Filename = wxNewId();
const wxWindowID VideoPanel::ID_STATICTEXT_Video_Starttime = wxNewId();
const wxWindowID VideoPanel::IDD_SLIDER_Video_Starttime = wxNewId();
const wxWindowID VideoPanel::ID_TEXTCTRL_Video_Starttime = wxNewId();
const wxWindowID VideoPanel::ID_STATICTEXT1 = wxNewId();
const wxWindowID VideoPanel::ID_TEXTCTRL_Duration = wxNewId();
const wxWindowID VideoPanel::ID_BUTTON1 = wxNewId();
const wxWindowID VideoPanel::ID_STATICTEXT_Video_DurationTreatment = wxNewId();
const wxWindowID VideoPanel::ID_CHOICE_Video_DurationTreatment = wxNewId();
const wxWindowID VideoPanel::ID_STATICTEXT2 = wxNewId();
const wxWindowID VideoPanel::IDD_SLIDER_Video_Speed = wxNewId();
const wxWindowID VideoPanel::ID_VALUECURVE_Video_Speed = wxNewId();
const wxWindowID VideoPanel::ID_TEXTCTRL_Video_Speed = wxNewId();
const wxWindowID VideoPanel::ID_CHECKBOX_Video_AspectRatio = wxNewId();
const wxWindowID VideoPanel::ID_CHECKBOX_SynchroniseWithAudio = wxNewId();
const wxWindowID VideoPanel::ID_STATICTEXT_Video_CropLeft = wxNewId();
const wxWindowID VideoPanel::IDD_SLIDER_Video_CropLeft = wxNewId();
const wxWindowID VideoPanel::ID_VALUECURVE_Video_CropLeft = wxNewId();
const wxWindowID VideoPanel::ID_TEXTCTRL_Video_CropLeft = wxNewId();
const wxWindowID VideoPanel::ID_STATICTEXT_Video_CropRight = wxNewId();
const wxWindowID VideoPanel::IDD_SLIDER_Video_CropRight = wxNewId();
const wxWindowID VideoPanel::ID_VALUECURVE_Video_CropRight = wxNewId();
const wxWindowID VideoPanel::ID_TEXTCTRL_Video_CropRight = wxNewId();
const wxWindowID VideoPanel::ID_STATICTEXT_Video_CropTop = wxNewId();
const wxWindowID VideoPanel::IDD_SLIDER_Video_CropTop = wxNewId();
const wxWindowID VideoPanel::ID_VALUECURVE_Video_CropTop = wxNewId();
const wxWindowID VideoPanel::ID_TEXTCTRL_Video_CropTop = wxNewId();
const wxWindowID VideoPanel::ID_STATICTEXT_Video_CropBottom = wxNewId();
const wxWindowID VideoPanel::IDD_SLIDER_Video_CropBottom = wxNewId();
const wxWindowID VideoPanel::ID_VALUECURVE_Video_CropBottom = wxNewId();
const wxWindowID VideoPanel::ID_TEXTCTRL_Video_CropBottom = wxNewId();
const wxWindowID VideoPanel::ID_STATICTEXT4 = wxNewId();
const wxWindowID VideoPanel::ID_CHOICE_Video_Scaling = wxNewId();
const wxWindowID VideoPanel::ID_CHECKBOX_Video_TransparentBlack = wxNewId();
const wxWindowID VideoPanel::IDD_SLIDER_Video_TransparentBlack = wxNewId();
const wxWindowID VideoPanel::ID_TEXTCTRL_Video_TransparentBlack = wxNewId();
const wxWindowID VideoPanel::ID_STATICTEXT3 = wxNewId();
const wxWindowID VideoPanel::IDD_SLIDER_SampleSpacing = wxNewId();
const wxWindowID VideoPanel::ID_TEXTCTRL_SampleSpacing = wxNewId();
//*)
...
VideoPanel::VideoPanel(wxWindow* parent) : xlEffectPanel(parent)
{
	...
	TextCtrl_Video_Starttime = new BulkEditTextCtrlF2(this, ID_TEXTCTRL_Video_Starttime, _T("0.0"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(40,-1)), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL_Video_Starttime"));
	...
	TextCtrl2 = new wxTextCtrl(this, ID_TEXTCTRL_Duration, _T("0:00:00.000"), wxDefaultPosition, wxDefaultSize, wxTE_READONLY|wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL_Duration"));
	...
	TextCtrl_Video_Speed = new BulkEditTextCtrlF2(this, ID_TEXTCTRL_Video_Speed, _T("1.00"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(40,-1)), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL_Video_Speed"));
	...
	FlexGridSizer13 = new wxFlexGridSizer(0, 1, 0, wxDLG_UNIT(this,wxSize(0,0)).GetWidth());
	...
	FlexGridSizer13->Add(CheckBox_Video_AspectRatio, 1, wxALL|wxEXPAND, 2);
	CheckBox_SynchroniseWithAudio = new BulkEditCheckBox(this, ID_CHECKBOX_SynchroniseWithAudio, _("Use sequence audio file as video file and sync"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_SynchroniseWithAudio"));
	CheckBox_SynchroniseWithAudio->SetValue(false);
	FlexGridSizer13->Add(CheckBox_SynchroniseWithAudio, 1, wxALL|wxEXPAND, 2);
	FlexGridSizer4->Add(FlexGridSizer13, 1, wxALL|wxEXPAND, 2);
	...
	TextCtrl_Video_CropLeft = new BulkEditTextCtrl(this, ID_TEXTCTRL_Video_CropLeft, _T("0"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(40,-1)), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL_Video_CropLeft"));
	...
	TextCtrl_Video_CropRight = new BulkEditTextCtrl(this, ID_TEXTCTRL_Video_CropRight, _T("100"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(40,-1)), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL_Video_CropRight"));
	...
	TextCtrl_Video_CropTop = new BulkEditTextCtrl(this, ID_TEXTCTRL_Video_CropTop, _T("100"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(40,-1)), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL_Video_CropTop"));
	...
	TextCtrl_Video_CropBottom = new BulkEditTextCtrl(this, ID_TEXTCTRL_Video_CropBottom, _T("0"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(40,-1)), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL_Video_CropBottom"));
	...
	StaticText10 = new wxStaticText(this, ID_STATICTEXT4, _("Video Scaling"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT4"));
	FlexGridSizer14->Add(StaticText10, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	Choice_Video_Scaling = new BulkEditChoice(this, ID_CHOICE_Video_Scaling, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE_Video_Scaling"));
	Choice_Video_Scaling->SetSelection( Choice_Video_Scaling->Append(_("Cubic")) );
	Choice_Video_Scaling->Append(_("Lanczos"));
	Choice_Video_Scaling->Append(_("Nearest Neighbor"));
	Choice_Video_Scaling->Append(_("Linear"));
	Choice_Video_Scaling->Append(_("Experimental"));
	Choice_Video_Scaling->Append(_("Area Avg"));
	Choice_Video_Scaling->Append(_("Bicubic + Linear"));
	Choice_Video_Scaling->Append(_("Gaussian"));
	Choice_Video_Scaling->Append(_("Sinc"));
	Choice_Video_Scaling->Append(_("Spline"));
	Choice_Video_Scaling->SetToolTip(_("Algorithm used to rescale the video."));
	FlexGridSizer14->Add(Choice_Video_Scaling, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer14->Add(124,23,1, wxALL|wxEXPAND|wxFIXED_MINSIZE, 2);
	FlexGridSizer4->Add(FlexGridSizer14, 1, wxALL|wxEXPAND, 2);
	...
	TextCtrl1 = new BulkEditTextCtrl(this, ID_TEXTCTRL_Video_TransparentBlack, _T("0"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(40,-1)), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL_Video_TransparentBlack"));
	...
	TextCtrl_SampleSpacing = new BulkEditTextCtrl(this, ID_TEXTCTRL_SampleSpacing, _T("0"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(40,-1)), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL_SampleSpacing"));
	...
	FlexGridSizer4->Add(FlexGridSizer7, 1, wxALL|wxEXPAND, 2);
