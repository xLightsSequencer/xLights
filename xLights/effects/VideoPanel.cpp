...
const long VideoPanel::ID_BITMAPBUTTON_Video_AspectRatio = wxNewId();
const long VideoPanel::ID_CHECKBOX_Video_Loop = wxNewId();
const long VideoPanel::ID_BITMAPBUTTON_Video_Loop = wxNewId();
//*)
...
VideoPanel::VideoPanel(wxWindow* parent)
{
	...
	FlexGridSizer4->Add(CheckBox_Video_AspectRatio, 1, wxALL|wxEXPAND, 5);
	BitmapButton_Video_AspectRatio = new wxBitmapButton(this, ID_BITMAPBUTTON_Video_AspectRatio, wxNullBitmap, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_Video_AspectRatio"));
	BitmapButton_Video_AspectRatio->SetDefault();
	BitmapButton_Video_AspectRatio->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
	FlexGridSizer4->Add(BitmapButton_Video_AspectRatio, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
	...
	FlexGridSizer4->Add(CheckBox_Video_Loop, 1, wxALL|wxEXPAND, 5);
	BitmapButton_Video_Loop = new wxBitmapButton(this, ID_BITMAPBUTTON_Video_Loop, wxNullBitmap, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_Video_Loop"));
	BitmapButton_Video_Loop->SetDefault();
	BitmapButton_Video_Loop->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
	FlexGridSizer4->Add(BitmapButton_Video_Loop, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
	...
	Connect(ID_BITMAPBUTTON_Video_AspectRatio,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&VideoPanel::OnLockButtonClick);
	Connect(ID_BITMAPBUTTON_Video_Loop,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&VideoPanel::OnLockButtonClick);
	//*)
