...
const long RipplePanel::ID_SLIDER_Ripple_Spacing = wxNewId();
...
const long RipplePanel::ID_SLIDER_Ripple_Twist = wxNewId();
...
const long RipplePanel::ID_SLIDER_Ripple_Velocity = wxNewId();
...
RipplePanel::RipplePanel(wxWindow* parent) : xlEffectPanel(parent)
{
	...
	Slider_Ripple_Spacing = new BulkEditSliderF1(this, ID_SLIDER_Ripple_Spacing, 10, 10, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER_Ripple_Spacing"));
