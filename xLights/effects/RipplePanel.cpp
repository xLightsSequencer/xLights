...
const long RipplePanel::ID_BITMAPBUTTON7 = wxNewId();
...
const long RipplePanel::ID_SLIDER1 = wxNewId();
const long RipplePanel::ID_BITMAPBUTTON2 = wxNewId();
const long RipplePanel::IDD_TEXTCTRL_Ripple_Spacing = wxNewId();
...
const long RipplePanel::ID_SLIDER4 = wxNewId();
const long RipplePanel::ID_BITMAPBUTTON8 = wxNewId();
const long RipplePanel::IDD_TEXTCTRL_Ripple_Twist = wxNewId();
...
const long RipplePanel::ID_SLIDER2 = wxNewId();
const long RipplePanel::ID_BITMAPBUTTON9 = wxNewId();
const long RipplePanel::IDD_TEXTCTRL_Ripple_Velocity = wxNewId();
const long RipplePanel::ID_BITMAPBUTTON_SLIDER_Ripple_Velocity = wxNewId();
const long RipplePanel::ID_STATICTEXT8 = wxNewId();
const long RipplePanel::ID_SLIDER3 = wxNewId();
const long RipplePanel::ID_BITMAPBUTTON10 = wxNewId();
...
RipplePanel::RipplePanel(wxWindow* parent) : xlEffectPanel(parent)
{
	...
	BitmapButton7 = new BulkEditValueCurveButton(this, ID_BITMAPBUTTON7, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON7"));
	FlexGridSizer8->Add(BitmapButton7, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
	...
	FlexGridSizer57->Add(BitmapButton_Ripple_Scale, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BitmapButton2 = new BulkEditValueCurveButton(this, ID_BITMAPBUTTON2, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON2"));
	FlexGridSizer6->Add(BitmapButton2, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
	FlexGridSizer57->Add(FlexGridSizer6, 1, wxALL|wxEXPAND, 0);
	TextCtrl_Ripple_Spacing = new BulkEditTextCtrlF1(this, IDD_TEXTCTRL_Ripple_Spacing, _("1.0"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Ripple_Spacing"));
	...
	FlexGridSizer57->Add(BitmapButton_Ripple_Spacing, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	Slider4 = new BulkEditSlider(this, ID_SLIDER4, 3, 1, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER4"));
	FlexGridSizer7->Add(Slider4, 1, wxALL|wxEXPAND, 2);
	BitmapButton8 = new BulkEditValueCurveButton(this, ID_BITMAPBUTTON8, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON8"));
	FlexGridSizer7->Add(BitmapButton8, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
	FlexGridSizer57->Add(FlexGridSizer7, 1, wxALL|wxEXPAND, 0);
	TextCtrl_Ripple_Twist = new BulkEditTextCtrlF1(this, IDD_TEXTCTRL_Ripple_Twist, _("0.0"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Ripple_Twist"));
	...
	FlexGridSizer57->Add(BitmapButton_Ripple_Twist, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	Slider2 = new BulkEditSlider(this, ID_SLIDER2, 3, 1, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER2"));
	FlexGridSizer9->Add(Slider2, 1, wxALL|wxEXPAND, 2);
	BitmapButton9 = new BulkEditValueCurveButton(this, ID_BITMAPBUTTON9, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON9"));
	FlexGridSizer9->Add(BitmapButton9, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer57->Add(FlexGridSizer9, 1, wxALL|wxEXPAND, 0);
	TextCtrl_Ripple_Velocity = new BulkEditTextCtrlF1(this, IDD_TEXTCTRL_Ripple_Velocity, _("0.0"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(20,-1)), 0, wxDefaultValidator, _T("IDD_TEXTCTRL_Ripple_Velocity"));
	...
	FlexGridSizer57->Add(BitmapButton_Ripple_Velocity, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	Slider3 = new BulkEditSlider(this, ID_SLIDER3, 3, 1, 100, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER3"));
	FlexGridSizer10->Add(Slider3, 1, wxALL|wxEXPAND, 2);
	BitmapButton10 = new BulkEditValueCurveButton(this, ID_BITMAPBUTTON10, GetValueCurveNotSelectedBitmap(), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxBORDER_NONE, wxDefaultValidator, _T("ID_BITMAPBUTTON10"));
	FlexGridSizer10->Add(BitmapButton10, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
	...
	FlexGridSizer57->Add(BitmapButton_Ripple_Direction, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer57->Add(BitmapButton_Ripple_Draw_Style, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer57->Add(-1,-1,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
