...
ShimmerPanel::ShimmerPanel(wxWindow* parent)
{
	...
	BitmapButton_Shimmer_Duty_FactorVC = new BulkEditValueCurveButton(this, ID_VALUECURVE_Shimmer_Duty_Factor, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Shimmer_Duty_Factor"));
	...
	BitmapButton_Shimmer_Duty_Factor = new wxBitmapButton(this, ID_BITMAPBUTTON_SLIDER_Shimmer_Duty_Factor, padlock16x16_blue_xpm, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Shimmer_Duty_Factor"));
	...
	BitmapButton_Shimmer_CyclesVC = new BulkEditValueCurveButton(this, ID_VALUECURVE_Shimmer_Cycles, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Shimmer_Cycles"));
	...
	BitmapButton_ShimmerCycles = new wxBitmapButton(this, ID_BITMAPBUTTON_SLIDER_Shimmer_Cycles, padlock16x16_blue_xpm, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_SLIDER_Shimmer_Cycles"));
	BitmapButton_ShimmerCycles->SetMinSize(wxSize(13,13));
	BitmapButton_ShimmerCycles->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_ACTIVECAPTION));
	...
	BitmapButton_Shimmer_Use_All_Colors = new wxBitmapButton(this, ID_BITMAPBUTTON_CHECKBOX_Shimmer_Use_All_Colors, padlock16x16_blue_xpm, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON_CHECKBOX_Shimmer_Use_All_Colors"));
