...
//(*IdInit(ServoPanel)
const long ServoPanel::ID_STATICTEXT1 = wxNewId();
...
ServoPanel::ServoPanel(wxWindow* parent)
{
	...
	Choice_Channel = new wxChoice(this, ID_CHOICE_Channel, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE_Channel"));
	FlexGridSizer2->Add(Choice_Channel, 1, wxALL, 5);
	CheckBox_16bit = new wxCheckBox(this, ID_CHECKBOX_16bit, _("16 bit"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_16bit"));
	...
	Label_DMX1 = new wxStaticText(this, wxID_ANY, _("Value:"), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
	FlexGridSizer1->Add(Label_DMX1, 1, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 2);
	Slider_Servo = new wxSlider(this, IDD_SLIDER_Servo, 0, 0, 1000, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("IDD_SLIDER_Servo"));
	FlexGridSizer1->Add(Slider_Servo, 1, wxALL|wxEXPAND, 2);
	ValueCurve_Servo = new ValueCurveButton(this, ID_VALUECURVE_Servo, valuecurvenotselected_24, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|wxNO_BORDER, wxDefaultValidator, _T("ID_VALUECURVE_Servo"));
	FlexGridSizer1->Add(ValueCurve_Servo, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	TextCtrl_Servo = new wxTextCtrl(this, ID_TEXTCTRL_Servo, _("0"), wxDefaultPosition, wxDLG_UNIT(this,wxSize(20,-1)), wxTE_PROCESS_ENTER, wxDefaultValidator, _T("ID_TEXTCTRL_Servo"));
	...
	Connect(IDD_SLIDER_Servo,wxEVT_COMMAND_SLIDER_UPDATED,(wxObjectEventFunction)&ServoPanel::UpdateLinkedTextCtrlFloatVC);
	Connect(ID_VALUECURVE_Servo,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&ServoPanel::OnVCButtonClick);
	Connect(ID_TEXTCTRL_Servo,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&ServoPanel::UpdateLinkedSliderFloat);
	//*)
