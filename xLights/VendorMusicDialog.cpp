...
VendorMusicDialog::VendorMusicDialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	HyperlinkCtrl_VideoLink = new wxHyperlinkCtrl(Panel_Item, ID_HYPERLINKCTRL1, _("http://xlights.org"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_CONTEXTMENU|wxHL_ALIGN_LEFT|wxNO_BORDER, _T("ID_HYPERLINKCTRL1"));
	...
	HyperlinkCtrl_WebLink = new wxHyperlinkCtrl(Panel_Item, ID_HYPERLINKCTRL3, _("http://xlights.org"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_CONTEXTMENU|wxHL_ALIGN_LEFT|wxNO_BORDER, _T("ID_HYPERLINKCTRL3"));
	...
	HyperlinkCtrl_MusicLink = new wxHyperlinkCtrl(Panel_Item, ID_HYPERLINKCTRL5, _("http://xlights.org"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_CONTEXTMENU|wxHL_ALIGN_LEFT|wxNO_BORDER, _T("ID_HYPERLINKCTRL5"));
