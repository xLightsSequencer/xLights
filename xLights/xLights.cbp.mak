...
CFLAGS_LINUX_RELEASE = $(CFLAGS) -O2 -std=gnu++14 -Wall `wx-config --version=3.1 --cflags` `pkg-config --cflags gstreamer-1.0 gstreamer-video-1.0` `pkg-config --cflags libavformat libavcodec libavutil  libswresample libswscale` -Winvalid-pch -DWX_PRECOMP -DLINUX -DNDEBUG -D__cdecl='' -Wno-reorder -Wno-sign-compare -Wno-unused-variable -Wno-switch -Wno-unused-but-set-variable -Wno-parentheses -Wno-return-type -Wno-uninitialized -Wno-unused-value -Wno-sequence-point -Wno-comment -Wno-unused-function
...
$(OBJDIR_LINUX_DEBUG)/RotoZoom.o: RotoZoom.cpp
	$(CXX) $(CFLAGS_LINUX_DEBUG) $(INC_LINUX_DEBUG) -c RotoZoom.cpp -o $(OBJDIR_LINUX_DEBUG)/RotoZoom.o
...
$(OBJDIR_LINUX_DEBUG)/BufferTransformProperties.o: BufferTransformProperties.cpp
	$(CXX) $(CFLAGS_LINUX_DEBUG) $(INC_LINUX_DEBUG) -c BufferTransformProperties.cpp -o $(OBJDIR_LINUX_DEBUG)/BufferTransformProperties.o
...
$(OBJDIR_LINUX_RELEASE)/RotoZoom.o: RotoZoom.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c RotoZoom.cpp -o $(OBJDIR_LINUX_RELEASE)/RotoZoom.o
...
$(OBJDIR_LINUX_RELEASE)/BufferTransformProperties.o: BufferTransformProperties.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c BufferTransformProperties.cpp -o $(OBJDIR_LINUX_RELEASE)/BufferTransformProperties.o
...
PixelBuffer.h: models/Model.h models/SingleLineModel.h RenderBuffer.h ValueCurve.h RotoZoom.h
...
BufferPanel.h: ValueCurve.h ValueCurveButton.h RotoZoom.h
...
effects/SingleStrandEffect.cpp: effects/SingleStrandEffect.h effects/SingleStrandPanel.h sequencer/Effect.h RenderBuffer.h UtilClasses.h ../include/singleStrand.xpm
...
PixelBuffer.cpp: PixelBuffer.h DimmingCurve.h models/ModelManager.h models/SingleLineModel.h UtilClasses.h AudioManager.h RotoZoom.h
...
BufferPanel.cpp: BufferPanel.h models/Model.h effects/EffectPanelUtils.h ../include/padlock16x16-blue.xpm ../include/valuecurvenotselected.xpm ValueCurveDialog.h SubBufferPanel.h BufferTransformProperties.h

ValueCurveDialog.h: xlCustomControl.h ValueCurve.h

BufferTransformProperties.h: RotoZoom.h

BufferTransformProperties.cpp: BufferTransformProperties.h
...
effects/PianoEffect.cpp: effects/PianoEffect.h effects/PianoPanel.h AudioManager.h sequencer/Effect.h RenderBuffer.h UtilClasses.h xLightsXmlFile.h ../include/piano.xpm
