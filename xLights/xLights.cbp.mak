...
CFLAGS_LINUX_DEBUG = $(CFLAGS) -Wall -g -std=gnu++11 `wx-config --cflags` -Winvalid-pch -DWX_PRECOMP -DLINUX -D__WXDEBUG__
...
effects/TendrilEffect.cpp: effects/TendrilEffect.h effects/TendrilPanel.h sequencer/Effect.h RenderBuffer.h UtilClasses.h
