...
TopEffectsPanel::TopEffectsPanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	BitmapButtonSelectedEffect = new wxBitmapButton(this, ID_BITMAPBUTTON_SelectedEffect, butterfly, wxDefaultPosition, wxSize(13,13), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTON_SelectedEffect"));
