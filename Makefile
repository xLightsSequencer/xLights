...
wxwidgets31: FORCE
	...
	@if test "`wx-config --version`" != "3.1.1"; \
		...
		CXXFLAGS="-std=gnu++14" ./configure --with-cxx=14 --enable-cxx11 --enable-std_containers --enable-std_string --enable-std_string_conv_in_wxstring --enable-backtrace --enable-exceptions --enable-mediactrl --enable-graphics_ctx --enable-monolithic --disable-shared --disable-gtktest --disable-sdltest --with-gtk=3 --disable-pcx --disable-iff --without-libtiff; \
