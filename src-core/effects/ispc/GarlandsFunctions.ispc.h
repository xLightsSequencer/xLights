...
#ifndef __ISPC_STRUCT_GarlandsData__
#define __ISPC_STRUCT_GarlandsData__
struct GarlandsData {
    uint32_t width;
    uint32_t height;
    int32_t buffMax;
...
extern "C" {
#endif // __cplusplus
    extern void GarlandsEffectISPC(const struct GarlandsData * data, int32_t startIdx, int32_t endIdx, const uint8_t4   * colors, const int32_t * yb, uint8_t4   * result);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
