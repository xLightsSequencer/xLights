...
#ifndef __ISPC_STRUCT_WaveISPCData__
#define __ISPC_STRUCT_WaveISPCData__
struct WaveISPCData {
    int32_t width;
    int32_t height;
    int32_t fillColor;
    ...
    int32_t yoffset;
    int32_t numColors;
    struct uint8_t4  noneColor;
    uint8_t4  palColors[8];
};
#endif
...
extern "C" {
#endif // __cplusplus
    extern void WaveEffectISPC(const struct WaveISPCData * d, const int32_t * cols, int32_t startIdx, int32_t endIdx, uint8_t4   * result);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
