...
#ifndef __ISPC_STRUCT_ShimmerData__
#define __ISPC_STRUCT_ShimmerData__
struct ShimmerData {
    uint32_t width;
    uint32_t height;
    int32_t lutMode;
...
extern "C" {
#endif // __cplusplus
    extern void ShimmerEffectISPC(const struct ShimmerData * data, int32_t startIdx, int32_t endIdx, const uint8_t4   * lut, uint8_t4   * result);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
