...
#ifndef __ISPC_STRUCT_TwinkleISPCData__
#define __ISPC_STRUCT_TwinkleISPCData__
...
extern "C" {
#endif // __cplusplus
    extern void TwinkleEffectISPC(const struct TwinkleISPCData * d, int32_t startIdx, int32_t endIdx, int32_t * states, const uint8_t4   * lut, uint8_t4   * result);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
