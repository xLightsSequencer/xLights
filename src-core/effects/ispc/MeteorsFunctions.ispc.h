...
#ifndef __ISPC_STRUCT_MeteorsISPCData__
#define __ISPC_STRUCT_MeteorsISPCData__
...
#ifndef __ISPC_STRUCT_MeteorParticle__
#define __ISPC_STRUCT_MeteorParticle__
...
extern "C" {
    ...
    extern void MeteorsRadialWalkISPC(float mx, float my, float ddx, float ddy, int32_t implode, int32_t phStart, int32_t phEnd, int32_t W, int32_t H, int32_t * outX, int32_t * outY);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
