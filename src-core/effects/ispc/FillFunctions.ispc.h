...
#ifndef __ISPC_STRUCT_FillData__
#define __ISPC_STRUCT_FillData__
struct FillData {
    uint32_t width;
    uint32_t height;
    int32_t vertical;
...
extern "C" {
#endif // __cplusplus
    extern void FillEffectISPC(const struct FillData * data, int32_t startIdx, int32_t endIdx, const uint8_t4   * lut, const uint8_t * painted, uint8_t4   * result);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
