...
#ifndef __ISPC_STRUCT_TreeISPCData__
#define __ISPC_STRUCT_TreeISPCData__
struct TreeISPCData {
    uint32_t width;
    uint32_t height;
    int32_t ppb;
    ...
    int32_t f_mod;
    int32_t showlights;
    uint8_t4  bgColors[512];
    uint8_t4  lightColors[5];
};
#endif
...
extern "C" {
#endif // __cplusplus
    extern void TreeEffectISPC(const struct TreeISPCData * data, int32_t startIdx, int32_t endIdx, uint8_t4   * result);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
