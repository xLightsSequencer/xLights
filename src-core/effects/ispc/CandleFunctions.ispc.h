...
#ifndef __ISPC_STRUCT_CandleISPCData__
#define __ISPC_STRUCT_CandleISPCData__
...
extern "C" {
#endif // __cplusplus
    extern void CandleEffectISPC(const struct CandleISPCData * d, int32_t startIdx, int32_t endIdx, uint8_t * states, uint8_t4   * result);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
