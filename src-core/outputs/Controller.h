...
public:
    ...
    void SetExtraProperty(const std::string &p, const std::string &v) { if (auto it = _extraProperties.find(p); it == _extraProperties.end() || it->second != v) { _extraProperties[p] = v; _dirty = true; } }
    #pragma endregion
