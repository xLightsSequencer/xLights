...
//(*InternalHeaders(xCrossFadeFrame)
#include <wx/intl.h>
#include <wx/string.h>
//*)
...
//(*IdInit(xCrossFadeFrame)
const long xCrossFadeFrame::ID_CHECKBOX_TRIGGERONCHANNEL = wxNewId();
const long xCrossFadeFrame::ID_STATICTEXT1 = wxNewId();
const long xCrossFadeFrame::ID_SPINCTRL_UNIVERSE = wxNewId();
const long xCrossFadeFrame::ID_STATICTEXT2 = wxNewId();
const long xCrossFadeFrame::ID_SPINCTRL_CHANNEL = wxNewId();
const long xCrossFadeFrame::ID_STATICTEXT3 = wxNewId();
const long xCrossFadeFrame::ID_SPINCTRL_START = wxNewId();
const long xCrossFadeFrame::ID_STATICTEXT4 = wxNewId();
const long xCrossFadeFrame::ID_SPINCTRL_END = wxNewId();
const long xCrossFadeFrame::ID_STATICLINE1 = wxNewId();
const long xCrossFadeFrame::ID_STATICTEXT5 = wxNewId();
const long xCrossFadeFrame::ID_CHECKBOX_E131 = wxNewId();
const long xCrossFadeFrame::ID_CHECKBOX_ARTNET = wxNewId();
const long xCrossFadeFrame::ID_STATICTEXT7 = wxNewId();
const long xCrossFadeFrame::ID_STATICTEXT8 = wxNewId();
const long xCrossFadeFrame::ID_BUTTON9 = wxNewId();
const long xCrossFadeFrame::ID_STATICTEXT6 = wxNewId();
const long xCrossFadeFrame::ID_STATICLINE2 = wxNewId();
const long xCrossFadeFrame::ID_LISTVIEW_UNIVERSES = wxNewId();
const long xCrossFadeFrame::ID_BUTTON6 = wxNewId();
const long xCrossFadeFrame::ID_BUTTON3 = wxNewId();
const long xCrossFadeFrame::ID_BUTTON4 = wxNewId();
const long xCrossFadeFrame::ID_BUTTON5 = wxNewId();
const long xCrossFadeFrame::ID_BUTTON1 = wxNewId();
const long xCrossFadeFrame::ID_BUTTON8 = wxNewId();
const long xCrossFadeFrame::ID_BUTTON2 = wxNewId();
const long xCrossFadeFrame::ID_BUTTON7 = wxNewId();
const long xCrossFadeFrame::ID_STATUSBAR1 = wxNewId();
const long xCrossFadeFrame::ID_TIMER1 = wxNewId();
//*)

const long xCrossFadeFrame::ID_E131SOCKET = wxNewId();
const long xCrossFadeFrame::ID_ARTNETSOCKET = wxNewId();

BEGIN_EVENT_TABLE(xCrossFadeFrame,wxFrame)
    //(*EventTable(xCrossFadeFrame)
    //*)
END_EVENT_TABLE()

void xCrossFadeFrame::PurgeCollectedData()
{
...
void xCrossFadeFrame::StashPacket(long type, wxByte* packet, int len)
{
    int universe = -1;
...
bool xCrossFadeFrame::IsUniverseToBeCaptured(int universe, bool ignoreall /*= false*/)
{
...
int xCrossFadeFrame::GuessFrameMS()
{
...
xCrossFadeFrame::xCrossFadeFrame(wxWindow* parent, const std::string& showdir, const std::string& playlist, wxWindowID id)
{
    static log4cpp::Category &logger_base = log4cpp::Category::getInstance(std::string("log_base"));
    ...
    Connect(ID_CHECKBOX_TRIGGERONCHANNEL,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&xCrossFadeFrame::OnCheckBox_TriggerOnChannelClick);
    Connect(ID_CHECKBOX_E131,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&xCrossFadeFrame::OnCheckBox_E131Click);
    Connect(ID_CHECKBOX_ARTNET,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&xCrossFadeFrame::OnCheckBox_ArtNETClick);
    Connect(ID_BUTTON9,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&xCrossFadeFrame::OnButton1Click);
    Connect(ID_LISTVIEW_UNIVERSES,wxEVT_COMMAND_LIST_ITEM_SELECTED,(wxObjectEventFunction)&xCrossFadeFrame::OnListView_UniversesItemSelect);
    Connect(ID_LISTVIEW_UNIVERSES,wxEVT_COMMAND_LIST_ITEM_ACTIVATED,(wxObjectEventFunction)&xCrossFadeFrame::OnListView_UniversesItemActivated);
    Connect(ID_BUTTON6,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&xCrossFadeFrame::OnButton_AllClick);
    Connect(ID_BUTTON3,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&xCrossFadeFrame::OnButton_AddClick);
    Connect(ID_BUTTON4,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&xCrossFadeFrame::OnButton_EditClick);
    Connect(ID_BUTTON5,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&xCrossFadeFrame::OnButton_DeleteClick);
    Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&xCrossFadeFrame::OnButton_StartStopClick);
    Connect(ID_BUTTON8,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&xCrossFadeFrame::OnButton_AnalyseClick);
    Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&xCrossFadeFrame::OnButton_SaveClick);
    Connect(ID_BUTTON7,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&xCrossFadeFrame::OnButton_ClearClick);
    Connect(ID_TIMER1,wxEVT_TIMER,(wxObjectEventFunction)&xCrossFadeFrame::OnUITimerTrigger);
    Connect(wxEVT_SIZE,(wxObjectEventFunction)&xCrossFadeFrame::OnResize);
    //*)

    Connect(ID_E131SOCKET, wxEVT_SOCKET, (wxObjectEventFunction)&xCrossFadeFrame::OnE131SocketEvent);
    Connect(ID_ARTNETSOCKET, wxEVT_SOCKET, (wxObjectEventFunction)&xCrossFadeFrame::OnArtNETSocketEvent);
...
void xCrossFadeFrame::LoadState()
{
...
xCrossFadeFrame::~xCrossFadeFrame()
{
    SaveState();
    ...
    //(*Destroy(xCrossFadeFrame)
    //*)
}

void xCrossFadeFrame::SaveState()
{
    int x, y;
    GetPosition(&x, &y);
...
void xCrossFadeFrame::CloseSockets(bool force)
{
...
void xCrossFadeFrame::OnQuit(wxCommandEvent& event)
{
    Close();
}

void xCrossFadeFrame::OnAbout(wxCommandEvent& event)
{
    auto about = wxString::Format(wxT("xCrossFade v%s %s, the xLights packet capturer."), xlights_version_string, GetBitness());
...
{
    _frameTimeMS = -1;
    if (type == xCrossFadeFrame::ID_E131SOCKET)
    {
        // validate the packet
        if (len < 126) return;
    ...
    else if (type == xCrossFadeFrame::ID_ARTNETSOCKET)
    {
        // validate the packet
        if (len < 18) return;
...
bool Collector::operator<(const Collector& c) const
{
    ...
    {
        if (_protocol == xCrossFadeFrame::ID_E131SOCKET)
        {
            return true;
        }
        return false;
...
void xCrossFadeFrame::ValidateWindow()
{
    if (CheckBox_TriggerOnChannel->GetValue())
    {
...
void xCrossFadeFrame::CreateE131Listener()
{
    static log4cpp::Category &logger_base = log4cpp::Category::getInstance(std::string("log_base"));
...
void xCrossFadeFrame::CreateArtNETListener()
{
    static log4cpp::Category &logger_base = log4cpp::Category::getInstance(std::string("log_base"));
...
void xCrossFadeFrame::AddUniverseRange(int low, int high)
{
    if (ListView_Universes->GetItemCount() == 1 &&
...
void xCrossFadeFrame::OnResize(wxSizeEvent& event)
{
    Layout();
}

void xCrossFadeFrame::CreateDebugReport(wxDebugReportCompress *report) {
...
void xCrossFadeFrame::SendReport(const wxString &loc, wxDebugReportCompress &report) {
    wxHTTP http;
    ...
    wxString fn = wxString::Format("xCrossFade-%s_%s_%s_%s.zip", wxPlatformInfo::Get().GetOperatingSystemFamilyName().c_str(), xlights_version_string, GetBitness(), ts);
...
void xCrossFadeFrame::OnKeyDown(wxKeyEvent& event)
{
    ValidateWindow();
}

void xCrossFadeFrame::OnButton_StartStopClick(wxCommandEvent& event)
{
    static log4cpp::Category &logger_base = log4cpp::Category::getInstance(std::string("log_base"));
...
void xCrossFadeFrame::OnButton_SaveClick(wxCommandEvent& event)
{
    static log4cpp::Category &logger_base = log4cpp::Category::getInstance(std::string("log_base"));
...
long xCrossFadeFrame::GetChannelsPerFrame()
{
    long size = 0;
    for (auto it = _capturedData.begin(); it != _capturedData.end(); ++it)
    {
...
wxDateTime xCrossFadeFrame::GetStartTime()
{
...
void xCrossFadeFrame::OnCheckBox_TriggerOnChannelClick(wxCommandEvent& event)
{
    ValidateWindow();
}

void xCrossFadeFrame::OnListView_UniversesItemSelect(wxListEvent& event)
{
    ValidateWindow();
}

void xCrossFadeFrame::OnListView_UniversesItemActivated(wxListEvent& event)
{
    if (ListView_Universes->GetSelectedItemCount() > 0)
    {
...
void xCrossFadeFrame::OnButton_AllClick(wxCommandEvent& event)
{
...
void xCrossFadeFrame::OnButton_ClearClick(wxCommandEvent& event)
{
    _capturedDesc = "";
    _capturedPackets = 0;
    PurgeCollectedData();
...
void xCrossFadeFrame::OnCheckBox_E131Click(wxCommandEvent& event)
{
    CloseSockets();
...
void xCrossFadeFrame::OnCheckBox_ArtNETClick(wxCommandEvent& event)
{
    CloseSockets();
...
void xCrossFadeFrame::OnE131SocketEvent(wxSocketEvent& event)
{
    static log4cpp::Category &logger_base = log4cpp::Category::getInstance(std::string("log_base"));
...
void xCrossFadeFrame::OnArtNETSocketEvent(wxSocketEvent & event)
{
    static log4cpp::Category &logger_base = log4cpp::Category::getInstance(std::string("log_base"));
...
void xCrossFadeFrame::OnButton_AddClick(wxCommandEvent& event)
{
...
void xCrossFadeFrame::OnButton_EditClick(wxCommandEvent& event)
{
    if (ListView_Universes->GetSelectedItemCount() > 0)
    {
        int start = wxAtoi(ListView_Universes->GetItemText(ListView_Universes->GetFirstSelected()));
...
void xCrossFadeFrame::OnButton_DeleteClick(wxCommandEvent& event)
{
    if (ListView_Universes->GetSelectedItemCount() > 0)
    {
        ListView_Universes->DeleteItem(ListView_Universes->GetFirstSelected());
...
void xCrossFadeFrame::OnUITimerTrigger(wxTimerEvent& event)
{
...
void xCrossFadeFrame::SaveFSEQ(wxString file, int frameMS, long channelsPerFrame, int frames, wxString& log)
{
    static log4cpp::Category &logger_base = log4cpp::Category::getInstance(std::string("log_base"));
...
void xCrossFadeFrame::RestartInterfaces()
{
    CloseSockets(true);
    if (CheckBox_E131->GetValue())
    {
...
void xCrossFadeFrame::UpdateCaptureDesc()
{
...
void xCrossFadeFrame::SaveESEQ(wxString file, int frameMS, long channelsPerFrame, int frames, wxString& log)
{
    static log4cpp::Category &logger_base = log4cpp::Category::getInstance(std::string("log_base"));
...
void xCrossFadeFrame::OnButton_AnalyseClick(wxCommandEvent& event)
{
    int frameMS = GuessFrameMS();
...
void xCrossFadeFrame::OnButton1Click(wxCommandEvent& event)
{
