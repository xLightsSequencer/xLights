...
#ifndef XCROSSFADEMAIN_H
#define XCROSSFADEMAIN_H
...
class xCrossFadeFrame : public wxFrame
{
    void ValidateWindow();
...
public:
        ...
        xCrossFadeFrame(wxWindow* parent, const std::string& showdir = "", const std::string& playlist = "", wxWindowID id = -1);
        virtual ~xCrossFadeFrame();
