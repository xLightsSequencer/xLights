...
---------------------------------
2026.09  May ??, 2026
    -enh (cybercop23)           Add State effect on SubModels. Ensure only nodes that are part of the SubModel are                                lit. Same node-index transaltion on Face effect if using Face effect on a SubModel.
