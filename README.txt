...
---------------------------------
   -- enh (dkulp)   Allow reverse order for SubModel node ranges (10-5 intead of 5-10). Fixes #
   -- enh (keith)   Rework sequence elements dialog box to get rid of the add window and make everything drag and drop
2017.12  Apr  30, 2017
