...
3.3.2				-Bug fix (dkulp): When imprting LOR *.lms files, certain missing data would cause a crash. 
						conversion now fills in any of those mising parameters and conversion completes.
