...
XLIGHTS/NUTCRACKER RELEASE NOTES:
    -enh (djulien) Allow multiple/extended selections on Sequence Display Elements dialog list on Nutcracker tab (easier for including/excluding a bunch of models), add checkbox for all on/off
3.6.15 Dec 20, 2014
