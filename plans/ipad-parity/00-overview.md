...
| **At parity** (both platforms) | 873 (**~73%**) |
| **iPad-missing** (desktop has, iPad doesn't) | 173 |
...
|---|---|--:|--:|--:|--:|--:|--:|--:|
| 01 | [File Lifecycle & Sequence Management](01-file-lifecycle.md) | 71 | 48 | 68% | 12 | 6 | 6 | 4 |
...
| — | **Total** | **1,201** | **873** | **~73%** | **173** | **63** | **≈92** | **82** |
