...
| Alternate audio track CRUD (add/remove/rename/replace) | dialog | ✅ | ✅ | parity | P2 | medium | feasible | `SeqSettingsDialog.cpp:2320-2401` ↔ `SequenceSettingsSheet.swift:794` (AudioTracksTab) |
