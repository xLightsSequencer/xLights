...
| Base Show Folder (inheritance) | setup/sheet | ✅ | ✅ | parity | P2 | medium | feasible | Desktop `ShowDirectoriesDialog` (`src-ui-wx/setup/ShowDirectoriesDialog.cpp`, was the Setup tab until PR #6690); iPad FolderConfigView base section + Auto-Update + Update Now. |
